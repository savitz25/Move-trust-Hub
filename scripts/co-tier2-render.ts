/**
 * Shared render for CO Tier 2 packs.
...
/**
 * ${p.slug} â€” CO Tier 2 Wave 1
 */
export const ${p.exportName}: CountyIntelligencePack = finalizeCoTier2Pack({
  countySlug: '${p.slug}',
...
`;
  ...
  const outPath = join(
    process.cwd(),
    'lib/local-movers/county-intelligence/colorado',
    p.file
  );
