/**
 * Overlay IL-MOVE-001 onto committed move-network-metrics-v1 without a Supabase recount.
 */
...
if (prev.network.publishedStateIntelligencePaths.includes('/illinois')) {
  throw new Error('IL already present in network metrics; reset from main before overlay');
}
...
const input = {
  ...
  vaHhgListingRows: prev.virginia.hhgListingRows,
  vaPropertyListingRows: prev.virginia.propertyListingRows,
  vaSourceRetrievedAt: prev.virginia.retrievedAt,
  nyHhgBulletinObservations: prev.newYork.hhgBulletinObservations,
  nyBulletinIssues: prev.newYork.bulletinIssues,
  publishedStateIntelligencePaths: [...prev.network.publishedStateIntelligencePaths, '/illinois'],
