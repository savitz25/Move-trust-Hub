/**
 * Shared render for NC Tier 2 packs.
...
/**
 * ${p.slug} — NC Tier 2 Wave 1
 */
export const ${p.exportName}: CountyIntelligencePack = finalizeNcTier2Pack({
  countySlug: '${p.slug}',
...
`;
  ...
  const outPath = join(
    process.cwd(),
    'lib/local-movers/county-intelligence/north-carolina',
    p.file
  );
