...
| Hawaii | 5/5 (complete) | 6 | 10–12 (Honolulu) / 8–10 (Maui) / 6–8+ (others) | `honolulu`, `maui` 0.85 | `count-hawaii-movers.ts`, `apply-hawaii-mover-expansion.ts`, `audit-hawaii-seo.ts` |
| Alaska | 5/5 premium + 24 remote (5 each) | 5 | 10–12 (Anchorage) / 8–10 (Fairbanks, Mat-Su) / 5–7+ (others) | `anchorage` 0.85 | `count-alaska-movers.ts`, `apply-alaska-mover-expansion.ts`, `audit-alaska-seo.ts` |
| Washington | 39/39 (complete) | 6 | 12 (King) / 10 (Snohomish, Pierce) / 9 (Spokane) | `king`, `pierce`, `snohomish`, `spokane` 0.85 | `count-washington-movers.ts`, `apply-washington-mover-expansion.ts`, `audit-washington-seo.ts` |
| Oregon | 36/36 (complete) | 6 | 12 (Multnomah, Washington, Clackamas) / 9 (Lane, Marion) | `multnomah`, `washington`, `clackamas` 0.85 | `count-oregon-movers.ts`, `apply-oregon-mover-expansion.ts`, `audit-oregon-seo.ts` |
| Nevada | 17/17 (complete) | 6 | 12 (Clark) / 9 (Washoe) | `clark`, `washoe` 0.85 | `count-nevada-movers.ts`, `apply-nevada-mover-expansion.ts`, `audit-nevada-seo.ts` |
| Arizona | 15/15 (complete) | 6 | 12 (Maricopa) / 9 (Pima) | `maricopa`, `pima` 0.85 | `count-arizona-movers.ts`, `apply-arizona-mover-expansion.ts`, `audit-arizona-seo.ts` |
| New Mexico | 33/33 (complete) | 5 | 11 (Bernalillo) / 9 (Santa Fe, Doña Ana) | `bernalillo` 0.85 | `count-new-mexico-movers.ts`, `apply-new-mexico-mover-expansion.ts`, `audit-new-mexico-seo.ts` |
| Utah | 29/29 (complete) | 6 | 12 (Salt Lake) / 9 (Utah) / 8 (Davis, Weber, Washington) | `salt-lake`, `utah` 0.85 | `count-utah-movers.ts`, `apply-utah-mover-expansion.ts`, `audit-utah-seo.ts` |
| Colorado | 64/64 (complete) | 6 | 12 (Denver metro) / 11 (El Paso) / 9 (Boulder, Larimer, Weld) | `denver`, `arapahoe`, `jefferson`, `adams`, `douglas` 0.85 | `count-colorado-movers.ts`, `apply-colorado-mover-expansion.ts`, `audit-colorado-seo.ts` |
| Idaho | 44/44 (complete) | 5 | 11 (Ada) / 8 (Canyon) | `ada`, `canyon` 0.85 | `count-idaho-movers.ts`, `apply-idaho-mover-expansion.ts`, `audit-idaho-seo.ts` |
| Montana | 56/56 (complete) | 5 | 11 (Yellowstone) / 9 (Missoula, Gallatin) / 8 (Cascade) | `yellowstone`, `missoula`, `gallatin`, `cascade` 0.85 | `count-montana-movers.ts`, `apply-montana-mover-expansion.ts`, `audit-montana-seo.ts` |
| Wyoming | 23/23 (complete) | 5 | 10 (Laramie) / 9 (Natrona) / 8 (Teton) | `laramie`, `natrona`, `teton` 0.85 | `count-wyoming-movers.ts`, `apply-wyoming-mover-expansion.ts`, `audit-wyoming-seo.ts` |
| North Dakota | 53/53 (complete) | 5 | 10 (Cass) / 9 (Burleigh) / 8 (Williams, Grand Forks) | `cass`, `burleigh`, `williams`, `grand-forks` 0.85 | `count-north-dakota-movers.ts`, `apply-north-dakota-mover-expansion.ts`, `audit-north-dakota-seo.ts` |
| South Dakota | 66/66 (complete) | 5 | 11 (Minnehaha) / 10 (Pennington) / 8 (Brown, Codington, Lincoln) | `minnehaha`, `pennington` 0.85 | `count-south-dakota-movers.ts`, `apply-south-dakota-mover-expansion.ts`, `audit-south-dakota-seo.ts` |
| Nebraska | 93/93 (complete) | 5 | 12 (Douglas) / 10 (Sarpy, Lancaster) / 8 (Hall, Buffalo, Dodge) | `douglas`, `sarpy`, `lancaster` 0.85 | `count-nebraska-movers.ts`, `apply-nebraska-mover-expansion.ts`, `audit-nebraska-seo.ts` |
...
> **Minnesota note:** Minnesota has **87 counties** — **complete state curation** for a high-value Midwest market. **Hennepin County** (Minneapolis — 13 movers) and **Ramsey County** (Saint Paul — 13 movers) are the premium Twin Cities hubs covering Fortune 500 corporate headquarters (Target, US Bancorp, Best Buy), downtown high-rise logistics, state government, and University of Minnesota campus moves. **Dakota**, **Anoka**, **Washington**, **Scott**, and **Carver** (10 movers each) are Twin Cities collar counties covering fast-growth suburban family moves. **Olmsted County** (Rochester — 10 movers) covers Mayo Clinic medical professional relocations. **St. Louis County** (Duluth — 9 movers) covers Lake Superior North Shore tourism, seasonal, and second-home logistics. Rural and lakes-country counties emphasize agricultural hauls, harsh winters, remote logistics, and very long-distance Lower 48 moves at 5–7 movers minimum. Franchise #1 in Hennepin; `regional-*-mn-movers` in other counties. MN `washington`, `lincoln`, `lake`, `st-louis`, `clay`, `carver`, `scott`, `dakota`, `grant`, `douglas`, `stearns`, `rice`, `jackson`, `martin`, `watonwan`, and `steele` slugs collide with other states — nearby links use `displayLabel` disambiguation. Cross-border nearby links to Wisconsin (Pierce, St. Croix, Douglas), Iowa (Dickinson, Lyon), South Dakota (Lincoln, Moody), and North Dakota (Clay, Traverse, Wilkin). Add to `SKIP_STATES` and `CURATED_STATE_SLUGS`.

> **Iowa note:** Iowa has **99 counties** — **73 curated county guides** for a rural/specialized agricultural market (remaining 26 counties pending batch 3). **Polk County** (Des Moines metro — 12 movers) is the premium hub covering insurance and finance headquarters (Principal, Nationwide, EMC), corporate employee transfers, suburban West Des Moines/Ankeny growth, and long-distance I-35/I-80 corridor hauls. **Linn County** (Cedar Rapids — 10 movers) and **Johnson County** (Iowa City — 10 movers) form the eastern Iowa corridor covering manufacturing, University of Iowa campus moves, and healthcare-sector relocations. **Scott County** (Quad Cities / Davenport — 9 movers) covers cross-border Illinois logistics and Mississippi River manufacturing moves. **Woodbury County** (Sioux City — 8 movers) covers tri-state agricultural processing and Missouri River northwest corridor demand. Rural counties emphasize agricultural hauls (corn, soybeans, pork, ethanol), harsh winters, remote logistics, and very long-distance Lower 48 moves at 5–7 movers minimum. Franchise #1 in Polk, Linn, and Johnson; `regional-*-ia-movers` in other counties. IA `johnson`, `dallas`, `union`, `clay`, `hancock`, `washington`, `jefferson`, `madison`, `monroe`, `decatur`, `wayne`, `carroll`, `cass`, `adams`, `buchanan`, `jackson`, `henry`, `lee`, `lincoln`, `page`, and `iowa` slugs collide with other states — nearby links use `displayLabel` disambiguation. Cross-border nearby links to Illinois (Rock Island, Jo Daviess), Missouri (Clark, Putnam), Minnesota (Dakota, Mower), South Dakota (Union, Lyon), Nebraska (Douglas, Sarpy, Dakota), and Wisconsin (Grant). Add to `SKIP_STATES` and `CURATED_STATE_SLUGS`.

> **Nebraska note:** Nebraska has **93 counties** — **complete state curation** for a rural/specialized agricultural market. **Douglas County** (Omaha metro — 12 movers) is the premium hub covering corporate, suburban family moves, healthcare-sector relocations, and Offutt AFB military-adjacent demand. **Sarpy County** (Papillion / Bellevue — 10 movers) covers Omaha metro south-bank suburban growth and Offutt AFB military PCS. **Lancaster County** (Lincoln — 10 movers) covers University of Nebraska campus moves and state government transfers. **Hall** (Grand Island), **Buffalo** (Kearney), and **Dodge** (Fremont — 8 movers each) are secondary Platte Valley and eastern corridor hubs. Rural counties emphasize agricultural hauls (corn, soybeans, cattle), harsh winters, remote logistics, and very long-distance Lower 48 moves at 5–7 movers minimum. Franchise #1 in Douglas and Lancaster; `regional-*-ne-movers` in other counties. NE `buffalo`, `dodge`, `clay`, `washington`, `sheridan`, `grant`, `madison`, `cass`, `lincoln`, and `platte` slugs collide with other states — nearby links use `displayLabel` disambiguation. Cross-border nearby links to Iowa (Pottawattamie, Mills, Woodbury), Missouri, Kansas, Colorado, Wyoming, and South Dakota. Add to `SKIP_STATES` and `CURATED_STATE_SLUGS`.

> **South Dakota note:** South Dakota has **66 counties** — **complete state curation** for a rural/specialized market. **Minnehaha County** (Sioux Falls metro — 11 movers) is the premium hub covering corporate, healthcare, and Big Sioux Valley suburban growth. **Pennington County** (Rapid City / Black Hills — 10 movers) covers Mount Rushmore tourism, second-home logistics, and Ellsworth AFB military PCS. **Brown** (Aberdeen), **Codington** (Watertown), and **Lincoln** (Sioux Falls south-bank — 8 movers each) are secondary regional hubs. Black Hills counties (**Lawrence**, **Meade**, **Custer**) emphasize tourism and seasonal demand. Rural counties emphasize agricultural hauls (corn, soybeans, cattle), harsh winters, remote logistics, and very long-distance Lower 48 moves at 5–7 movers minimum. Franchise #1 in Minnehaha and Pennington; `regional-*-sd-movers` in other counties. SD `lincoln`, `clay`, `union`, `grant`, `lake`, `marshall`, `roberts`, `turner`, and `lawrence` slugs collide with other states — nearby links use `displayLabel` disambiguation. Cross-border nearby links to Minnesota (Traverse, Big Stone, Marshall), Iowa (Lyon, Clay, Woodbury), Nebraska, Wyoming (Weston, Crook), North Dakota (Dickey, Sargent, Sioux), and Montana (Carter). Add to `SKIP_STATES` and `CURATED_STATE_SLUGS`.

> **North Dakota note:** North Dakota has **53 counties** — **complete state curation** for a rural/specialized market. **Cass County** (Fargo metro — 10 movers) is the premium hub covering corporate, NDSU university, and Red River Valley suburban growth. **Burleigh County** (Bismarck — 9 movers) covers state government and regional hub relocations. **Williams County** (Williston / Bakken — 8 movers) and **Grand Forks County** (8 movers) cover energy-sector and university demand respectively. Bakken counties (**McKenzie**, **Mountrail**, **Dunn**) emphasize oil-and-gas workforce moves. Rural counties emphasize agricultural hauls, harsh winters, remote logistics, and very long-distance Lower 48 moves at 5–7 movers minimum. Franchise #1 in Cass; `regional-*-nd-movers` in other counties. ND `grand-forks`, `richland`, `walsh`, `grant`, `billings`, and `sheridan` slugs collide with other states — nearby links use `displayLabel` disambiguation. Cross-border nearby links to Minnesota (Clay, Polk, Marshall, Wilkin), South Dakota (Campbell, Perkins, Harding), and Montana (Richland). Add to `SKIP_STATES` and `CURATED_STATE_SLUGS`.

> **Wyoming note:** Wyoming has **23 counties** — **complete state curation** for a large rural/specialized market. **Laramie County** (Cheyenne — 10 movers) is the premium hub covering state government, F.E. Warren AFB military PCS, and I-25 Front Range regional hub moves. **Natrona County** (Casper — 9 movers) covers oil-and-gas energy-sector relocations and North Platte basin demand. **Teton County** (Jackson Hole — 8 movers) covers luxury resort, tourism, and second-home logistics. Energy counties (**Campbell** Powder River Basin, **Sweetwater** trona/I-80 corridor) emphasize mining and energy workforce moves. Rural counties emphasize harsh winters, remote ranch properties, agricultural hauls, and very long-distance Lower 48 moves at 5–7 movers minimum. Franchise #1 in Laramie and Natrona; `regional-*-wy-movers` in other counties. WY `laramie`, `lincoln`, `carbon`, `teton`, and `albany` slugs collide with other states — nearby links use `displayLabel` disambiguation. Cross-border nearby links to Colorado (Larimer, Weld, Moffat), Montana (Powder River, Gallatin), Idaho (Teton), Utah (Summit), Nebraska (Scotts Bluff, Kimball), and South Dakota (Lawrence). Add to `SKIP_STATES` and `CURATED_STATE_SLUGS`.

> **Montana note:** Montana has **56 counties** — **complete state curation** for a large rural/specialized market. **Yellowstone County** (Billings — 11 movers) is the premium hub covering regional corporate, energy-sector, and agricultural corridor moves. **Missoula** and **Gallatin** (Bozeman — 9 movers each) cover university, tourism, outdoor-lifestyle, and rapid growth corridors. **Cascade** (Great Falls — 8 movers) covers Malmstrom AFB military PCS and central Montana agricultural logistics. Tourism counties (**Flathead** Glacier gateway, **Park** Livingston, **Madison** Big Sky) emphasize second-home and seasonal resort logistics. Rural Hi-Line and plains counties emphasize harsh winters, remote logistics, and long-distance Lower 48 hauls at 5–7 movers minimum. Franchise #1 in Yellowstone, Gallatin, and Missoula; `regional-*-mt-movers` in other counties. MT `jefferson`, `madison`, `lincoln`, `carbon`, `valley`, `lake`, `garfield`, `sheridan`, and `broadwater` slugs collide with other states — nearby links use `displayLabel` disambiguation. Cross-border nearby links to North Dakota (Williams, McKenzie), South Dakota (Harding), Wyoming (Campbell, Teton), Idaho (Clearwater, Bonner), Oregon (Malheur), and Washington (Spokane). Add to `SKIP_STATES` and `CURATED_STATE_SLUGS`.

> **Idaho note:** Idaho has **44 counties** — **complete state curation** for a rural/specialized fast-growing market. **Ada County** (Boise metro — 11 movers) is the premium hub covering tech/corporate growth, Treasure Valley suburban family moves, and rapid population expansion. **Canyon County** (Nampa–Caldwell — 8 movers) is the secondary Treasure Valley hub. Tourism counties (**Blaine** Sun Valley, **Kootenai** Coeur d'Alene, **Valley** McCall, **Teton** Driggs) emphasize second-home, retirement, and seasonal resort logistics. Rural counties emphasize agricultural hauls, long-distance relocations, and remote logistics at 5–7 movers minimum. Franchise #1 in Ada and Canyon; `regional-*-id-movers` in other counties. ID `washington`, `lincoln`, `adams`, `franklin`, `jefferson`, `clark`, `teton`, and `idaho` slugs collide with other states — nearby links use `displayLabel` disambiguation. Cross-border nearby links to Washington (Spokane, Whitman), Oregon (Malheur), Utah (Salt Lake, Box Elder), Nevada (Elko), Montana (Lincoln), and Wyoming (Teton). Add to `SKIP_STATES` and `CURATED_STATE_SLUGS`.

> **Colorado note:** Colorado has **64 counties** — **complete state curation** for a fast-growing Front Range market. **Denver metro** (**Denver**, **Arapahoe**, **Jefferson**, **Adams**, **Douglas** — 12 movers each) is the premium hub covering tech/corporate growth, outdoor-lifestyle family moves, and dense urban/suburban logistics. **El Paso County** (Colorado Springs — 11 movers) covers Fort Carson, Peterson SFB, and Air Force Academy military PCS. **Boulder**, **Larimer** (Fort Collins), and **Weld** (Greeley — 9 movers each) are tertiary Front Range hubs. Rural counties emphasize long-distance hauls, agricultural corridors, mountain-road access, and tourism/second-home logistics at 6–8 movers minimum. Franchise #1 in Denver, Arapahoe, Jefferson, Adams, Douglas, El Paso, Boulder, and Larimer; `regional-*-co-movers` in other counties. CO `washington`, `lincoln`, `san-juan`, `bent`, `las-animas`, and `cheyenne` slugs collide with other states — nearby links use `displayLabel` disambiguation. Cross-border nearby links to Wyoming (Sweetwater, Laramie), New Mexico (Colfax), Kansas (Hamilton), and Utah (Grand). Add to `SKIP_STATES` and `CURATED_STATE_SLUGS`.

> **Utah note:** Utah has **29 counties** — **complete state curation** for a fast-growing Wasatch Front market. **Salt Lake County** (12 movers) is the premium hub covering tech/corporate growth, large family moves, and Wasatch Front suburban expansion. **Utah County** (Provo-Orem / Silicon Slopes — 9 movers) covers tech-corridor and university moves. **Davis** (Hill AFB military PCS — 8), **Weber** (Ogden — 8), and **Washington** (St. George retirement/snowbird — 8) are secondary hubs. Rural counties emphasize long-distance hauls, outdoor-lifestyle logistics, and mountain-road access at 6–8 movers minimum. Franchise #1 in Salt Lake, Utah, Davis, and Weber; `regional-*-ut-movers` in Washington and rural counties. UT `washington`, `san-juan`, `rich`, `carbon`, `wayne`, `morgan`, and `grand` slugs collide with other states — nearby links use `displayLabel` disambiguation. Cross-border nearby links to Idaho (Bonneville), Wyoming (Sweetwater), Colorado (Mesa), Nevada (Clark), Arizona (Apache), and New Mexico (San Juan). Add to `SKIP_STATES` and `CURATED_STATE_SLUGS`.

> **New Mexico note:** New Mexico has **33 counties** — **complete state curation** for a rural/specialized market. **Bernalillo County** (Albuquerque metro — 11 movers) is the premium hub covering corporate, Kirtland AFB military PCS, Sandia Labs relocations, and Rio Rancho suburban growth. **Santa Fe County** (9 movers) covers capital-city tourism, second-home, and retirement moves; **Doña Ana County** (Las Cruces — 9 movers) covers Holloman AFB/White Sands military PCS and El Paso cross-border moves. Rural counties (Catron, Harding, Union, etc.) emphasize long-distance hauls, remote logistics, and harsh terrain at 5–7 movers minimum. Franchise #1 in Bernalillo; `regional-*-nm-movers` in other counties. NM `san-juan`, `grant`, `lincoln`, `hidalgo`, `colfax`, and `union` slugs collide with other states — nearby links use `displayLabel` disambiguation. Cross-border nearby links to Texas (El Paso, Parmer), Arizona (Pima, Apache, Greenlee), Colorado (Las Animas, Costilla), and Utah (San Juan). Add to `SKIP_STATES` and `CURATED_STATE_SLUGS`.

> **Arizona note:** Arizona has **15 counties** — **complete state curation** with two distinct major markets. **Maricopa County** (Phoenix metro — 12 movers) is the premium hub covering rapid population growth, corporate/tech relocations, retirement/snowbird seasonal moves, and extreme desert heat logistics. **Pima County** (Tucson — 9 movers) covers university moves, Davis-Monthan AFB military PCS, and Oro Valley retirement communities. Rural counties (Mohave, Yuma, Greenlee, etc.) emphasize mining, border corridors, long-distance regional hauls, and very hot climate challenges at 6–10 movers. Franchise #1 in Maricopa and Pima; `regional-*-az-movers` in other counties. Cross-border nearby links to California (San Bernardino, Imperial, Riverside, San Diego) and Nevada (Clark). Add to `SKIP_STATES` and `CURATED_STATE_SLUGS`.

> **Nevada note:** Nevada has **17 counties** — **complete state curation** with two distinct major markets. **Clark County** (Las Vegas metro — 12 movers) is the premium hub covering tourism, hospitality, corporate growth, high-density housing, and Nellis AFB military PCS moves. **Washoe County** (Reno–Sparks — 9–10 movers) covers tech, manufacturing, logistics, and suburban Truckee Meadows moves. Rural counties (Elko, Humboldt, Nye, etc.) emphasize mining, remote logistics, and long-distance regional hauls at 6–10 movers. Franchise #1 in Clark and Washoe; `regional-*-nv-movers` in other counties. NV `clark`, `douglas`, `lincoln`, `humboldt`, and `eureka` slugs collide with other states — nearby links use `displayLabel` disambiguation. Cross-border nearby links to California (Los Angeles, San Bernardino, Placer, Inyo) and Arizona (Mohave, Maricopa). Add to `SKIP_STATES` and `CURATED_STATE_SLUGS`.

> **Oregon note:** Oregon has **36 counties** — **complete state curation** with distinct regional markets. **Portland metro** (**Multnomah**, **Washington**, **Clackamas** — 12 movers each) emphasizes tech, corporate, and high-density urban moves. **Willamette Valley** (**Lane**, **Marion**, **Polk**, **Benton**, **Linn**, **Yamhill** — 9–10 movers) covers suburban, university, and agricultural moves. **Central Oregon** (**Deschutes**, **Crook**, **Jefferson**), **Coast** (**Clatsop**, **Tillamook**, **Lincoln**, **Coos**, **Curry**), and **Eastern Oregon** emphasize rural and long-distance regional hauls. Franchise #1 in Multnomah, Washington, Clackamas, and Lane; `regional-*-or-movers` in other counties. OR `columbia`, `lincoln`, `washington`, `grant`, `lake`, and `jefferson` slugs collide with other states — nearby links use `displayLabel` disambiguation. Cross-border nearby links to Washington (Clark, King) and California (Siskiyou, Del Norte) and Idaho (Ada). Add to `SKIP_STATES` and `CURATED_STATE_SLUGS`.

> **Washington note:** Washington has **39 counties** — **complete state curation** with two distinct markets. **Western Washington** (Puget Sound: **King** 12 movers, **Snohomish**/**Pierce** 10 each, Kitsap, Island, etc.) emphasizes tech-corridor, corporate, military (JBLM), and high-density urban moves. **Eastern Washington** (**Spokane** 9–10, Tri-Cities, Yakima, rural plateau counties 6–10) emphasizes suburban/rural, agricultural, and longer regional hauls. Franchise #1 in King, Pierce, Snohomish, Spokane, and Clark; `regional-*-wa-movers` in all other counties. WA `columbia`, `lincoln`, and `jefferson` slugs collide with other states — nearby links use `displayLabel` disambiguation; Pend Oreille Newport is WA (not RI). Cross-border nearby links to Oregon (Multnomah, Washington County OR) and Idaho (Kootenai, Bonner, Latah). Add to `SKIP_STATES` and `CURATED_STATE_SLUGS`.

> **Alaska note:** Alaska is a **large remote state** — not a mainland metro. **29 boroughs/census areas** total. Premium curation on **5 major population centers**: **Anchorage Municipality**, **Matanuska-Susitna**, **Fairbanks North Star**, **Kenai Peninsula**, and **Juneau** (research, testimonials, 8–10 movers). **Anchorage** uses Two Men and a Truck franchise #1; other curated boroughs use `regional-*-ak-movers`. Remote boroughs (Sitka, Kodiak, Bethel, etc.) keep generated `alaska-region-*` pools with 5 movers minimum. Nearby links include inter-borough guides plus Washington Lower 48 hubs (King, Snohomish) for long-distance moves. Content emphasizes military PCS, oil & gas, winter logistics, and remote access. Add to `SKIP_STATES` and `CURATED_STATE_SLUGS`.

> **Hawaii note:** Hawaii is an **island archipelago** — not a mainland state. **5 counties** — complete state curation. **Honolulu** (Oahu) uses Two Men and a Truck franchise #1; **Hawaii** (Big Island), **Maui**, **Kauai**, and remote **Kalawao** use `regional-*-hi-movers`. HI state slug and **Hawaii County** slug both use `hawaii` — nearby links use `displayLabel` disambiguation (Big Island vs state). Nearby links include inter-island counties plus mainland long-distance hubs (Los Angeles CA, King WA, Harris TX). Content must differentiate inter-island vs mainland-to-Hawaii moves. Add to `SKIP_STATES` and `CURATED_STATE_SLUGS`.
