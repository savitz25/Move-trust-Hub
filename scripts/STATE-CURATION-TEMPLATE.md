...
| Washington | 19/39 (expanding) | 10 | 10 (curated counties) | `king`, `pierce`, `snohomish`, `spokane` 0.85 | `count-washington-movers.ts`, `apply-washington-mover-expansion.ts`, `audit-washington-seo.ts` |

> **Washington note:** Washington has **39 counties** — curation is **expanding statewide**. **19 premium hubs** curated: Puget Sound (**King**, **Pierce**, **Snohomish**, **Kitsap**, **Island**, **Skagit**, **Whatcom**), regional (**Spokane**, **Clark**, **Thurston**, **Yakima**, **Benton**, **Franklin**, **Grant**, **Chelan**, **Cowlitz**, **Lewis**, **Clallam**, **Grays Harbor**) — 10 movers each. Franchise #1 in King, Pierce, Snohomish, Spokane, and Clark; `regional-*-wa-movers` in all other curated counties. Remaining counties keep generated `washington-region-*` metro fallback. Cross-county nearby links among curated hubs. Add to `SKIP_STATES` and `CURATED_STATE_SLUGS`.
