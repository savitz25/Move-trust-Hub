...
| Washington | 39/39 (complete) | 10 | 10 (all counties) | `king`, `pierce`, `snohomish`, `spokane` 0.85 | `count-washington-movers.ts`, `apply-washington-mover-expansion.ts`, `audit-washington-seo.ts` |

> **Washington note:** Washington has **39 counties** — **complete state curation**. Puget Sound (**King**, **Pierce**, **Snohomish**, **Kitsap**, **Island**, **Skagit**, **Whatcom**, **Mason**, **Jefferson**, **San Juan**), regional (**Spokane**, **Clark**, **Thurston**, **Yakima**, **Benton**, **Franklin**, **Grant**, **Chelan**, **Cowlitz**, **Lewis**, **Clallam**, **Grays Harbor**, **Pacific**, **Wahkiakum**, **Skamania**, **Klickitat**), and eastern rural (**Walla Walla**, **Stevens**, **Kittitas**, **Whitman**, **Douglas**, **Okanogan**, **Asotin**, **Adams**, **Pend Oreille**, **Lincoln**, **Ferry**, **Columbia**, **Garfield**) — 10 movers each. Franchise #1 in King, Pierce, Snohomish, Spokane, and Clark; `regional-*-wa-movers` in all other counties. WA `columbia`, `lincoln`, and `jefferson` slugs collide with other states — nearby links use `displayLabel` disambiguation; Pend Oreille Newport is WA (not RI). Cross-county nearby links statewide. Add to `SKIP_STATES` and `CURATED_STATE_SLUGS`.
