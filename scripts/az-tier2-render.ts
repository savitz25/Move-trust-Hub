/**
 * Shared render for AZ Tier 2 packs.
...
/**
 * ${p.slug} — AZ Tier 2 Wave 1
 */
export const ${p.exportName}: CountyIntelligencePack = finalizeAzTier2Pack({
  countySlug: '${p.slug}',
...
`;
  ...
  const outPath = join(
    process.cwd(),
    'lib/local-movers/county-intelligence/arizona',
    p.file
  );
