/**
 * Shared render for WA Tier 2 packs.
...
/**
 * ${p.slug} â€” WA Tier 2 Wave 1
 */
export const ${p.exportName}: CountyIntelligencePack = finalizeWaTier2Pack({
  countySlug: '${p.slug}',
...
`;
  ...
  const outPath = join(
    process.cwd(),
    'lib/local-movers/county-intelligence/washington',
    p.file
  );
