/**
 * One-shot script: expand SC curated assignments to minimum 5 movers (10 for major metros).
 * Run: npx tsx scripts/apply-south-carolina-mover-expansion.ts
 */
...
const assignmentsPath = 'data/south-carolina-county-assignments.ts';
...
for (const county of scCounties) {
