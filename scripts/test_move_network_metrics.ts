...
function baseInput(over: Partial<MoveNetworkMetricsInput> = {}): MoveNetworkMetricsInput {
  return {
    ...
    vaHhgListingRows: 192,
    vaPropertyListingRows: 4916,
    vaSourceRetrievedAt: '2026-09-10T15:05:33.623358+00:00',
    nyHhgBulletinObservations: 108,
    nyBulletinIssues: 36,
    orAuthorizedHhgListRows: 113,
    orDistinctCertificateIds: 113,
    paHhgOperatorListRows: 269,
    paHhgDistinctUtilityCodes: 267,
    ncHhgListRows: 362,
    ncHhgDistinctCNumbers: 362,
    gaHhgListingRows: 572,
    gaHhgDistinctMca: 380,
    publishedStateIntelligencePaths: ['/florida', '/new-jersey', '/california', '/texas', '/washington', '/colorado', '/virginia', '/new-york', '/illinois', '/oregon', '/pennsylvania', '/north-carolina', '/ohio', '/georgia'],
