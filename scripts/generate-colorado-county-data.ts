/**
 * Generates all 64 Colorado county curation files (batch 1–4).
...
const DISPLAY_LABELS: Partial<Record<string, string>> = {
  ...
  lake: 'Lake County, CO',
  washington: 'Washington County, CO',
  lincoln: 'Lincoln County, CO',
  jackson: 'Jackson County, CO',
  bent: 'Bent County, CO',
  cheyenne: 'Cheyenne County, CO',
  mineral: 'Mineral County, CO',
  'san-juan': 'San Juan County, CO',
  custer: 'Custer County, CO',
  'rio-blanco': 'Rio Blanco County, CO',
  kiowa: 'Kiowa County, CO',
};
...
const CO_NEIGHBORS: Record<string, string[]> = {
  ...
  saguache: ['alamosa', 'rio-grande', 'costilla', 'mineral', 'hinsdale'],
  'rio-blanco': ['moffat', 'garfield', 'eagle', 'routt', 'jackson'],
  gilpin: ['clear-creek', 'jefferson', 'boulder', 'grand', 'summit'],
  crowley: ['otero', 'pueblo', 'prowers', 'kiowa', 'las-animas'],
  lincoln: ['elbert', 'arapahoe', 'washington', 'kit-carson', 'cheyenne'],
  bent: ['las-animas', 'prowers', 'kiowa', 'baca', 'pueblo'],
  custer: ['fremont', 'pueblo', 'huerfano', 'saguache', 'park'],
  ouray: ['montrose', 'san-miguel', 'san-juan', 'hinsdale', 'gunnison'],
  washington: ['logan', 'yuma', 'morgan', 'weld', 'phillips'],
  phillips: ['washington', 'yuma', 'logan', 'sedgwick', 'morgan'],
  costilla: ['alamosa', 'conejos', 'saguache', 'huerfano', 'rio-grande'],
  baca: ['bent', 'prowers', 'las-animas', 'kiowa', 'pueblo'],
  dolores: ['montezuma', 'san-miguel', 'mesa', 'san-juan', 'ouray'],
  sedgwick: ['logan', 'phillips', 'yuma', 'kit-carson', 'cheyenne'],
  cheyenne: ['kit-carson', 'yuma', 'logan', 'lincoln', 'kiowa'],
  kiowa: ['elbert', 'lincoln', 'crowley', 'bent', 'baca'],
  jackson: ['routt', 'grand', 'larimer', 'moffat', 'rio-blanco'],
  mineral: ['archuleta', 'rio-grande', 'saguache', 'hinsdale', 'ouray'],
  'san-juan': ['ouray', 'san-miguel', 'dolores', 'la-plata', 'archuleta'],
  hinsdale: ['lake', 'gunnison', 'ouray', 'mineral', 'saguache'],
};
...
const COUNTIES: CountyDef[] = [
  ...
  },
  {
    ...
    seat: 'Saguache',
    city: 'Saguache',
    metro: 'saguache-metro-co',
    costTier: 'rural',
    citySlug: 'saguache',
    regional1: 'saguache-corridor',
    regional2: 'san-luis-central',
    topId: 'regional-saguache-co-movers',
    topName: 'Regional Saguache / Saguache County Providers',
    regional1Name: 'Saguache Corridor Moving',
    regional2Name: 'San Luis Central Moving',
    marketNotes:
    ...
    costNote:
      'Saguache County pricing reflects San Luis Valley demand, rural travel distances, and competition among regional agents serving central Colorado communities.',
    tipVariant: 'rural',
  },
  {
    slug: 'rio-blanco',
    ...
    seat: 'Meeker',
    city: 'Meeker',
    metro: 'rio-blanco-metro-co',
    costTier: 'rural',
    citySlug: 'meeker',
    regional1: 'meeker-corridor',
    regional2: 'white-river-valley',
    topId: 'regional-rioblanco-co-movers',
    topName: 'Regional Meeker / Rio Blanco Providers',
    regional1Name: 'Meeker Corridor Moving',
    regional2Name: 'White River Valley Moving',
    marketNotes:
    ...
    costNote:
      'Rio Blanco County pricing reflects Meeker-area demand, northwest Colorado travel distances, and competition among regional agents serving rural corridor communities.',
    tipVariant: 'rural',
  },
  {
    slug: 'gilpin',
    ...
    seat: 'Central City',
    city: 'Central City',
    metro: 'gilpin-metro-co',
    costTier: 'western_slope',
    citySlug: 'central-city',
    regional1: 'central-city-corridor',
    regional2: 'gambling-district',
    topId: 'regional-gilpin-co-movers',
    topName: 'Regional Central City / Gilpin Providers',
    regional1Name: 'Central City Corridor Moving',
    regional2Name: 'Gambling District Moving',
    marketNotes:
    ...
    costNote:
      'Gilpin County pricing reflects Central City-area demand, I-70 mountain corridor traffic, Denver metro spillover, and competition among regional agents serving west-metro mountain communities.',
    tipVariant: 'mountain',
  },
  {
    slug: 'crowley',
    ...
    seat: 'Ordway',
    city: 'Ordway',
    metro: 'crowley-metro-co',
    costTier: 'rural',
    citySlug: 'ordway',
    regional1: 'ordway-corridor',
    regional2: 'arkansas-valley-east',
    topId: 'regional-crowley-co-movers',
    topName: 'Regional Ordway / Crowley Providers',
    regional1Name: 'Ordway Corridor Moving',
    regional2Name: 'Arkansas Valley East Moving',
    marketNotes:
    ...
    costNote:
      'Crowley County pricing reflects Ordway-area demand, eastern plains travel distances, and competition among regional agents serving southeastern Colorado communities.',
    tipVariant: 'rural',
  },
  {
    slug: 'lincoln',
    ...
    seat: 'Hugo',
    city: 'Hugo',
    metro: 'lincoln-metro-co',
    costTier: 'rural',
    citySlug: 'hugo',
    regional1: 'hugo-corridor',
    regional2: 'eastern-i-70',
    topId: 'regional-lincoln-co-movers',
    topName: 'Regional Hugo / Lincoln Providers',
    regional1Name: 'Hugo Corridor Moving',
    regional2Name: 'Eastern I-70 Moving',
    marketNotes:
    ...
    costNote:
      'Lincoln County pricing reflects Hugo-area demand, eastern plains travel distances, and competition among regional agents serving northeastern Colorado communities.',
    tipVariant: 'rural',
  },
  {
    slug: 'bent',
    ...
    costTier: 'rural',
    citySlug: 'las-animas',
    regional1: 'las-animas-corridor',
    regional2: 'arkansas-valley-south',
    topId: 'regional-bent-co-movers',
    topName: 'Regional Las Animas / Bent Providers',
    regional1Name: 'Las Animas Corridor Moving',
    regional2Name: 'Arkansas Valley South Moving',
    marketNotes:
    ...
    costNote:
      'Bent County pricing reflects Las Animas-area demand, southeastern plains travel distances, and competition among regional agents serving rural Arkansas Valley communities.',
    tipVariant: 'rural',
  },
  {
    slug: 'custer',
    ...
    seat: 'Westcliffe',
    city: 'Westcliffe',
    metro: 'custer-metro-co',
    costTier: 'rural',
    citySlug: 'westcliffe',
    regional1: 'westcliffe-corridor',
    regional2: 'wet-mountain-valley',
    topId: 'regional-custer-co-movers',
    topName: 'Regional Westcliffe / Custer Providers',
    regional1Name: 'Westcliffe Corridor Moving',
    regional2Name: 'Wet Mountain Valley Moving',
    marketNotes:
    ...
    costNote:
      'Custer County pricing reflects Westcliffe-area demand, mountain-access logistics, and competition among regional agents serving central Colorado mountain communities.',
    tipVariant: 'mountain',
  },
  {
    slug: 'ouray',
    ...
    seat: 'Ouray',
    city: 'Ouray',
    metro: 'ouray-metro-co',
    costTier: 'metro',
    citySlug: 'ouray',
    regional1: 'ouray-corridor',
    regional2: 'million-dollar-highway',
    topId: 'regional-ouray-co-movers',
    topName: 'Regional Ouray / Ouray County Providers',
    regional1Name: 'Ouray Corridor Moving',
    regional2Name: 'Million Dollar Highway Moving',
    marketNotes:
    ...
    costNote:
      'Ouray County pricing reflects Ouray tourism demand, mountain-access logistics, vacation-rental turnover, and competition among regional agents serving southwestern Colorado resort communities.',
    tipVariant: 'tourist_mountain',
  },
  {
    slug: 'washington',
    ...
    seat: 'Akron',
    city: 'Akron',
    metro: 'washington-metro-co',
    costTier: 'rural',
    citySlug: 'akron',
    regional1: 'akron-corridor',
    regional2: 'eastern-plains-northeast',
    topId: 'regional-washington-co-movers',
    topName: 'Regional Akron / Washington Providers',
    regional1Name: 'Akron Corridor Moving',
    regional2Name: 'Eastern Plains Northeast Moving',
    marketNotes:
    ...
    costNote:
      'Washington County pricing reflects Akron-area demand, eastern plains travel distances, and competition among regional agents serving northeastern Colorado communities.',
    tipVariant: 'rural',
  },
  {
    slug: 'phillips',
    ...
    seat: 'Holyoke',
    city: 'Holyoke',
    metro: 'phillips-metro-co',
    costTier: 'rural',
    citySlug: 'holyoke',
    regional1: 'holyoke-corridor',
    regional2: 'eastern-plains-border',
    topId: 'regional-phillips-co-movers',
    topName: 'Regional Holyoke / Phillips Providers',
    regional1Name: 'Holyoke Corridor Moving',
    regional2Name: 'Eastern Plains Border Moving',
    marketNotes:
    ...
    costNote:
      'Phillips County pricing reflects Holyoke-area demand, eastern plains travel distances, and competition among regional agents serving northeastern border communities.',
    tipVariant: 'rural',
  },
  {
    slug: 'costilla',
    ...
    seat: 'San Luis',
    city: 'San Luis',
    metro: 'costilla-metro-co',
    costTier: 'rural',
    citySlug: 'san-luis',
    regional1: 'san-luis-corridor',
    regional2: 'culebra-range',
    topId: 'regional-costilla-co-movers',
    topName: 'Regional San Luis / Costilla Providers',
    regional1Name: 'San Luis Corridor Moving',
    regional2Name: 'Culebra Range Moving',
    marketNotes:
    ...
    costNote:
      'Costilla County pricing reflects San Luis-area demand, southern valley travel distances, and competition among regional agents serving rural San Luis Valley communities.',
    tipVariant: 'rural',
  },
  {
    slug: 'baca',
    ...
    regional1: 'springfield-corridor',
    regional2: 'southeast-corner',
    topId: 'regional-baca-co-movers',
    topName: 'Regional Springfield / Baca Providers',
    regional1Name: 'Springfield Corridor Moving',
    ...
    costNote:
      'Baca County pricing reflects Springfield-area demand, southeastern plains travel distances, and competition among regional agents serving rural frontier communities.',
    tipVariant: 'rural',
  },
  {
    slug: 'dolores',
    ...
    seat: 'Dove Creek',
    city: 'Dove Creek',
    metro: 'dolores-metro-co',
    costTier: 'rural',
    citySlug: 'dove-creek',
    regional1: 'dove-creek-corridor',
    regional2: 'four-corners-west',
    topId: 'regional-dolores-co-movers',
    topName: 'Regional Dove Creek / Dolores Providers',
    regional1Name: 'Dove Creek Corridor Moving',
    regional2Name: 'Four Corners West Moving',
    marketNotes:
    ...
    costNote:
      'Dolores County pricing reflects Dove Creek-area demand, southwestern rural travel distances, and competition among regional agents serving four corners gateway communities.',
    tipVariant: 'rural',
  },
  {
    slug: 'sedgwick',
    ...
    seat: 'Julesburg',
    city: 'Julesburg',
    metro: 'sedgwick-metro-co',
    costTier: 'rural',
    citySlug: 'julesburg',
    regional1: 'julesburg-corridor',
    regional2: 'nebraska-border',
    topId: 'regional-sedgwick-co-movers',
    topName: 'Regional Julesburg / Sedgwick Providers',
    regional1Name: 'Julesburg Corridor Moving',
    regional2Name: 'Nebraska Border Moving',
    marketNotes:
    ...
    costNote:
      'Sedgwick County pricing reflects Julesburg-area demand, northeastern border travel distances, and competition among regional agents serving rural corridor communities.',
    tipVariant: 'rural',
  },
  {
    slug: 'cheyenne',
    ...
    seat: 'Cheyenne Wells',
    city: 'Cheyenne Wells',
    metro: 'cheyenne-metro-co',
    costTier: 'rural',
    citySlug: 'cheyenne-wells',
    regional1: 'cheyenne-wells-corridor',
    regional2: 'eastern-plains-southeast',
    topId: 'regional-cheyenne-co-movers',
    topName: 'Regional Cheyenne Wells / Cheyenne Providers',
    regional1Name: 'Cheyenne Wells Corridor Moving',
    regional2Name: 'Eastern Plains Southeast Moving',
    marketNotes:
    ...
    costNote:
      'Cheyenne County pricing reflects Cheyenne Wells-area demand, eastern plains travel distances, and competition among regional agents serving rural southeastern Colorado communities.',
    tipVariant: 'rural',
  },
  {
    slug: 'kiowa',
    ...
    seat: 'Eads',
    city: 'Eads',
    metro: 'kiowa-metro-co',
    costTier: 'rural',
    citySlug: 'eads',
    regional1: 'eads-corridor',
    regional2: 'high-plains-east',
    topId: 'regional-kiowa-co-movers',
    topName: 'Regional Eads / Kiowa Providers',
    regional1Name: 'Eads Corridor Moving',
    ...
    costNote:
      'Kiowa County pricing reflects Eads-area demand, eastern plains travel distances, and competition among regional agents serving rural high plains communities.',
    tipVariant: 'rural',
  },
  {
    slug: 'jackson',
    ...
    seat: 'Walden',
    city: 'Walden',
    metro: 'jackson-metro-co',
    costTier: 'rural',
    citySlug: 'walden',
    regional1: 'walden-corridor',
    regional2: 'north-park',
    topId: 'regional-jackson-co-movers',
    topName: 'Regional Walden / Jackson Providers',
    regional1Name: 'Walden Corridor Moving',
    regional2Name: 'North Park Moving',
    marketNotes:
    ...
    costNote:
      'Jackson County pricing reflects Walden-area demand, North Park mountain-access logistics, and competition among regional agents serving remote north-central Colorado communities.',
    tipVariant: 'mountain',
  },
  {
    slug: 'mineral',
    ...
    seat: 'Creede',
    city: 'Creede',
    metro: 'mineral-metro-co',
    costTier: 'rural',
    citySlug: 'creede',
    regional1: 'creede-corridor',
    regional2: 'san-juan-north',
    topId: 'regional-mineral-co-movers',
    topName: 'Regional Creede / Mineral Providers',
    regional1Name: 'Creede Corridor Moving',
    regional2Name: 'San Juan North Moving',
    marketNotes:
    ...
    costNote:
      'Mineral County pricing reflects Creede-area demand, high-mountain access logistics, and competition among regional agents serving remote San Juan communities.',
    tipVariant: 'mountain',
  },
  {
    slug: 'san-juan',
    ...
    seat: 'Silverton',
    city: 'Silverton',
    metro: 'san-juan-metro-co',
    costTier: 'metro',
    citySlug: 'silverton',
    regional1: 'silverton-corridor',
    regional2: 'san-juan-alpine',
    topId: 'regional-sanjuan-co-movers',
    topName: 'Regional Silverton / San Juan Providers',
    regional1Name: 'Silverton Corridor Moving',
    regional2Name: 'San Juan Alpine Moving',
    marketNotes:
    ...
    costNote:
      'San Juan County pricing reflects Silverton tourism demand, alpine mountain-access logistics, vacation-rental turnover, and competition among regional agents serving high-alpine resort communities.',
    tipVariant: 'tourist_mountain',
  },
  {
    slug: 'hinsdale',
    ...
    seat: 'Lake City',
    city: 'Lake City',
    metro: 'hinsdale-metro-co',
    costTier: 'rural',
    citySlug: 'lake-city',
    regional1: 'lake-city-corridor',
    regional2: 'remote-san-juan',
    topId: 'regional-hinsdale-co-movers',
    topName: 'Regional Lake City / Hinsdale Providers',
    regional1Name: 'Lake City Corridor Moving',
    regional2Name: 'Remote San Juan Moving',
    marketNotes:
    ...
    costNote:
      'Hinsdale County pricing reflects Lake City-area demand, remote mountain-access logistics, limited crew availability, and competition among regional agents serving isolated San Juan communities.',
    tipVariant: 'mountain',
  },
];
