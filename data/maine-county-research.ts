...
export const maineCountyResearch: Record<string, CuratedCountyResearch> = {
  cumberland: {
    ...
    tips: [
      'Treat Cumberland as Portland metro product (peninsula, South Portland, lakeside suburbs) — not York seacoast south or Bangor north.',
      'Survey peninsula elevators, tight streets, and winter ice separately from Westbrook–Gorham suburban HOAs.',
      'Price I-295 · I-95 · US-1 · ME-25 portal time honestly for cross-zone pairs.',
      ...
      'Peak tourism May–September compresses Portland fleets — book early for peninsula windows.',
    ],
  },
  york: {
    marketNotes:
    ...
    tips: [
      'Treat York as Biddeford–Saco / southern seacoast product — not a Portland peninsula south clone.',
      'Price I-95 · US-1 · ME-109 · ME-111 portal time honestly; summer tourism rewrites US-1 curb windows.',
      'Short NH border hops (Kittery–Berwick edges) need FMCSA even when map miles look local.',
      'For pure in-state Maine jobs insist on written estimates and insurance; FMCSA for interstate legs.',
      'Survey coastal multi-unit and older seacoast stock separately from Sanford inland product.',
    ],
  },
  penobscot: {
    marketNotes:
    ...
    tips: [
      'Treat Penobscot as Bangor regional hub — not Portland density renamed north.',
      'Price I-95 · US-2 · ME-15 portal time honestly; long rural approaches add empty miles.',
      'UMaine semester peaks near Orono cluster multi-unit curb demand in August and January.',
      'For pure in-state Maine jobs insist on written estimates and insurance; FMCSA for interstate legs.',
      'Winter ice and longer Bangor–rural staging reshape crew timing more than packing skill alone.',
    ],
  },
  kennebec: {
    marketNotes:
    ...
    tips: [
      'Treat Kennebec as Augusta capital product — not Portland north or Bangor spillover.',
      'Price I-95 · US-201 · US-202 portal time honestly for capital ↔ Waterville pairs.',
      'Capital workforce mid-month calendars often matter more than Saturday peaks.',
      'For pure in-state Maine jobs insist on written estimates and insurance; FMCSA for interstate legs.',
      'Survey river-town access (Hallowell–Gardiner) separately from Augusta multi-unit cores.',
    ],
  },
  androscoggin: {
    marketNotes:
    ...
    tips: [
      'Treat Androscoggin as Lewiston–Auburn mill-city densification — not Portland west clones.',
      'Survey older mill multi-unit stairs and river-crossing freeflow separately from suburban edges.',
      'Price I-95 · ME-4 · ME-11 · US-202 portal time honestly for L-A twin-city pairs.',
      'For pure in-state Maine jobs insist on written estimates and insurance; FMCSA for interstate legs.',
      'Prefer mid-week early starts; winter ice and mill-stair surveys dominate estimate risk.',
    ],
  },
  aroostook: {
    marketNotes:
