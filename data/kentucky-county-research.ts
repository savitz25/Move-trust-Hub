...
export const kentuckyCountyResearch: Record<string, CuratedCountyResearch> = {
  jefferson: {
    ...
    tips: [
      'Label every job Jefferson County, Kentucky (Louisville) — never apply Jefferson County, Missouri assumptions.',
      'Survey East End multi-unit and HOA product separately from South End and West End older stock.',
      'Price I-64 / I-65 / I-71 / I-264 / I-265 portal time honestly for cross-zone pairs.',
      'Verify KYTC Division of Motor Carriers household goods license (DMT/DVR) for pure in-state jobs; FMCSA for IN/OH or other interstate legs.',
      'Prefer mid-week early starts; winter ice and summer humidity reshape outdoor carries.',
    ],
  },
  fayette: {
    marketNotes:
    ...
    tips: [
      'Treat Fayette as Lexington horse-country and university product — not a Louisville neighborhood clone.',
      'Price I-64 / I-75 / US-60 / US-27 / New Circle portal time honestly for city ↔ suburb pairs.',
      'Plan UK lease waves into campus-adjacent multi-unit estimates; collect HOA packets for horse-country edges.',
      'Verify KYTC household goods certificate for pure in-state jobs; FMCSA for interstate legs.',
  ...
  kenton: {
    ...
    tips: [
      'Treat Kenton as Northern Kentucky / Covington–Cincinnati collar — not Louisville north.',
      'Price I-71/75 / I-275 / KY-16 / KY-17 portal time honestly; Ohio destinations flip jobs to FMCSA.',
      'Survey urban Covington multi-unit stairs separately from suburban HOA multi-family.',
      'Verify KYTC household goods certificate for pure in-state jobs; FMCSA for Ohio or other interstate legs.',
      'Prefer mid-week starts; bridge freeflow and winter ice reshape outdoor carries.',
    ],
  },
  warren: {
    marketNotes:
    ...
    tips: [
      'Treat Warren as Bowling Green south-central regional hub — not Louisville south spillover.',
      'Price I-65 / US-31W / US-68 portal time honestly for city ↔ suburb pairs.',
      'Plan campus and manufacturing calendars into multi-unit estimates.',
      'Verify KYTC household goods certificate for pure in-state jobs; FMCSA for TN or other interstate legs.',
      'Prefer mid-week mornings; winter ice and summer heat reshape outdoor carries.',
    ],
  },
  boone: {
    marketNotes:
    ...
    tips: [
      'Treat Boone as Florence / CVG airport corridor growth — not a Kenton urban clone.',
      'Price I-71/75 / I-275 / KY-18 / KY-237 / CVG approach portal time honestly.',
      'Collect HOA packets for multi-family growth; plan airport freeflow into crew windows.',
      'Verify KYTC household goods certificate for pure in-state jobs; FMCSA for OH/IN interstate legs.',
      'Prefer mid-week early starts; school peaks pack North Kentucky fleets first.',
    ],
  },
  hardin: {
    marketNotes:
    ...
    tips: [
      'Treat Hardin as Elizabethtown / I-65 regional with Fort Knox adjacency where accurate — not Louisville clone.',
      'Price I-65 / US-31W / KY-313 portal time honestly; empty miles matter on military-adjacent moves.',
      'Capture PCS/hard report dates and storage-in-transit needs early for Fort Knox-adjacent households.',
      'Verify KYTC household goods certificate for pure in-state jobs; FMCSA for interstate legs.',
      'Prefer mid-week starts; school and military calendars cluster demand.',
    ],
  },
  daviess: {
    marketNotes:
