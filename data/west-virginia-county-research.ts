...
export const westVirginiaCountyResearch: Record<string, CuratedCountyResearch> = {
  kanawha: {
    ...
    tips: [
      'Treat Kanawha as Charleston capital / Kanawha Valley product — not Huntington Tri-State or Eastern Panhandle defaults.',
      'Survey hillside stairs, older multi-unit, and Capitol-area curb separately from South Hills driveways.',
      'Price I-64 · I-77 · US-60 · US-119 portal time honestly for valley cross-zone pairs.',
      'Verify WV PSC Motor Carrier household goods Certificate of Convenience and Necessity for pure in-state jobs; FMCSA for any out-of-state leg.',
      'Prefer mid-week early starts; legislative and school peaks pack capital fleets first.',
    ],
  },
  berkeley: {
    marketNotes:
    ...
    tips: [
      'Treat Berkeley as Eastern Panhandle / Martinsburg growth — not Charleston capital east clones.',
      'Price I-81 · WV-9 · US-11 portal time honestly; DC–Baltimore spillover compresses windows.',
      'Short MD / VA / PA hops need FMCSA even when map miles look local.',
      'Verify WV PSC household goods certificate for pure in-state jobs; FMCSA for interstate legs.',
      'Collect HOA packets for Inwood growth product early; photo long driveway access.',
    ],
  },
  monongalia: {
    marketNotes:
    ...
    tips: [
      'Treat Monongalia as Morgantown / WVU product — not Charleston density north.',
      'Price I-79 · I-68 · US-119 portal time honestly; hills and bridges rewrite empty miles.',
      'WVU semester peaks (August / May) and football weekends cluster multi-unit curb demand.',
      'Verify WV PSC household goods certificate for pure in-state jobs; FMCSA for PA and other interstate legs.',
      'Survey hillside stairs and campus multi-unit elevators with photos before final estimates.',
    ],
  },
  cabell: {
    marketNotes:
    ...
    tips: [
      'Treat Cabell as Huntington river city / Tri-State product — not Charleston west or Parkersburg north.',
      'Price I-64 · US-60 · WV-2 portal time honestly for twin-city and river pairs.',
      'Ohio / Kentucky short hops need FMCSA even when map miles look local.',
      'Verify WV PSC household goods certificate for pure in-state jobs; FMCSA for interstate legs.',
      'Marshall semester peaks cluster older multi-unit curb; survey stairs early.',
    ],
  },
  wood: {
    marketNotes:
    ...
    tips: [
      'Treat Wood as Parkersburg / Ohio River mid-Ohio Valley product — not Huntington north clones.',
      'Price I-77 · US-50 · WV-2 portal time honestly for Vienna / Mineral Wells pairs.',
      'Ohio border hops need FMCSA even when river crossings look local on a map.',
      'Verify WV PSC household goods certificate for pure in-state jobs; FMCSA for interstate legs.',
      'Survey river-edge industrial freeflow and older multi-unit stairs separately from suburban stock.',
    ],
  },
  raleigh: {
    marketNotes:
