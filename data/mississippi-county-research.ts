...
export const mississippiCountyResearch: Record<string, CuratedCountyResearch> = {
  harrison: {
    ...
    tips: [
      'Treat Harrison as Gulfport–Biloxi coastal product — not Jackson metro south spillover.',
      'Price I-10 / US-90 / US-49 portal time honestly; tourism peaks rewrite local freeflow.',
      'Survey coastal multi-unit elevators separately from inland SFH; hurricane-season contingency matters.',
      'Verify MDOT household goods authority for pure in-state jobs; FMCSA for interstate legs.',
      'Prefer mid-week shoulder-season starts outside peak tourism weekends when flexible.',
    ],
  },
  hinds: {
    marketNotes:
    ...
    tips: [
      'Treat Hinds as Jackson the city / capital metro core — not Jackson County Gulf Coast product.',
      'Survey downtown multi-unit and older neighborhood stock separately from suburban multi-family edges.',
      'Price I-55 / I-20 / US-49 / US-51 portal time honestly for capital cross-zone pairs.',
      'Verify MDOT household goods carrier authority for pure in-state jobs; FMCSA for interstate legs.',
      'Prefer mid-week early starts; summer heat and humidity reshape outdoor carries.',
    ],
  },
  desoto: {
    marketNotes:
    ...
    tips: [
      'Treat DeSoto as Southaven / Olive Branch Memphis collar — not central Mississippi Jackson metro.',
      'Clarify Tennessee destinations early — short Memphis-side hops often need FMCSA.',
      'Price I-55 / I-69 / US-51 / US-78 portal time honestly for collar pairs.',
      'Verify MDOT household goods authority for pure in-state jobs; FMCSA for TN or other interstate legs.',
      'Prefer mid-week early starts; school peaks pack Memphis-collar fleets first.',
    ],
  },
  rankin: {
    marketNotes:
    ...
    tips: [
      'Treat Rankin as Pearl / Brandon east Jackson metro — must differ from Madison north-metro product.',
      'Collect HOA packets for multi-family growth; price I-20 / US-80 / MS-25 portal time honestly.',
      'Clarify Rankin vs Hinds / Madison addresses on multi-address estimates.',
      'Verify MDOT household goods authority for pure in-state jobs; FMCSA for interstate legs.',
      'Prefer mid-week mornings; school peaks pack east-metro fleets first.',
    ],
  },
  jackson: {
    marketNotes:
    ...
    tips: [
      'Treat Jackson County, Mississippi as Pascagoula / Ocean Springs Gulf Coast — NOT Jackson the city (Hinds) and NOT Jackson County, Missouri.',
      'Price I-10 / US-90 / MS-63 portal time honestly for coastal industrial + residential pairs.',
      'Survey coastal multi-unit and older stock separately from industrial-adjacent housing.',
      'Verify MDOT household goods authority for pure in-state jobs; FMCSA for interstate legs.',
      'Prefer mid-week starts; heat, humidity, and storm seasons reshape outdoor carries.',
    ],
  },
  madison: {
    marketNotes:
    ...
    tips: [
      'Label every job Madison County, Mississippi (Madison / Ridgeland) — never apply Madison County, Alabama assumptions.',
      'Collect HOA packets for north-metro growth multi-family; price I-55 / MS-22 / US-51 portal time honestly.',
      'Clarify Madison vs Hinds / Rankin county lines on every multi-address estimate.',
      'Verify MDOT household goods authority for pure in-state jobs; FMCSA for interstate legs.',
      'Prefer mid-week early starts; school peaks pack north-metro fleets first.',
    ],
  },
  lee: {
    marketNotes:
