...
export const coloradoCountyResearch: Record<string, CuratedCountyResearch> = {
  'el-paso': {
    ...
    tips: [
      'Treat Fort Carson, Academy, and Peterson PCS hard dates as estimate inputs — storage-in-transit and report-date flexibility matter.',
      'Price Powers Blvd / Academy / I-25 portal time honestly for north-to-south Springs pairs — this is not a Denver collar hop.',
      'Photo multi-unit elevators and HOA gate access in Northgate and Widefield before truck sizing.',
      'Verify Colorado PUC household goods (HHG) permit for pure in-state jobs; FMCSA for any out-of-state leg.',
      'Prefer mid-week mornings when flexible; military and school calendars collide on peak Fridays.',
    ],
  },
  denver: {
    marketNotes:
    ...
    tips: [
      'Reserve elevators and street permits early for RiNo, LoDo, and downtown multi-unit stock — curb staging fails more estimates than packing skill.',
      'Survey Capitol Hill walk-ups and Highlands stairs separately from Wash Park SFH driveways; access products differ by pocket.',
      'Build altitude pacing into crew hours for newcomers and open carries on hot summer days.',
      'Verify Colorado PUC HHG permit for pure in-state jobs; FMCSA for interstate CA/TX/AZ arrivals and exits.',
      'Prefer mid-week early starts on I-25 / I-70 pairs; month-end lease waves pack downtown docks first.',
    ],
  },
  arapahoe: {
    marketNotes:
    ...
    tips: [
      'Collect HOA gate lists and COI for Aurora, Centennial, and Parker-edge villages before dispatch.',
      'Price I-225 / E-470 / Parker Road portal time honestly for DTC ↔ southeast pairs — not a Denver walk-up quote.',
      'Survey DTC multi-unit elevators separately from Smoky Hill SFH tracts.',
      'Verify Colorado PUC HHG permit for pure in-state jobs; FMCSA for interstate legs.',
      'School-season Saturdays fill south-metro crews first May–August — book peak windows early.',
    ],
  },
  jefferson: {
    marketNotes:
    ...
    tips: [
      'Photo foothills driveway grade and turn radius in Golden / Evergreen-edge stock before truck sizing.',
      'Price I-70 / US-6 / C-470 / Wadsworth portal time for Lakewood–Arvada–foothills pairs honestly.',
      'Winter ice and elevation on mountain-edge parcels can erase productivity — keep flexible dates October–April.',
      'Verify Colorado PUC HHG permit for pure in-state jobs; FMCSA for interstate legs.',
      'Colfax west multi-unit curb limits differ from master-planned west-metro HOAs — survey access type carefully.',
    ],
  },
  adams: {
    marketNotes:
    ...
    tips: [
      'Plan DIA / Tower Road industrial traffic buffers for airport-adjacent multi-family and workforce housing.',
      'New subdivision streets and HOA packets are routine in Thornton / Brighton growth corridors — collect them early.',
      'Price I-25 / I-76 / E-470 / I-270 portal time for north-metro pairs; empty miles from Denver yards add cost.',
      'Verify Colorado PUC HHG permit for pure in-state jobs; FMCSA for interstate legs.',
      'Prefer mid-week mornings when flexible; school and shift-change peaks stack on I-25 north.',
    ],
  },
  douglas: {
    marketNotes:
    ...
    tips: [
      'HOA gate lists dominate Highlands Ranch, Parker, and Castle Rock villages — send packets with the estimate.',
      'Price C-470 / E-470 / I-25 portal time for Lone Tree ↔ Castle Rock pairs; south-metro runs are longer than map miles suggest.',
      'Survey RidgeGate multi-unit elevators separately from master-planned SFH driveways.',
      'Verify Colorado PUC HHG permit for pure in-state jobs; FMCSA for interstate legs.',
      'Peak family Saturdays May–August fill Douglas fleets first — book early for school-year moves.',
    ],
  },
  weld: {
    marketNotes:
    ...
    tips: [
      'Treat Greeley / Windsor growth as plains product — not Boulder constrained-city logistics.',
      'Price I-25 / US-85 / US-34 portal time for southern Weld ↔ Fort Collins pairs honestly.',
      'Energy and ag workforce hard dates often land mid-week; get report-date flexibility in writing.',
      'Verify Colorado PUC HHG permit for pure in-state jobs; FMCSA for interstate legs.',
      'Longer empty miles and rural driveways are common north and east of Greeley — photo access early.',
    ],
  },
  larimer: {
    marketNotes:
    ...
    tips: [
      'Book August/May CSU multi-unit clusters early — campus stairs and elevators clear local crews first.',
      'Price I-25 / Harmony / US-287 portal time for Fort Collins ↔ Loveland / Windsor pairs honestly.',
      'Do not price Old Town walk-ups like south Fort Collins HOA SFH; access products differ.',
      'Verify Colorado PUC HHG permit for pure in-state jobs; FMCSA for interstate legs.',
      'Prefer mid-week mornings; student move-in weekends and I-25 peaks collide hard.',
    ],
  },
  boulder: {
    marketNotes:
    ...
    tips: [
      'Constrained central Boulder curb and multi-unit rules fail estimates more often than packing skill — photo staging options.',
      'Price US-36 peak congestion for Boulder ↔ Denver pairs; short map miles still burn portal time.',
      'Foothills driveway grade and canyon approaches need truck-size and weather buffers.',
      'Verify Colorado PUC HHG permit for pure in-state jobs; FMCSA for interstate legs.',
      'CU lease clusters and tech start dates create mid-month spikes — reserve elevators early when applicable.',
    ],
  },
  pueblo: {
    marketNotes:
    ...
    tips: [
      'Treat Pueblo as a southern Colorado hub — not a Front Range collar quote with free empty miles from Denver yards.',
      'Price I-25 / US-50 portal time for Pueblo ↔ Colorado Springs pairs; regional hauls need honest drive buffers.',
      'Photo long driveways and outbuildings on Pueblo West and rural edges before truck sizing.',
      'Verify Colorado PUC HHG permit for pure in-state jobs; FMCSA for interstate legs.',
      'Industrial-edge multi-unit and older core stock differ from north Pueblo growth — survey access type carefully.',
    ],
  },
  mesa: {
    marketNotes:
