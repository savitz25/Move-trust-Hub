...
export const seedReviews: Review[] = [
  ...
  { id: 'r-pensey-1', companyId: 'pensey-moving', author: 'Mark T.', rating: 5, date: '2026-02-27', source: 'Verified Customer', content: 'Pensey is the real deal. Extremely careful with our antiques and the crew was the most professional I have ever seen.', verified: true, location: 'Scottsdale, AZ' },
  { id: 'r-gentle-1', companyId: 'gentle-giant-moving', author: 'Catherine B.', rating: 5, date: '2026-01-30', source: 'Google', content: 'Gentle Giant lived up to their name. They moved our baby grand piano and entire art collection without a scratch. Expensive but worth it.', verified: true, location: 'Boston, MA' },
