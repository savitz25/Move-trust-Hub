...
export const seedReviews: Review[] = [
  ...
  { id: 'r-royal-1', companyId: 'royal', author: 'Stephanie L.', rating: 2, date: '2025-10-18', source: 'BBB', content: 'They were late by almost a week and the quote changed significantly. Would not recommend for time-sensitive moves.', verified: false, location: 'San Diego, CA' },
