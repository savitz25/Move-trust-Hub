...
/** Hand-curated Pennsylvania county research — batches 1–5 */
export const pennsylvaniaCountyResearch: Record<string, CuratedCountyResearch> = {
  ...
  bradford: { marketNotes: 'Bradford County is a rural county in Northern Pennsylvania with residential demand across Towanda and the Susquehanna River northern tier.', costs: { studioRange: '$750–$1,500', familyRange: '$2,600–$5,800+', avgHourly: '$105–$160/hr for a 2-person crew', note: 'Bradford County pricing reflects rural northern PA demand, US-6 and Route 220 corridor traffic, and competition among regional full-service agents.' }, tips: ['Verify coverage for Towanda and surrounding areas before booking.', 'Regional traffic on US-6 and Route 220 impacts scheduling — confirm crew arrival windows.', 'Rural river valley communities may require longer drive times — confirm crew coverage radius.', 'Confirm insurance for high-value homes and multi-floor loading zones.', 'Book early for peak seasons (May–September) and month-end lease changeover.', 'Obtain multiple estimates and re-verify FMCSA authority, BBB rating, and current reviews.'] },
  wayne: { marketNotes: 'Wayne County is a rural Northeastern Pennsylvania county with residential demand across Honesdale and the Pocono northern corridor.', costs: { studioRange: '$750–$1,500', familyRange: '$2,600–$5,800+', avgHourly: '$105–$160/hr for a 2-person crew', note: 'Wayne County pricing reflects rural northeastern PA demand, Route 6 and US-6 corridor traffic, and competition among regional full-service agents.' }, tips: ['Verify coverage for Honesdale and surrounding areas before booking.', 'Regional traffic on Route 6 and US-6 impacts scheduling — confirm crew arrival windows.', 'Lake and mountain communities may require seasonal access coordination — confirm building access.', 'Confirm insurance for high-value homes and multi-floor loading zones.', 'Book early for peak seasons (May–September) and month-end lease changeover.', 'Obtain multiple estimates and re-verify FMCSA authority, BBB rating, and current reviews.'] },
  venango: { marketNotes: 'Venango County is a rural Northwestern Pennsylvania county with residential demand across Franklin and the Oil Region corridor.', costs: { studioRange: '$750–$1,500', familyRange: '$2,600–$5,800+', avgHourly: '$105–$160/hr for a 2-person crew', note: 'Venango County pricing reflects Oil Region demand, US-322 and Route 8 corridor traffic, and competition among regional full-service agents.' }, tips: ['Verify coverage for Franklin and surrounding areas before booking.', 'Regional traffic on US-322 and Route 8 impacts scheduling — confirm crew arrival windows.', 'River valley communities may require bridge crossing coordination — confirm crew routing.', 'Confirm insurance for high-value homes and multi-floor loading zones.', 'Book early for peak seasons (May–September) and month-end lease changeover.', 'Obtain multiple estimates and re-verify FMCSA authority, BBB rating, and current reviews.'] },
  bedford: { marketNotes: 'Bedford County is a rural county in South Central Pennsylvania with residential demand across Bedford and the Allegheny southern corridor.', costs: { studioRange: '$750–$1,500', familyRange: '$2,600–$5,800+', avgHourly: '$105–$160/hr for a 2-person crew', note: 'Bedford County pricing reflects rural south central PA demand, I-70 and US-30 corridor traffic, and competition among regional full-service agents.' }, tips: ['Verify coverage for Bedford and surrounding areas before booking.', 'Regional traffic on I-70 and US-30 impacts scheduling — confirm crew arrival windows.', 'Mountain and rural communities may require longer drive times — confirm crew coverage radius.', 'Confirm insurance for high-value homes and multi-floor loading zones.', 'Book early for peak seasons (May–September) and month-end lease changeover.', 'Obtain multiple estimates and re-verify FMCSA authority, BBB rating, and current reviews.'] },
  perry: { marketNotes: 'Perry County is a rural county in South Central Pennsylvania with residential demand across New Bloomfield and the Susquehanna River western corridor.', costs: { studioRange: '$750–$1,500', familyRange: '$2,600–$5,800+', avgHourly: '$105–$160/hr for a 2-person crew', note: 'Perry County pricing reflects rural south central PA demand, Route 11 and US-22 corridor traffic, and competition among regional full-service agents.' }, tips: ['Verify coverage for New Bloomfield and surrounding areas before booking.', 'Regional traffic on Route 11 and US-22 impacts scheduling — confirm crew arrival windows.', 'Rural farm communities may require longer drive times — confirm crew coverage radius.', 'Confirm insurance for high-value homes and multi-floor loading zones.', 'Book early for peak seasons (May–September) and month-end lease changeover.', 'Obtain multiple estimates and re-verify FMCSA authority, BBB rating, and current reviews.'] },
  mifflin: { marketNotes: 'Mifflin County is a rural county in Central Pennsylvania with residential demand across Lewistown and the Juniata Valley corridor.', costs: { studioRange: '$750–$1,500', familyRange: '$2,600–$5,800+', avgHourly: '$105–$160/hr for a 2-person crew', note: 'Mifflin County pricing reflects Juniata Valley demand, US-322 and Route 522 corridor traffic, and competition among regional full-service agents.' }, tips: ['Verify coverage for Lewistown and surrounding areas before booking.', 'Regional traffic on US-322 and Route 522 impacts scheduling — confirm crew arrival windows.', 'Valley communities may require bridge crossing coordination — confirm crew routing.', 'Confirm insurance for high-value homes and multi-floor loading zones.', 'Book early for peak seasons (May–September) and month-end lease changeover.', 'Obtain multiple estimates and re-verify FMCSA authority, BBB rating, and current reviews.'] },
  jefferson: { marketNotes: 'Jefferson County is a rural Northwestern Pennsylvania county with residential demand across Brookville and the northwest plateau corridor.', costs: { studioRange: '$750–$1,500', familyRange: '$2,600–$5,800+', avgHourly: '$105–$160/hr for a 2-person crew', note: 'Jefferson County pricing reflects rural northwestern PA demand, I-80 and US-322 corridor traffic, and competition among regional full-service agents.' }, tips: ['Verify coverage for Brookville and surrounding areas before booking.', 'Regional traffic on I-80 and US-322 impacts scheduling — confirm crew arrival windows.', 'Rural plateau communities may require longer drive times — confirm crew coverage radius.', 'Confirm insurance for high-value homes and multi-floor loading zones.', 'Book early for peak seasons (May–September) and month-end lease changeover.', 'Obtain multiple estimates and re-verify FMCSA authority, BBB rating, and current reviews.'] },
  huntingdon: { marketNotes: 'Huntingdon County is a rural Central Pennsylvania county with residential demand across Huntingdon and the Raystown Lake corridor.', costs: { studioRange: '$750–$1,500', familyRange: '$2,600–$5,800+', avgHourly: '$105–$160/hr for a 2-person crew', note: 'Huntingdon County pricing reflects rural central PA demand, US-22 and Route 26 corridor traffic, and competition among regional full-service agents.' }, tips: ['Verify coverage for Huntingdon and surrounding areas before booking.', 'Regional traffic on US-22 and Route 26 impacts scheduling — confirm crew arrival windows.', 'Lake and mountain communities may require seasonal access coordination — confirm building access.', 'Confirm insurance for high-value homes and multi-floor loading zones.', 'Book early for peak seasons (May–September) and month-end lease changeover.', 'Obtain multiple estimates and re-verify FMCSA authority, BBB rating, and current reviews.'] },
  union: { marketNotes: 'Union County is a county in Central Pennsylvania with residential demand across Lewisburg and the Susquehanna River west-central corridor.', costs: { studioRange: '$750–$1,500', familyRange: '$2,600–$5,800+', avgHourly: '$105–$160/hr for a 2-person crew', note: 'Union County pricing reflects Lewisburg and Bucknell University corridor demand, US-15 and I-80 corridor traffic, and competition among regional full-service agents.' }, tips: ['Verify coverage for Lewisburg and surrounding areas before booking.', 'Regional traffic on US-15 and I-80 impacts scheduling — confirm crew arrival windows.', 'University and river valley communities may require parking coordination — confirm building access.', 'Confirm insurance for high-value homes and multi-floor loading zones.', 'Book early for peak seasons (May–September) and semester changeover.', 'Obtain multiple estimates and re-verify FMCSA authority, BBB rating, and current reviews.'] },
  tioga: { marketNotes: 'Tioga County is a rural Northern Pennsylvania county with residential demand across Wellsboro and the Pine Creek Gorge corridor.', costs: { studioRange: '$750–$1,500', familyRange: '$2,600–$5,800+', avgHourly: '$105–$160/hr for a 2-person crew', note: 'Tioga County pricing reflects rural northern PA demand, US-6 and Route 660 corridor traffic, and competition among regional full-service agents.' }, tips: ['Verify coverage for Wellsboro and surrounding areas before booking.', 'Regional traffic on US-6 and Route 660 impacts scheduling — confirm crew arrival windows.', 'Gorge and rural communities may require longer drive times — confirm crew coverage radius.', 'Confirm insurance for high-value homes and multi-floor loading zones.', 'Book early for peak seasons (May–September) and month-end lease changeover.', 'Obtain multiple estimates and re-verify FMCSA authority, BBB rating, and current reviews.'] },
  snyder: { marketNotes: 'Snyder County is a rural Central Pennsylvania county with residential demand across Middleburg and the Susquehanna River middle corridor.', costs: { studioRange: '$750–$1,500', familyRange: '$2,600–$5,800+', avgHourly: '$105–$160/hr for a 2-person crew', note: 'Snyder County pricing reflects rural central PA demand, US-11 and US-15 corridor traffic, and competition among regional full-service agents.' }, tips: ['Verify coverage for Middleburg and surrounding areas before booking.', 'Regional traffic on US-11 and US-15 impacts scheduling — confirm crew arrival windows.', 'Rural farm communities may require longer drive times — confirm crew coverage radius.', 'Confirm insurance for high-value homes and multi-floor loading zones.', 'Book early for peak seasons (May–September) and month-end lease changeover.', 'Obtain multiple estimates and re-verify FMCSA authority, BBB rating, and current reviews.'] },
  mckean: { marketNotes: 'McKean County is a rural Northwestern Pennsylvania county with residential demand across Smethport and the Allegheny National Forest corridor.', costs: { studioRange: '$750–$1,500', familyRange: '$2,600–$5,800+', avgHourly: '$105–$160/hr for a 2-person crew', note: 'McKean County pricing reflects rural northwestern PA demand, US-6 and Route 219 corridor traffic, and competition among regional full-service agents.' }, tips: ['Verify coverage for Smethport and surrounding areas before booking.', 'Regional traffic on US-6 and Route 219 impacts scheduling — confirm crew arrival windows.', 'Forest and rural communities may require longer drive times — confirm crew coverage radius.', 'Confirm insurance for high-value homes and multi-floor loading zones.', 'Book early for peak seasons (May–September) and month-end lease changeover.', 'Obtain multiple estimates and re-verify FMCSA authority, BBB rating, and current reviews.'] },
  susquehanna: { marketNotes: 'Susquehanna County is a rural Northeastern Pennsylvania county with residential demand across Montrose and the Endless Mountains corridor.', costs: { studioRange: '$750–$1,500', familyRange: '$2,600–$5,800+', avgHourly: '$105–$160/hr for a 2-person crew', note: 'Susquehanna County pricing reflects Endless Mountains demand, US-11 and Route 706 corridor traffic, and competition among regional full-service agents.' }, tips: ['Verify coverage for Montrose and surrounding areas before booking.', 'Regional traffic on US-11 and Route 706 impacts scheduling — confirm crew arrival windows.', 'Mountain and rural communities may require longer drive times — confirm crew coverage radius.', 'Confirm insurance for high-value homes and multi-floor loading zones.', 'Book early for peak seasons (May–September) and month-end lease changeover.', 'Obtain multiple estimates and re-verify FMCSA authority, BBB rating, and current reviews.'] },
  clinton: { marketNotes: 'Clinton County is a rural Central Pennsylvania county with residential demand across Lock Haven and the West Branch Susquehanna River corridor.', costs: { studioRange: '$750–$1,500', familyRange: '$2,600–$5,800+', avgHourly: '$105–$160/hr for a 2-person crew', note: 'Clinton County pricing reflects Lock Haven university corridor demand, I-80 and Route 120 corridor traffic, and competition among regional full-service agents.' }, tips: ['Verify coverage for Lock Haven and surrounding areas before booking.', 'Regional traffic on I-80 and Route 120 impacts scheduling — confirm crew arrival windows.', 'River valley communities may require bridge crossing coordination — confirm crew routing.', 'Confirm insurance for high-value homes and multi-floor loading zones.', 'Book early for peak seasons (May–September) and month-end lease changeover.', 'Obtain multiple estimates and re-verify FMCSA authority, BBB rating, and current reviews.'] },
  warren: { marketNotes: 'Warren County is a rural Northwestern Pennsylvania county with residential demand across Warren and the Allegheny Reservoir corridor.', costs: { studioRange: '$750–$1,500', familyRange: '$2,600–$5,800+', avgHourly: '$105–$160/hr for a 2-person crew', note: 'Warren County pricing reflects rural northwestern PA demand, US-6 and Route 27 corridor traffic, and competition among regional full-service agents.' }, tips: ['Verify coverage for Warren and surrounding areas before booking.', 'Regional traffic on US-6 and Route 27 impacts scheduling — confirm crew arrival windows.', 'Reservoir and forest communities may require seasonal access coordination — confirm building access.', 'Confirm insurance for high-value homes and multi-floor loading zones.', 'Book early for peak seasons (May–September) and month-end lease changeover.', 'Obtain multiple estimates and re-verify FMCSA authority, BBB rating, and current reviews.'] },
  cameron: { marketNotes: 'Cameron County is one of Pennsylvania’s least populous counties, a rural Northern Pennsylvania area with residential demand across Emporium and the Allegheny Wilds corridor.', costs: { studioRange: '$750–$1,500', familyRange: '$2,600–$5,800+', avgHourly: '$105–$160/hr for a 2-person crew', note: 'Cameron County pricing reflects rural northern PA demand, US-6 and Route 120 corridor traffic, and competition among regional full-service agents.' }, tips: ['Verify coverage for Emporium and surrounding areas before booking.', 'Regional traffic on US-6 and Route 120 impacts scheduling — confirm crew arrival windows.', 'Forest and rural communities may require longer drive times — confirm crew coverage radius.', 'Confirm insurance for high-value homes and multi-floor loading zones.', 'Book early for peak seasons (May–September) and month-end lease changeover.', 'Obtain multiple estimates and re-verify FMCSA authority, BBB rating, and current reviews.'] },
  clarion: { marketNotes: 'Clarion County is a rural Northwestern Pennsylvania county with residential demand across Clarion and the Allegheny River north corridor.', costs: { studioRange: '$750–$1,500', familyRange: '$2,600–$5,800+', avgHourly: '$105–$160/hr for a 2-person crew', note: 'Clarion County pricing reflects rural northwestern PA demand, US-322 and Route 68 corridor traffic, and competition among regional full-service agents.' }, tips: ['Verify coverage for Clarion and surrounding areas before booking.', 'Regional traffic on US-322 and Route 68 impacts scheduling — confirm crew arrival windows.', 'River valley communities may require bridge crossing coordination — confirm crew routing.', 'Confirm insurance for high-value homes and multi-floor loading zones.', 'Book early for peak seasons (May–September) and month-end lease changeover.', 'Obtain multiple estimates and re-verify FMCSA authority, BBB rating, and current reviews.'] },
  elk: { marketNotes: 'Elk County is a rural Northwestern Pennsylvania county with residential demand across Ridgway and St. Marys and the Pennsylvania Wilds corridor.', costs: { studioRange: '$750–$1,500', familyRange: '$2,600–$5,800+', avgHourly: '$105–$160/hr for a 2-person crew', note: 'Elk County pricing reflects rural northwestern PA demand, US-219 and Route 948 corridor traffic, and competition among regional full-service agents.' }, tips: ['Verify coverage for Ridgway and surrounding areas before booking.', 'Regional traffic on US-219 and Route 948 impacts scheduling — confirm crew arrival windows.', 'Forest and rural communities may require longer drive times — confirm crew coverage radius.', 'Confirm insurance for high-value homes and multi-floor loading zones.', 'Book early for peak seasons (May–September) and month-end lease changeover.', 'Obtain multiple estimates and re-verify FMCSA authority, BBB rating, and current reviews.'] },
  forest: { marketNotes: 'Forest County is one of Pennsylvania’s least populous counties, a rural Northwestern area with residential demand across Tionesta and the Allegheny National Forest corridor.', costs: { studioRange: '$750–$1,500', familyRange: '$2,600–$5,800+', avgHourly: '$105–$160/hr for a 2-person crew', note: 'Forest County pricing reflects rural northwestern PA demand, US-62 and Route 36 corridor traffic, and competition among regional full-service agents.' }, tips: ['Verify coverage for Tionesta and surrounding areas before booking.', 'Regional traffic on US-62 and Route 36 impacts scheduling — confirm crew arrival windows.', 'National forest communities may require seasonal access coordination — confirm building access.', 'Confirm insurance for high-value homes and multi-floor loading zones.', 'Book early for peak seasons (May–September) and month-end lease changeover.', 'Obtain multiple estimates and re-verify FMCSA authority, BBB rating, and current reviews.'] },
  fulton: { marketNotes: 'Fulton County is a rural South Central Pennsylvania county with residential demand across McConnellsburg and the Great Valley corridor.', costs: { studioRange: '$750–$1,500', familyRange: '$2,600–$5,800+', avgHourly: '$105–$160/hr for a 2-person crew', note: 'Fulton County pricing reflects rural south central PA demand, US-522 and I-70 corridor traffic, and competition among regional full-service agents.' }, tips: ['Verify coverage for McConnellsburg and surrounding areas before booking.', 'Regional traffic on US-522 and I-70 impacts scheduling — confirm crew arrival windows.', 'Mountain and rural communities may require longer drive times — confirm crew coverage radius.', 'Confirm insurance for high-value homes and multi-floor loading zones.', 'Book early for peak seasons (May–September) and month-end lease changeover.', 'Obtain multiple estimates and re-verify FMCSA authority, BBB rating, and current reviews.'] },
  greene: { marketNotes: 'Greene County is a rural Southwestern Pennsylvania county with residential demand across Waynesburg and the Monongahela River corridor.', costs: { studioRange: '$750–$1,500', familyRange: '$2,600–$5,800+', avgHourly: '$105–$160/hr for a 2-person crew', note: 'Greene County pricing reflects rural southwestern PA demand, I-79 and US-19 corridor traffic, and competition among regional full-service agents.' }, tips: ['Verify coverage for Waynesburg and surrounding areas before booking.', 'Regional traffic on I-79 and US-19 impacts scheduling — confirm crew arrival windows.', 'Coal country and rural communities may require longer drive times — confirm crew coverage radius.', 'Confirm insurance for high-value homes and multi-floor loading zones.', 'Book early for peak seasons (May–September) and month-end lease changeover.', 'Obtain multiple estimates and re-verify FMCSA authority, BBB rating, and current reviews.'] },
  juniata: { marketNotes: 'Juniata County is a rural Central Pennsylvania county with residential demand across Mifflintown and the Juniata River corridor.', costs: { studioRange: '$750–$1,500', familyRange: '$2,600–$5,800+', avgHourly: '$105–$160/hr for a 2-person crew', note: 'Juniata County pricing reflects rural central PA demand, US-22 and US-522 corridor traffic, and competition among regional full-service agents.' }, tips: ['Verify coverage for Mifflintown and surrounding areas before booking.', 'Regional traffic on US-22 and US-522 impacts scheduling — confirm crew arrival windows.', 'River valley communities may require bridge crossing coordination — confirm crew routing.', 'Confirm insurance for high-value homes and multi-floor loading zones.', 'Book early for peak seasons (May–September) and month-end lease changeover.', 'Obtain multiple estimates and re-verify FMCSA authority, BBB rating, and current reviews.'] },
  montour: { marketNotes: 'Montour County is a small rural county in Central Pennsylvania with residential demand across Danville and the Susquehanna River central corridor.', costs: { studioRange: '$750–$1,500', familyRange: '$2,600–$5,800+', avgHourly: '$105–$160/hr for a 2-person crew', note: 'Montour County pricing reflects Danville and Geisinger corridor demand, I-80 and US-11 corridor traffic, and competition among regional full-service agents.' }, tips: ['Verify coverage for Danville and surrounding areas before booking.', 'Regional traffic on I-80 and US-11 impacts scheduling — confirm crew arrival windows.', 'Hospital and university communities may require parking coordination — confirm building access.', 'Confirm insurance for high-value homes and multi-floor loading zones.', 'Book early for peak seasons (May–September) and month-end lease changeover.', 'Obtain multiple estimates and re-verify FMCSA authority, BBB rating, and current reviews.'] },
  potter: { marketNotes: 'Potter County is a rural Northern Pennsylvania county with residential demand across Coudersport and the Northern Tier Highlands corridor.', costs: { studioRange: '$750–$1,500', familyRange: '$2,600–$5,800+', avgHourly: '$105–$160/hr for a 2-person crew', note: 'Potter County pricing reflects rural northern PA demand, US-6 and Route 44 corridor traffic, and competition among regional full-service agents.' }, tips: ['Verify coverage for Coudersport and surrounding areas before booking.', 'Regional traffic on US-6 and Route 44 impacts scheduling — confirm crew arrival windows.', 'Highland and rural communities may require longer drive times — confirm crew coverage radius.', 'Confirm insurance for high-value homes and multi-floor loading zones.', 'Book early for peak seasons (May–September) and month-end lease changeover.', 'Obtain multiple estimates and re-verify FMCSA authority, BBB rating, and current reviews.'] },
  sullivan: { marketNotes: 'Sullivan County is one of Pennsylvania’s least populous counties, a rural Northern Pennsylvania area with residential demand across Laporte and the Endless Mountains south corridor.', costs: { studioRange: '$750–$1,500', familyRange: '$2,600–$5,800+', avgHourly: '$105–$160/hr for a 2-person crew', note: 'Sullivan County pricing reflects rural northern PA demand, US-220 and Route 87 corridor traffic, and competition among regional full-service agents.' }, tips: ['Verify coverage for Laporte and surrounding areas before booking.', 'Regional traffic on US-220 and Route 87 impacts scheduling — confirm crew arrival windows.', 'Mountain and lake communities may require seasonal access coordination — confirm building access.', 'Confirm insurance for high-value homes and multi-floor loading zones.', 'Book early for peak seasons (May–September) and month-end lease changeover.', 'Obtain multiple estimates and re-verify FMCSA authority, BBB rating, and current reviews.'] },
  wyoming: { marketNotes: 'Wyoming County is a rural Northeastern Pennsylvania county with residential demand across Tunkhannock and the Wyoming Valley east corridor.', costs: { studioRange: '$750–$1,500', familyRange: '$2,600–$5,800+', avgHourly: '$105–$160/hr for a 2-person crew', note: 'Wyoming County pricing reflects rural northeastern PA demand, US-6 and Route 29 corridor traffic, and competition among regional full-service agents.' }, tips: ['Verify coverage for Tunkhannock and surrounding areas before booking.', 'Regional traffic on US-6 and Route 29 impacts scheduling — confirm crew arrival windows.', 'River valley communities may require bridge crossing coordination — confirm crew routing.', 'Confirm insurance for high-value homes and multi-floor loading zones.', 'Book early for peak seasons (May–September) and month-end lease changeover.', 'Obtain multiple estimates and re-verify FMCSA authority, BBB rating, and current reviews.'] },
};
