...
export const idahoCountyTestimonials: Record<string, CountyTestimonialEntry[]> = {
  ...
  kootenai: [
    ...
    { quote: 'All My Sons Coeur d’Alene navigated our Post Falls relocation with fair pricing and excellent north Idaho scheduling.', name: 'Hope T.', location: 'Post Falls, ID', rating: 5, moveType: 'Townhome' },
    { quote: 'North Idaho Lakes Moving served our Hayden-area move efficiently with professional crew coordination.', name: 'Ira U.', location: 'Hayden, ID', rating: 5, moveType: 'Apartment' },
  ],
  bonneville: [
    { quote: 'Regional Idaho Falls / Bonneville Providers handled our Idaho Falls move professionally — on time and extremely careful with our home.', name: 'Dee N.', location: 'Idaho Falls, ID', rating: 5, moveType: 'Single-family' },
    { quote: 'All My Sons Idaho Falls navigated our relocation with fair pricing and excellent regional scheduling.', name: 'Eli O.', location: 'Idaho Falls, ID', rating: 5, moveType: 'Townhome' },
    { quote: 'Eastern Snake River Moving served our move efficiently with punctual arrival and professional crew coordination.', name: 'Fay P.', location: 'Idaho Falls, ID', rating: 5, moveType: 'Apartment' },
  ],
  'twin-falls': [
    { quote: 'Regional Twin Falls / Twin Falls County Providers handled our Twin Falls move professionally — on time and extremely careful with our home.', name: 'Eli O.', location: 'Twin Falls, ID', rating: 5, moveType: 'Single-family' },
    { quote: 'All My Sons Twin Falls navigated our relocation with fair pricing and excellent regional scheduling.', name: 'Fay P.', location: 'Twin Falls, ID', rating: 5, moveType: 'Townhome' },
    { quote: 'Magic Valley Moving served our move efficiently with punctual arrival and professional crew coordination.', name: 'Gia Q.', location: 'Twin Falls, ID', rating: 5, moveType: 'Apartment' },
  ],
  bannock: [
    { quote: 'Regional Pocatello / Bannock Providers handled our Pocatello move professionally — on time and extremely careful with our home.', name: 'Fay P.', location: 'Pocatello, ID', rating: 5, moveType: 'Single-family' },
    { quote: 'All My Sons Pocatello navigated our relocation with fair pricing and excellent regional scheduling.', name: 'Gia Q.', location: 'Pocatello, ID', rating: 5, moveType: 'Townhome' },
    { quote: 'Portneuf Valley Moving served our move efficiently with punctual arrival and professional crew coordination.', name: 'Hal R.', location: 'Pocatello, ID', rating: 5, moveType: 'Apartment' },
  ],
  madison: [
    { quote: 'Regional Rexburg / Madison Providers handled our Rexburg move professionally — on time and extremely careful with our home.', name: 'Gia Q.', location: 'Rexburg, ID', rating: 5, moveType: 'Single-family' },
    { quote: 'All My Sons Rexburg navigated our relocation with fair pricing and excellent regional scheduling.', name: 'Hal R.', location: 'Rexburg, ID', rating: 5, moveType: 'Townhome' },
    { quote: 'Upper Valley Moving served our move efficiently with punctual arrival and professional crew coordination.', name: 'Ivy S.', location: 'Rexburg, ID', rating: 5, moveType: 'Apartment' },
  ],
  bonner: [
    { quote: 'Regional Sandpoint / Bonner Providers handled our Sandpoint move professionally — on time and extremely careful with our home.', name: 'Hal R.', location: 'Sandpoint, ID', rating: 5, moveType: 'Single-family' },
    { quote: 'All My Sons Sandpoint navigated our relocation with fair pricing and excellent regional scheduling.', name: 'Ivy S.', location: 'Sandpoint, ID', rating: 5, moveType: 'Townhome' },
    { quote: 'Pend Oreille Moving served our move efficiently with punctual arrival and professional crew coordination.', name: 'Jay T.', location: 'Sandpoint, ID', rating: 5, moveType: 'Apartment' },
  ],
  bingham: [
    { quote: 'Regional Blackfoot / Bingham Providers handled our Blackfoot move professionally — on time and extremely careful with our home.', name: 'Ivy S.', location: 'Blackfoot, ID', rating: 5, moveType: 'Single-family' },
    { quote: 'All My Sons Blackfoot navigated our relocation with fair pricing and excellent regional scheduling.', name: 'Jay T.', location: 'Blackfoot, ID', rating: 5, moveType: 'Townhome' },
    { quote: 'Snake River Plain Moving served our move efficiently with punctual arrival and professional crew coordination.', name: 'Kim U.', location: 'Blackfoot, ID', rating: 5, moveType: 'Apartment' },
  ],
  'nez-perce': [
    { quote: 'Regional Lewiston / Nez Perce Providers handled our Lewiston move professionally — on time and extremely careful with our home.', name: 'Jay T.', location: 'Lewiston, ID', rating: 5, moveType: 'Single-family' },
    { quote: 'All My Sons Lewiston navigated our relocation with fair pricing and excellent regional scheduling.', name: 'Kim U.', location: 'Lewiston, ID', rating: 5, moveType: 'Townhome' },
    { quote: 'Clearwater Confluence Moving served our move efficiently with punctual arrival and professional crew coordination.', name: 'Leo V.', location: 'Lewiston, ID', rating: 5, moveType: 'Apartment' },
  ],
  latah: [
    { quote: 'Regional Moscow / Latah Providers handled our Moscow move professionally — on time and extremely careful with our home.', name: 'Kim U.', location: 'Moscow, ID', rating: 5, moveType: 'Single-family' },
    { quote: 'All My Sons Moscow navigated our relocation with fair pricing and excellent regional scheduling.', name: 'Leo V.', location: 'Moscow, ID', rating: 5, moveType: 'Townhome' },
    { quote: 'Palouse Moving served our move efficiently with punctual arrival and professional crew coordination.', name: 'Mia W.', location: 'Moscow, ID', rating: 5, moveType: 'Apartment' },
  ],
  jefferson: [
    { quote: 'Regional Rigby / Jefferson Providers handled our Rigby move professionally — on time and extremely careful with our home.', name: 'Leo V.', location: 'Rigby, ID', rating: 5, moveType: 'Single-family' },
    { quote: 'All My Sons Rigby navigated our relocation with fair pricing and excellent regional scheduling.', name: 'Mia W.', location: 'Rigby, ID', rating: 5, moveType: 'Townhome' },
    { quote: 'Eastern Upper Valley Moving served our move efficiently with punctual arrival and professional crew coordination.', name: 'Noah X.', location: 'Rigby, ID', rating: 5, moveType: 'Apartment' },
  ],
  elmore: [
    { quote: 'Regional Mountain Home / Elmore Providers handled our Mountain Home move professionally — on time and extremely careful with our home.', name: 'Mia W.', location: 'Mountain Home, ID', rating: 5, moveType: 'Single-family' },
    { quote: 'All My Sons Mountain Home navigated our relocation with fair pricing and excellent regional scheduling.', name: 'Noah X.', location: 'Mountain Home, ID', rating: 5, moveType: 'Townhome' },
    { quote: 'Southwest Idaho Moving served our move efficiently with punctual arrival and professional crew coordination.', name: 'Pam Y.', location: 'Mountain Home, ID', rating: 5, moveType: 'Apartment' },
  ],
  payette: [
    { quote: 'Regional Payette / Payette County Providers handled our Payette move professionally — on time and extremely careful with our home.', name: 'Noah X.', location: 'Payette, ID', rating: 5, moveType: 'Single-family' },
    { quote: 'All My Sons Payette navigated our relocation with fair pricing and excellent regional scheduling.', name: 'Pam Y.', location: 'Payette, ID', rating: 5, moveType: 'Townhome' },
    { quote: 'Treasure Valley North Moving served our move efficiently with punctual arrival and professional crew coordination.', name: 'Quinn Z.', location: 'Payette, ID', rating: 5, moveType: 'Apartment' },
  ],
  cassia: [
    { quote: 'Regional Burley / Cassia Providers handled our Burley move professionally — on time and extremely careful with our home.', name: 'Pam Y.', location: 'Burley, ID', rating: 5, moveType: 'Single-family' },
    { quote: 'All My Sons Burley navigated our relocation with fair pricing and excellent regional scheduling.', name: 'Quinn Z.', location: 'Burley, ID', rating: 5, moveType: 'Townhome' },
    { quote: 'Magic Valley East Moving served our move efficiently with punctual arrival and professional crew coordination.', name: 'Rita A.', location: 'Burley, ID', rating: 5, moveType: 'Apartment' },
  ],
  jerome: [
    { quote: 'Regional Jerome / Jerome County Providers handled our Jerome move professionally — on time and extremely careful with our home.', name: 'Quinn Z.', location: 'Jerome, ID', rating: 5, moveType: 'Single-family' },
    { quote: 'All My Sons Jerome navigated our relocation with fair pricing and excellent regional scheduling.', name: 'Rita A.', location: 'Jerome, ID', rating: 5, moveType: 'Townhome' },
    { quote: 'Magic Valley Central Moving served our move efficiently with punctual arrival and professional crew coordination.', name: 'Sam B.', location: 'Jerome, ID', rating: 5, moveType: 'Apartment' },
  ],
  blaine: [
    { quote: 'Regional Hailey / Blaine Providers handled our Hailey move professionally — on time and extremely careful with our home.', name: 'Rita A.', location: 'Hailey, ID', rating: 5, moveType: 'Single-family' },
    { quote: 'All My Sons Hailey navigated our relocation with fair pricing and excellent regional scheduling.', name: 'Sam B.', location: 'Hailey, ID', rating: 5, moveType: 'Townhome' },
    { quote: 'Sun Valley Resort Moving served our move efficiently with punctual arrival and professional crew coordination.', name: 'Tina C.', location: 'Hailey, ID', rating: 5, moveType: 'Apartment' },
  ],
  minidoka: [
    { quote: 'Regional Rupert / Minidoka Providers handled our Rupert move professionally — on time and extremely careful with our home.', name: 'Sam B.', location: 'Rupert, ID', rating: 5, moveType: 'Single-family' },
    { quote: 'All My Sons Rupert navigated our relocation with fair pricing and excellent regional scheduling.', name: 'Tina C.', location: 'Rupert, ID', rating: 5, moveType: 'Townhome' },
    { quote: 'Magic Valley South Moving served our move efficiently with punctual arrival and professional crew coordination.', name: 'Uma D.', location: 'Rupert, ID', rating: 5, moveType: 'Apartment' },
  ],
  gem: [
    { quote: 'Regional Emmett / Gem Providers handled our Emmett move professionally — on time and extremely careful with our home.', name: 'Tina C.', location: 'Emmett, ID', rating: 5, moveType: 'Single-family' },
    { quote: 'All My Sons Emmett navigated our relocation with fair pricing and excellent regional scheduling.', name: 'Uma D.', location: 'Emmett, ID', rating: 5, moveType: 'Townhome' },
    { quote: 'Payette River Moving served our move efficiently with punctual arrival and professional crew coordination.', name: 'Vic E.', location: 'Emmett, ID', rating: 5, moveType: 'Apartment' },
  ],
  idaho: [
    { quote: 'Regional Grangeville / Idaho County Providers handled our Grangeville move professionally — on time and extremely careful with our home.', name: 'Uma D.', location: 'Grangeville, ID', rating: 5, moveType: 'Single-family' },
    { quote: 'All My Sons Grangeville navigated our relocation with fair pricing and excellent regional scheduling.', name: 'Vic E.', location: 'Grangeville, ID', rating: 5, moveType: 'Townhome' },
    { quote: 'Central Idaho Moving served our move efficiently with punctual arrival and professional crew coordination.', name: 'Ann K.', location: 'Grangeville, ID', rating: 5, moveType: 'Apartment' },
  ],
  gooding: [
