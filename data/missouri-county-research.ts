...
export const missouriCountyResearch: Record<string, CuratedCountyResearch> = {
  'st-louis': {
    ...
    tips: [
      'Label every job St. Louis County, Missouri — never apply Minnesota St. Louis County (Duluth) logistics assumptions.',
      'Collect HOA COI packets for West County multi-family; survey North County stairs separately from Clayton elevators.',
      'Price I-70 / I-64 / I-44 / I-270 / I-55 portal time honestly for cross-zone pairs.',
      'Verify MoDOT household goods operating authority for pure in-state jobs; FMCSA for Illinois Metro East or other interstate legs.',
      'Prefer mid-week early starts; ice storms and summer heat reshape outdoor carries.',
    ],
  },
  jackson: {
    marketNotes:
    ...
    tips: [
      'Treat Jackson County as Kansas City MO core/suburban mix — not a St. Louis County clone and not Clay north-metro alone.',
      'Price I-70 / I-35 / I-29 / I-435 / US-71 portal time honestly for city ↔ Independence / Lee’s Summit pairs.',
      'Survey urban multi-unit stairs separately from suburban HOA multi-family.',
      'Verify MoDOT household goods operating authority for pure in-state jobs; FMCSA for Kansas or other interstate legs.',
      'Prefer mid-week mornings; school-calendar Saturdays pack fleets first.',
    ],
  },
  'st-charles': {
    marketNotes:
    ...
    tips: [
      'Treat St. Charles as west St. Louis metro growth — not St. Louis County inner-ring elevators as the default.',
      'Collect HOA packets for O’Fallon / St. Peters multi-family; price I-70 / I-64 / MO-370 / MO-94 portal time honestly.',
      'Clarify St. Charles vs St. Louis County addresses on every multi-address estimate.',
      'Verify MoDOT household goods operating authority for pure in-state jobs; FMCSA for interstate legs.',
      'Prefer mid-week early starts; school peaks fill west-metro fleets first.',
    ],
  },
  greene: {
    marketNotes:
    ...
    tips: [
      'Treat Springfield / Greene as southwest Missouri regional product — not St. Louis or Kansas City spillover.',
      'Price I-44 / US-60 / US-65 portal time honestly for city ↔ Nixa / Republic / Ozark-edge pairs.',
      'Plan campus and healthcare calendars into multi-unit estimates near Missouri State corridors.',
      'Verify MoDOT household goods operating authority for pure in-state jobs; FMCSA for interstate legs.',
  ...
  clay: {
    ...
    tips: [
      'Treat Clay as north Kansas City metro — not a Jackson County downtown clone.',
      'Price I-35 / I-29 / I-435 / MO-291 portal time honestly for Northland pairs.',
      'Collect HOA packets for Liberty / Gladstone multi-family; survey older stock separately.',
      'Verify MoDOT household goods operating authority for pure in-state jobs; FMCSA for Kansas or other interstate legs.',
      'Prefer mid-week starts; school-calendar peaks pack Northland fleets first.',
    ],
  },
  jefferson: {
    marketNotes:
    ...
    tips: [
      'Treat Jefferson as south St. Louis metro fringe / I-55 — not St. Louis County West County HOA defaults.',
      'Price I-55 / US-61/67 / MO-21 / MO-30 portal time honestly; empty miles matter on rural edges.',
      'Survey long driveways and older multi-unit separately from growth multi-family.',
      'Verify MoDOT household goods operating authority for pure in-state jobs; FMCSA for interstate legs.',
      'Prefer mid-week mornings; school peaks and weather contingency reshape outdoor carries.',
    ],
  },
  boone: {
    marketNotes:
