...
export const illinoisCountyResearch: Record<string, CuratedCountyResearch> = {
  ...
  mchenry: {
    ...
    tips: [
      'Price Crystal Lake ↔ Woodstock or Huntley pairs with honest US-14 / IL-47 portal time — far-north collar empty miles often rival load time.',
      'Photo long rural driveways and HOA gate access in Huntley / Lake-in-the-Hills before finalizing crew size.',
      'Ask for mid-week morning starts when flexible; Saturday family demand fills thin McHenry fleets first May–August.',
      'Verify Illinois Commerce Commission (ICC) household goods authority for pure in-state jobs and FMCSA for any Wisconsin-bound leg.',
      'Compare written estimates that list stairs, outdoor gear, and winter ice risk on lake-edge and rural addresses.',
    ],
  },
  winnebago: {
    marketNotes:
    ...
    tips: [
      'Treat Rockford as a standalone regional hub — not a Chicago spillover quote with free empty miles from Cook yards.',
      'Confirm I-39 / I-90 timing for Loves Park, Machesney Park, and South Beloit approaches at shift-change peaks.',
      'Photo multi-story and older Rock River-adjacent stock for stairs and curb limits before truck sizing.',
      'Match ICC household goods licensing for pure Illinois jobs; FMCSA is required once any leg enters Wisconsin.',
      'Manufacturing and healthcare hard dates often land mid-week — get report-date flexibility in writing when possible.',
    ],
  },
  madison: {
    marketNotes:
    ...
    tips: [
      'Price Edwardsville / Glen Carbon ↔ Alton or Granite City pairs with I-255 and river-adjacent buffers — Metro East is St. Louis-facing, not Chicagoland.',
      'Clarify whether any destination is in Missouri; crossing the river flips the job to interstate FMCSA authority.',
      'Collect HOA packets for SIUE-adjacent and southwestern growth villages before dispatch.',
      'Verify Illinois ICC household goods authority for pure Illinois Metro East legs.',
      'Share driveway grade photos for Alton bluff and river-edge addresses that can force long carries.',
    ],
  },
  'st-clair': {
    marketNotes:
    ...
    tips: [
      'Distinguish Belleville street grids from O’Fallon / Shiloh HOA growth — access products differ under one Metro East label.',
      'Build Scott AFB PCS hard-date and storage-in-transit options into written estimates when report dates are fixed.',
      'Price I-64 / I-255 portal time honestly for any pair that also touches Madison County or Missouri destinations.',
      'Verify ICC household goods authority for pure Illinois jobs; Missouri destinations require FMCSA.',
      'Photo multi-unit curb options in Belleville cores where truck length and stairs dominate labor hours.',
    ],
  },
  champaign: {
    marketNotes:
    ...
    tips: [
      'Book August and mid-May windows early — Campustown and multi-family lease clusters clear local crews first.',
      'Survey stairs, alley access, and elevator rules near UIUC / Urbana multi-unit stock before truck sizing.',
      'Do not price Savoy or Mahomet family HOA product like Campustown student turns; access and inventory differ.',
      'Verify Illinois ICC household goods authority for in-state Champaign County jobs; FMCSA for any out-of-state leg.',
      'Prefer mid-week morning starts when flexible; I-57 / I-74 approach congestion still hits peak move days.',
    ],
  },
  sangamon: {
    marketNotes:
    ...
    tips: [
      'Treat Springfield capital multi-unit and west/south suburban SFH as different products under one county estimate.',
      'Session, agency, and medical-corridor calendars create mid-week demand — confirm elevators and curb windows early.',
      'Price I-55 / I-72 portal time honestly for any Champaign or Peoria regional pair.',
      'Verify Illinois ICC household goods authority for pure in-state jobs; FMCSA for interstate exits.',
      'Share Clear Lake Ave / medical-district access photos when multi-unit docks or long carries are likely.',
    ],
  },
  peoria: {
    marketNotes:
    ...
    tips: [
      'Clarify Peoria County vs Tazewell (East Peoria) addresses — river crossings change drive time and sometimes crew staging yards.',
      'Survey bluff grades and Medical District multi-unit elevators separately from Dunlap HOA driveways.',
      'Price I-74 / I-474 portal time honestly for Heights and north-growth pairs.',
      'Verify Illinois ICC household goods authority for pure in-state jobs; FMCSA for any out-of-state leg.',
      'Healthcare and manufacturing hard dates often land mid-week — get report-date flexibility in writing when possible.',
    ],
  },
  mclean: {
    marketNotes:
