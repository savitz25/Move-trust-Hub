...
export const montanaCountyResearch: Record<string, CuratedCountyResearch> = {
  yellowstone: {
    ...
    tips: [
      'Treat Yellowstone County as Billings regional hub — not Yellowstone National Park as the primary market label.',
      'Price I-90 · I-94 · US-87 · US-212 portal time honestly for Billings cross-zone pairs.',
      'Keep Billings product distinct from Bozeman/Gallatin growth and Missoula university defaults.',
      'For pure in-state jobs insist on written estimates and insurance; do not invent a Montana HHG certificate; FMCSA for interstate legs.',
      'Winter ice and long rural approaches reshape crew timing more than packing skill alone.',
    ],
  },
  gallatin: {
    marketNotes:
    ...
    tips: [
      'Treat Gallatin as Bozeman growth / tech + outdoor economy — not Billings west clones.',
      'Price I-90 · US-191 · MT-84 portal time honestly for valley and Big Sky gateway pairs.',
      'MSU semester and growth HOA packets pack fleets first — book early for peak summers.',
      'For pure in-state jobs insist on written estimates and insurance; FMCSA for interstate legs.',
      'Keep Bozeman product distinct from Yellowstone County Billings hub logistics.',
    ],
  },
  missoula: {
    marketNotes:
    ...
    tips: [
      'Treat Missoula as western MT university hub — not Billings east defaults.',
      'Price I-90 · US-93 · US-12 portal time honestly; mountain weather rewrites empty miles.',
      'UM semester peaks cluster multi-unit curb demand in August and May.',
      'For pure in-state jobs insist on written estimates and insurance; FMCSA for interstate legs.',
      'Survey hillside stairs and university multi-unit elevators with photos early.',
    ],
  },
  flathead: {
    marketNotes:
  ...
  cascade: {
    ...
    tips: [
      'Treat Cascade as Great Falls regional / Missouri River product — not Billings or Bozeman defaults.',
      'Price I-15 · US-87 · US-89 portal time honestly for city and rural pairs.',
      'Military-adjacent and long rural approaches reshape estimate risk where accurate.',
      'For pure in-state jobs insist on written estimates and insurance; FMCSA for interstate legs.',
      'Winter ice and wind on open approaches are real labor inputs.',
    ],
  },
  'lewis-and-clark': {
    marketNotes:
    ...
    tips: [
      'Treat Lewis and Clark as Helena capital product — not Billings hub or Bozeman growth defaults.',
      'Price I-15 · US-12 · US-287 portal time honestly for capital ↔ valley pairs.',
      'Capital workforce mid-month calendars often matter more than Saturday peaks.',
      'For pure in-state jobs insist on written estimates and insurance; FMCSA for interstate legs.',
      'Survey older multi-unit stairs downtown separately from valley SFH product.',
    ],
  },
  ravalli: {
    marketNotes:
