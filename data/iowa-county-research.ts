...
export const iowaCountyResearch: Record<string, CuratedCountyResearch> = {
  polk: {
    ...
    tips: [
      'Treat Polk as Des Moines metro product — neighborhoods, suburbs, and insurance/corporate corridors.',
      'Survey downtown multi-unit elevators separately from west and east suburban HOA multi-family.',
      'Price I-35 / I-80 / I-235 / US-6 portal time honestly for cross-zone pairs.',
      'Verify Iowa DOT Intrastate Motor Carrier Permit covering household goods for pure in-state jobs; FMCSA for interstate legs.',
      'Prefer mid-week early starts; winter ice and summer heat reshape outdoor carries.',
    ],
  },
  linn: {
    marketNotes:
    ...
    tips: [
      'Treat Linn as Cedar Rapids regional industrial + residential mix — not a Des Moines east clone.',
      'Price I-380 / US-30 / US-151 portal time honestly for city ↔ suburb pairs.',
      'Survey older multi-unit stairs separately from suburban growth multi-family.',
      'Verify Iowa DOT household goods permit for pure in-state jobs; FMCSA for interstate legs.',
  ...
  scott: {
    ...
    tips: [
      'Treat Scott as Quad Cities / Davenport Mississippi River product — not Des Moines east.',
      'Clarify Illinois destinations early — short river hops often need FMCSA.',
      'Price I-74 / I-80 / US-61 / US-67 portal time honestly for Quad Cities pairs.',
      'Verify Iowa DOT household goods permit for pure in-state jobs; FMCSA for IL or other interstate legs.',
      'Prefer mid-week starts; winter ice and bridge freeflow reshape outdoor carries.',
    ],
  },
  johnson: {
    marketNotes:
    ...
    tips: [
      'Label every job Johnson County, Iowa (Iowa City / UI) — never apply Johnson County KS or TN assumptions.',
      'Book elevators and crews early for University of Iowa August and January multi-unit peaks.',
      'Price I-80 / US-218 / US-6 portal time honestly for Iowa City ↔ Coralville / North Liberty pairs.',
      'Verify Iowa DOT household goods permit for pure in-state jobs; FMCSA for interstate legs.',
  ...
  'black-hawk': {
    ...
    tips: [
      'Treat Black Hawk as Waterloo–Cedar Falls twin markets — not Cedar Rapids or Des Moines clones.',
      'Price I-380 / US-20 / US-218 portal time honestly for Waterloo ↔ Cedar Falls pairs.',
      'Survey older multi-unit stock separately from campus-adjacent multi-family in Cedar Falls.',
      'Verify Iowa DOT household goods permit for pure in-state jobs; FMCSA for interstate legs.',
      'Prefer mid-week mornings; winter ice and campus peaks reshape outdoor carries.',
    ],
  },
  dallas: {
    marketNotes:
  ...
  woodbury: {
    ...
    tips: [
      'Treat Woodbury as Sioux City / western Iowa Missouri River product — not central Iowa Des Moines spillover.',
      'Clarify Nebraska or South Dakota destinations early — short border hops need FMCSA.',
      'Price I-29 / US-20 / US-75 portal time honestly for Sioux City metro pairs.',
      'Verify Iowa DOT household goods permit for pure in-state jobs; FMCSA for interstate legs.',
      'Prefer mid-week starts; winter ice reshapes outdoor carries on river-city stock.',
    ],
  },
  story: {
    marketNotes:
