...
export const wisconsinCountyResearch: Record<string, CuratedCountyResearch> = {
  milwaukee: {
    ...
    tips: [
      'Reserve elevators and building COIs early for downtown Milwaukee and Third Ward multi-unit stock — curb and dock limits fail estimates more often than packing skill.',
      'Survey East Side and Bay View walk-ups separately from Wauwatosa multi-family; access products differ.',
      'Price I-94 / I-43 / I-894 / US-41/45 portal time honestly for city ↔ west pairs.',
      'For pure in-state jobs insist on written estimates and insurance proof; verify FMCSA for any out-of-state leg.',
      'Prefer mid-week early starts; winter lake-effect ice and month-end lease waves pack docks first.',
    ],
  },
  dane: {
    marketNotes:
    ...
    tips: [
      'Book elevators and crews early for UW–Madison August and January multi-unit peaks on the isthmus.',
      'Photo isthmus curb options and stair counts separately from Fitchburg / Middleton HOA multi-family.',
      'Price Beltline / I-39/90/94 / US-12 / US-18/151 portal time honestly.',
      'For pure in-state jobs insist on written estimates and insurance proof; verify FMCSA for any out-of-state leg.',
      'Prefer mid-week mornings outside semester peaks; winter ice reshapes outdoor carries.',
    ],
  },
  waukesha: {
    marketNotes:
    ...
    tips: [
      'Collect HOA COI packets for Brookfield / New Berlin multi-family before dispatch.',
      'Survey Lake Country lakeshore driveways separately from Brookfield elevators; empty miles differ.',
      'Price I-94 / US-18 / WI-59 / WI-164 portal time honestly for west-metro pairs.',
      'For pure in-state jobs insist on written estimates and insurance proof; verify FMCSA for any out-of-state leg.',
      'Prefer mid-week early starts; school-calendar Saturdays pack west-metro fleets first.',
    ],
  },
  brown: {
    marketNotes:
    ...
    tips: [
      'Avoid home-event peak windows for Lambeau-adjacent addresses when flexible — freeflow collapses.',
      'Survey Green Bay near-core stairs separately from Howard cul-de-sac SFH.',
      'Price I-41 / I-43 / WI-29 portal time honestly for regional pairs.',
      'For pure in-state jobs insist on written estimates and insurance proof; verify FMCSA for any out-of-state leg.',
      'Prefer mid-week mornings; winter ice reshapes outdoor carries.',
    ],
  },
  racine: {
    marketNotes:
    ...
    tips: [
      'Survey downtown Racine stairs separately from Mount Pleasant HOA multi-family.',
      'Price I-94 / WI-20 / WI-31 / WI-32 portal time honestly for Milwaukee or Kenosha pairs.',
      'Do not price Racine mid-size lake stock like Milwaukee East Side density or Kenosha IL-collar product as interchangeable.',
      'For pure in-state jobs insist on written estimates and insurance proof; verify FMCSA for any out-of-state leg.',
      'Prefer mid-week mornings; winter lake-effect ice reshapes outdoor carries.',
    ],
  },
  outagamie: {
    marketNotes:
    ...
    tips: [
      ...
      'Price I-41 / US-10 / WI-441 / WI-47 portal time honestly for Fox Cities pairs.',
  ...
  winnebago: {
    ...
    tips: [
      'Book elevators and crews early for UW Oshkosh August and January multi-unit peaks.',
      'Avoid AirVenture week for non-urgent moves when flexible — freeflow collapses late July.',
      'Price I-41 / US-45 / WI-21 / WI-44 portal time honestly; do not treat Oshkosh as an Appleton clone.',
      'Label every job Winnebago County, Wisconsin — never apply Illinois or Iowa assumptions.',
      'For pure in-state jobs insist on written estimates and insurance proof; verify FMCSA for any out-of-state leg.',
    ],
  },
  kenosha: {
    ...
    tips: [
      'Clarify Illinois destinations early — short I-94 border hops often need FMCSA, not Wisconsin-only assumptions.',
      'Collect HOA packets for Pleasant Prairie multi-family; book elevators early for lakeshore condos.',
      'Price I-94 / WI-50 / WI-158 / WI-31 portal time honestly for Chicago-collar pairs.',
      'For pure in-state jobs insist on written estimates and insurance proof; verify FMCSA for any out-of-state leg.',
      'Prefer mid-week early starts; winter ice and commute peaks reshape outdoor carries.',
    ],
  },
  rock: {
    marketNotes:
