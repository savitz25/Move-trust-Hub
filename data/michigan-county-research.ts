...
export const michiganCountyResearch: Record<string, CuratedCountyResearch> = {
  wayne: {
    ...
    tips: [
      'Confirm movers have auto industry and corporate relocation experience if moving for Ford, GM, or supplier transfers.',
      'Verify coverage for Detroit, Dearborn, Livonia, Westland, and Grosse Pointe before booking — crews may differ across the metro.',
      'I-75, I-94, and I-96 congestion and winter lake-effect storms significantly impact scheduling — confirm crew arrival windows.',
      'Ask about long-distance and interstate scheduling if relocating out of Michigan — harsh winters can affect corridor timing.',
      'Compare at least three in-person or virtual estimates and confirm FMCSA authority before booking.',
    ],
  },
  oakland: {
    marketNotes:
    ...
    tips: [
      'Confirm movers have experience with corporate and healthcare-sector relocations if moving for Stellantis, Beaumont, or tech employers.',
      'Verify coverage for Troy, Rochester Hills, Birmingham, Royal Oak, and Auburn Hills before booking.',
      'I-75 and I-696 suburban corridor traffic and winter weather significantly impact scheduling — confirm crew arrival windows.',
      'High-value suburban homes may require specialty packing — confirm insurance limits and valuation coverage.',
      'Compare at least three in-person or virtual estimates and confirm FMCSA authority before booking.',
    ],
  },
  macomb: {
    ...
    tips: [
      'Confirm movers have experience with manufacturing and industrial corridor relocations along the I-94 Macomb industrial belt.',
      'Verify coverage for Warren, Sterling Heights, Clinton Township, and Shelby Township before booking.',
      'I-94 and M-59 suburban traffic and winter lake-effect snow significantly impact scheduling — confirm crew arrival windows.',
      'Book early for peak seasons (May–September) and month-end lease turnover in northeast Detroit suburbs.',
      'Compare at least three in-person or virtual estimates and confirm FMCSA authority before booking.',
    ],
  },
  kent: {
    ...
    tips: [
      'Confirm movers have experience with manufacturing and furniture-industry corporate relocations across West Michigan.',
      'Verify coverage for Grand Rapids, Wyoming, Kentwood, and Walker before booking.',
      'US-131 and I-96 corridor traffic and lake-effect winter weather significantly impact scheduling — confirm crew arrival windows.',
      'Ask about long-distance hauls if relocating to or from the Detroit metro or Chicago corridors.',
      'Compare at least three in-person or virtual estimates and confirm FMCSA authority before booking.',
    ],
  },
  ottawa: {
  ...
  washtenaw: {
    ...
    tips: [
      'Confirm movers have experience with University of Michigan campus and off-campus student housing if moving near semester start or end.',
      'Verify coverage for Ann Arbor, Ypsilanti, Saline, and Chelsea before booking.',
      'M-14 and I-94 corridor traffic and student move-in/out seasons significantly impact scheduling — confirm crew arrival windows.',
      'Medical and research professional relocations may require flexible scheduling around hospital and lab commitments.',
      'Compare at least three in-person or virtual estimates and confirm FMCSA authority before booking.',
    ],
  },
  ingham: {
    ...
    tips: [
      'Confirm movers have experience with Michigan State University campus and state government relocations if moving to East Lansing or downtown Lansing.',
      'Verify coverage for Lansing, East Lansing, Holt, and Okemos before booking.',
      'I-96 and US-127 corridor traffic and legislative session scheduling can impact crew arrival windows.',
      'Ask about long-distance hauls if relocating between Lansing and Detroit or Grand Rapids metros.',
      'Compare at least three in-person or virtual estimates and confirm FMCSA authority before booking.',
    ],
  },
  kalamazoo: {
  ...
  marquette: {
    ...
    tips: [
      'Confirm movers have Upper Peninsula and long-distance experience — many UP moves require multi-day scheduling and winter road planning.',
      'Verify coverage for Marquette, Negaunee, and Ishpeming before booking — rural UP logistics differ from Lower Peninsula metros.',
      'US-41 lake-effect snow and harsh winter conditions significantly impact scheduling — confirm crew arrival windows and backup dates.',
      'Tourism and second-home moves along Lake Superior may require seasonal coordination — book early for summer turnover.',
      'Compare at least three in-person or virtual estimates and confirm FMCSA authority before booking.',
    ],
  },
  shiawassee: {
