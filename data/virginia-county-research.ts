...
export const virginiaCountyResearch: Record<string, CuratedCountyResearch> = {
  fairfax: {
    marketNotes:
      'Fairfax County is one of Virginiaâ€™s largest and wealthiest counties with strong suburban, corporate, and residential demand across Northern Virginia and the Washington DC metro.',
    costs: {
    ...
    tips: [
      ...
      'Book early for peak seasons (Mayâ€“September), federal PCS turnover, and month-end lease changeover.',
  ...
  loudoun: {
    ...
    tips: [
      ...
      'Book early for peak seasons (Mayâ€“September), corporate relocations, and month-end lease changeover.',
      'Obtain multiple estimates and re-verify FMCSA authority, BBB rating, and current reviews.',
    ],
  },
  'virginia-beach': {
    ...
    tips: [
      ...
      'Book early for peak tourist seasons (Juneâ€“August), military PCS windows, and summer relocations.',
      'Obtain multiple estimates and re-verify FMCSA authority, BBB rating, and current reviews.',
    ],
  },
  chesterfield: {
  ...
  chesapeake: {
    ...
    tips: [
      ...
      'Book early for peak seasons (Mayâ€“September), military PCS windows, and summer relocations.',
      'Obtain multiple estimates and re-verify FMCSA authority, BBB rating, and current reviews.',
    ],
  },
  arlington: {
    ...
    costs: {
      studioRange: '$950â€“$2,000',
      familyRange: '$3,800â€“$9,000+',
      avgHourly: '$140â€“$215/hr for a 2-person crew',
    ...
    tips: [
      ...
      'Book early for peak seasons (Mayâ€“September), federal turnover, and month-end lease changeover.',
      'Obtain multiple estimates and re-verify FMCSA authority, BBB rating, and current reviews.',
    ],
  },
  richmond: {
    ...
    costs: {
      ...
      avgHourly: '$120â€“$180/hr for a 2-person crew',
    ...
    tips: [
      ...
      'Book early for peak seasons (Mayâ€“September) and legislative session turnover.',
      'Obtain multiple estimates and re-verify FMCSA authority, BBB rating, and current reviews.',
    ],
  },
  norfolk: {
    ...
    tips: [
      ...
      'Book early for peak seasons (Mayâ€“September), PCS windows, and summer relocations.',
      'Obtain multiple estimates and re-verify FMCSA authority, BBB rating, and current reviews.',
    ],
  },
  'newport-news': {
  ...
  stafford: {
    ...
    tips: [
      ...
      'Heavy Northern Virginia traffic significantly impacts scheduling â€” confirm crew arrival windows.',
      'Confirm insurance for high-value suburban homes and new-construction communities.',
      'Book early for peak seasons (Mayâ€“September), military PCS turnover, and month-end lease changeover.',
      'Obtain multiple estimates and re-verify FMCSA authority, BBB rating, and current reviews.',
    ],
  },
  alexandria: {
  ...
  albemarle: {
    ...
    tips: [
      ...
      'Book early for peak seasons (Mayâ€“September), semester changeover, and graduation weekends.',
      'Obtain multiple estimates and re-verify FMCSA authority, BBB rating, and current reviews.',
    ],
  },
  hanover: {
  ...
  suffolk: {
    ...
    tips: [
      ...
      'Book early for peak seasons (Mayâ€“September) and summer relocations.',
      'Obtain multiple estimates and re-verify FMCSA authority, BBB rating, and current reviews.',
    ],
  },
  frederick: {
  ...
  montgomery: {
    ...
    tips: [
      ...
      'Book early for peak seasons (Mayâ€“September), semester changeover (August and May), and graduation weekends.',
      'Obtain multiple estimates and re-verify FMCSA authority, BBB rating, and current reviews.',
    ],
  },
  'roanoke-county': {
  ...
  'james-city': {
    ...
    tips: [
      ...
      'Book early for peak tourist seasons (Juneâ€“August) and summer relocations.',
      'Obtain multiple estimates and re-verify FMCSA authority, BBB rating, and current reviews.',
    ],
  },
  bedford: {
    ...
    tips: [
      ...
      'Book early for peak seasons (Mayâ€“September) and summer lake-home turnover.',
      'Obtain multiple estimates and re-verify FMCSA authority, BBB rating, and current reviews.',
    ],
  },
  lynchburg: {
    ...
    tips: [
      ...
      'Book early for peak seasons (Mayâ€“September) and semester changeover.',
      'Obtain multiple estimates and re-verify FMCSA authority, BBB rating, and current reviews.',
    ],
  },
  augusta: {
