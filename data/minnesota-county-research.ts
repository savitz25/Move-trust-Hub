...
export const minnesotaCountyResearch: Record<string, CuratedCountyResearch> = {
  hennepin: {
    ...
    tips: [
      'Reserve elevators and building COIs early for downtown Minneapolis and North Loop multi-unit stock — curb and dock limits fail estimates more often than packing skill.',
      'Survey lakeside and central neighborhood walk-ups separately from Edina / Minnetonka west-metro HOA driveways; access products differ.',
      'Price I-94 / I-35W / I-394 / I-494 portal time honestly for city ↔ west-metro pairs.',
      'Verify MnDOT household goods mover permit for pure in-state jobs; FMCSA for any out-of-state leg.',
      'Prefer mid-week early starts; winter ice and month-end lease waves pack downtown docks first.',
    ],
  },
  ramsey: {
    marketNotes:
    ...
    tips: [
      'Treat St. Paul capital multi-unit and Cathedral Hill walk-ups as east-river product — not a Minneapolis lakeside clone.',
      'Price I-35E / I-94 / I-694 / US-61 portal time honestly for downtown ↔ Shoreview / Maplewood pairs.',
      'Collect elevator reservations and COIs for Lowertown and downtown towers before the survey is final.',
      'Verify MnDOT household goods mover permit for pure in-state jobs; FMCSA for interstate legs.',
      'Plan winter snow-emergency parking bans into outdoor carries; prefer mid-week mornings.',
    ],
  },
  dakota: {
    marketNotes:
    ...
    tips: [
      'Collect HOA COI packets and timed windows for Eagan / Burnsville / Apple Valley multi-family before dispatch.',
      'Price I-35 / I-494 / MN-77 portal time honestly for south-metro ↔ Twin Cities core pairs.',
      'Do not price Lakeville cul-de-sac SFH like downtown Minneapolis elevators; empty miles and access differ.',
      'Verify MnDOT household goods mover permit for pure in-state jobs; FMCSA for interstate legs.',
      'Prefer mid-week early starts; school-calendar Saturdays pack south-metro fleets first.',
    ],
  },
  anoka: {
    marketNotes:
    ...
    tips: [
      'Collect HOA packets for Blaine / Coon Rapids multi-family; survey Andover driveway SFH separately.',
      'Price I-35W / US-10 / MN-65 / 610 portal time honestly for north-metro pairs.',
      'Do not price Anoka river-town core like Blaine townhomes as interchangeable products.',
      'Verify MnDOT household goods mover permit for pure in-state jobs; FMCSA for interstate legs.',
      'Prefer mid-week mornings; winter driveway ice and school peaks reshape outdoor carries.',
    ],
  },
  washington: {
    marketNotes:
    ...
    tips: [
      'Label every job Washington County, Minnesota — never apply Washington State or Seattle logistics assumptions.',
      'Collect HOA packets for Woodbury multi-family; photo Stillwater historic stairs and tourism curb separately.',
      'Price I-94 / MN-36 / MN-5 / St. Croix approach portal time honestly; clarify Wisconsin border hops early (FMCSA).',
      'Verify MnDOT household goods mover permit for pure in-state jobs; FMCSA for any out-of-state leg.',
      'Prefer mid-week starts in Stillwater tourism season; winter ice reshapes outdoor carries.',
    ],
  },
  'st-louis': {
    marketNotes:
    ...
    tips: [
      'Label every job St. Louis County, Minnesota — never apply St. Louis, Missouri metro assumptions.',
      'Photo Duluth hill grades, stair counts, and truck length before sizing; winter ice on hills fails estimates often.',
      'Price I-35 / US-53 / MN-61 portal time honestly, including North Shore cabin empty miles and tourism peaks.',
      'Verify MnDOT household goods mover permit for pure in-state jobs; FMCSA for Wisconsin Superior or other interstate legs.',
      'Prefer mid-week shoulder-season starts; lake-effect snow November–April demands flexible dates.',
    ],
  },
  olmsted: {
    marketNotes:
    ...
    tips: [
      'Capture Mayo Clinic hard report dates, temporary housing, and storage-in-transit before the survey is final.',
      'Reserve elevators and COIs early for downtown Rochester multi-unit near campus corridors.',
      'Price US-52 / US-14 / US-63 portal time honestly; do not treat Rochester as a Twin Cities collar hop.',
      'Verify MnDOT household goods mover permit for pure in-state jobs; FMCSA for interstate medical relo legs.',
      'Build winter ice contingency around inflexible clinic start dates; book summer fellowship peaks early.',
    ],
  },
  stearns: {
    marketNotes:
    ...
    tips: [
      'Book elevators and crews early for St. Cloud State August and January multi-unit peaks.',
      'Survey downtown walk-ups separately from Sartell / Sauk Rapids HOA townhomes; products differ.',
      'Price I-94 / MN-15 / MN-23 / US-10 portal time honestly — Twin Cities pairs are long hauls, not collar hops.',
      'Verify MnDOT household goods mover permit for pure in-state jobs; FMCSA for interstate legs.',
      'Prefer mid-week mornings; winter ice and semester waves pack fleets first.',
    ],
  },
  scott: {
    marketNotes:
