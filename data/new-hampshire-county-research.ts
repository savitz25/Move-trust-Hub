...
export const newHampshireCountyResearch: Record<string, CuratedCountyResearch> = {
  hillsborough: {
    ...
    tips: [
      'Label every job Hillsborough / Manchester–Nashua — never apply Rockingham seacoast or Concord capital templates as defaults.',
      'Survey mill multi-unit stairs and elevator COIs separately from Bedford–Merrimack HOA cul-de-sacs.',
      'Price I-93 · I-293 · NH-101 · US-3 portal time honestly for cross-zone pairs.',
      'Verify New Hampshire household goods carrier authority (RSA 359-T / DOS Bureau) for pure in-state jobs; FMCSA for any MA or other interstate leg.',
      'Prefer mid-week early starts; winter ice and school peaks pack southern NH fleets first.',
    ],
  },
  rockingham: {
    marketNotes:
    ...
    tips: [
      'Treat Rockingham as Seacoast product (Portsmouth / Hampton / Exeter) — not a Manchester–Nashua I-93 clone.',
      'Price I-95 · NH-101 · NH-16 · US-1 portal time honestly; summer tourism compresses curb windows.',
      'Short MA border hops need FMCSA even when map miles look local.',
      'Verify New Hampshire household goods carrier authority for pure in-state jobs; FMCSA for interstate legs.',
  ...
  merrimack: {
    ...
    tips: [
      'Treat Merrimack as Concord capital product — not Manchester north or Seacoast spillover.',
      'Price I-93 · I-89 · US-4 · US-202 portal time honestly for capital ↔ suburb pairs.',
      'Capital workforce mid-month calendars often matter more than Saturday peaks.',
      'Verify New Hampshire household goods carrier authority for pure in-state jobs; FMCSA for interstate legs.',
      'Survey older Concord multi-unit stairs separately from west-suburb HOA stock.',
    ],
  },
  strafford: {
    marketNotes:
    ...
    tips: [
      'Treat Strafford as Dover–Rochester / Spaulding product — not a Portsmouth seacoast-only clone.',
      'Price NH-16 (Spaulding) · US-4 portal time honestly for twin-city pairs.',
      'UNH semester peaks near Durham cluster elevators and curb demand in August and January.',
      'Verify New Hampshire household goods carrier authority for pure in-state jobs; FMCSA for ME/MA legs.',
      'Survey mill multi-unit stairs in Dover and Rochester separately from rural township drives.',
    ],
  },
  grafton: {
    marketNotes:
    ...
    tips: [
      'Treat Grafton as Upper Valley / Hanover–Lebanon — not southern New Hampshire density north.',
      'Price I-89 · I-91 links · US-4 portal time honestly; winter mountain access is a real labor input.',
      'Vermont border pairs need FMCSA even when Connecticut River hops look local on a map.',
      'Verify New Hampshire household goods carrier authority for pure in-state jobs; FMCSA for interstate legs.',
      'Book around Dartmouth academic and medical report calendars when relevant.',
    ],
  },
  cheshire: {
    marketNotes:
