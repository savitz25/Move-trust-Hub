...
export const oklahomaCountyResearch: Record<string, CuratedCountyResearch> = {
  oklahoma: {
    ...
    tips: [
      'Treat Oklahoma County as Oklahoma City metro product — county-clear OKC, not statewide generic guidance.',
      'Survey downtown/midtown multi-unit elevators separately from north and west suburban HOA multi-family.',
      'Price I-35 / I-40 / I-44 / I-235 / Kilpatrick Turnpike portal time honestly for cross-zone pairs.',
      'Verify OCC Household Goods Certificate for pure in-state jobs (even within city limits); FMCSA for interstate legs.',
      'Prefer mid-week early starts; summer heat and storm seasons reshape outdoor carries.',
    ],
  },
  tulsa: {
    marketNotes:
    ...
    tips: [
      'Treat Tulsa as a distinct river-city market — not an Oklahoma City rename.',
      'Price I-44 / I-244 / US-75 / US-169 / Creek Turnpike portal time honestly for midtown ↔ south Tulsa pairs.',
      'Survey midtown multi-unit stairs separately from south Tulsa HOA multi-family.',
      'Verify OCC Household Goods Certificate for pure in-state jobs; FMCSA for interstate legs.',
      'Prefer mid-week mornings; heat and storm seasons reshape outdoor carries.',
    ],
  },
  cleveland: {
    marketNotes:
    ...
    tips: [
      'Label every job Cleveland County, Oklahoma (Norman) — never apply Cleveland, Ohio logistics assumptions.',
      'Plan OU campus lease waves into multi-unit estimates; survey Norman multi-family separately from rural edges.',
      'Price I-35 / US-77 / OK-9 portal time honestly for Norman ↔ OKC pairs.',
      'Verify OCC Household Goods Certificate for pure in-state jobs; FMCSA for interstate legs.',
      'Prefer mid-week starts outside semester peaks.',
    ],
  },
  canadian: {
    marketNotes:
    ...
    tips: [
      'Treat Canadian as west OKC growth (Yukon/Mustang) — not downtown Oklahoma County elevators as the default.',
      'Collect HOA packets for multi-family growth; price I-40 / Kilpatrick / OK-4 portal time honestly.',
      'Clarify Canadian vs Oklahoma County addresses on every multi-address estimate.',
      'Verify OCC Household Goods Certificate for pure in-state jobs; FMCSA for interstate legs.',
  ...
  comanche: {
    ...
    tips: [
      'Treat Comanche as Lawton southwest regional product with Fort Sill adjacency where accurate — not OKC or Tulsa spillover.',
      'Capture PCS/hard report dates and storage-in-transit needs early for military-adjacent households.',
      'Price I-44 / US-62 / US-281 portal time honestly for city ↔ base-adjacent pairs.',
      'Verify OCC Household Goods Certificate for pure in-state jobs; FMCSA for interstate legs.',
      'Prefer mid-week starts; military calendars cluster mid-month demand.',
    ],
  },
  rogers: {
    marketNotes:
    ...
    tips: [
      'Treat Rogers as northeast Tulsa metro fringe (Claremore/Catoosa) — not Tulsa midtown defaults.',
      'Price I-44 / OK-66 / OK-20 portal time honestly; empty miles matter on fringe pairs.',
      'Survey growth multi-family separately from older small-city stock.',
      'Verify OCC Household Goods Certificate for pure in-state jobs; FMCSA for interstate legs.',
      'Prefer mid-week mornings; school peaks pack northeast-metro fleets first.',
    ],
  },
  wagoner: {
    marketNotes:
