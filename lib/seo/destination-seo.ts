...
export const DESTINATIONS_INDEX_DESCRIPTION =
  'Explore inbound moving guides for Myrtle Beach, South Florida, and fast-growing relocation markets. Compare FMCSA-verified movers, estimate costs with our free calculator, and get matched with 2–3 licensed quotes within 24 hours.';
...
export const HOMEPAGE_SEO_DESCRIPTION =
  'Compare 25+ FMCSA-licensed interstate movers by reviews, pricing, and safety ratings. Free moving calculator, city destination guides (Myrtle Beach, Florida), and 3,100+ county-level local mover directories. Get matched with 2–3 quotes in 24 hours — independent directory, no sales pressure.';
