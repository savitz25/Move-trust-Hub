...
export const massachusettsToNorthCarolinaContent: RouteGuideExtendedContent = {
  slug: 'massachusetts-to-north-carolina',
  seo: {
    title:
      'Moving from Massachusetts to North Carolina (2026–2027) — Costs, Timeline & Mover Guide | Move Trust Hub',
    description:
      'Plan your Massachusetts to North Carolina move: ~750–900 miles, 2–7 day delivery, and $2,600–$6,200+ costs by home size. MA pickup tips, Charlotte and Research Triangle destination insights, car shipping, and how to compare FMCSA-licensed movers.',
    keywords: [
      'moving from massachusetts to north carolina',
      'massachusetts to north carolina moving cost 2026',
      'boston to charlotte moving cost',
      'boston to raleigh movers',
      'ma to charlotte relocation',
      'interstate move massachusetts north carolina',
      'boston to research triangle movers',
      'ship car massachusetts to north carolina',
      'massachusetts retiree move north carolina',
      'cape cod to wilmington nc movers',
    ],
  },
  heroSubheadline:
  ...
  whyMove: {
    heading: 'Why people move from Massachusetts to North Carolina',
    paragraphs: [
    ...
    highlights: [
      {
        ...
        body: 'Purchase prices, rent, and monthly carrying costs in Charlotte, Raleigh, and Wilmington suburbs undercut Boston Metro, North Shore, and MetroWest premiums — especially for families upsizing from triple-deckers and townhouses to single-family homes.',
      },
      {
        title: 'Charlotte & RTP jobs',
        body: 'Banking and fintech headquarters in Charlotte, Fortune 500 and RTP tech-and-biotech hiring in Raleigh and Durham, and Wilmington healthcare growth sustain career-driven inbound volume — a corridor that attracts finance, tech, and healthcare transferees from Boston and Cambridge metros.',
      },
      {
        title: 'Retirement appeal',
        body: 'Milder winters, lower property tax exposure, and active-adult and golf communities in Lake Norman spillover, coastal Wilmington, and foothills markets attract empty-nesters from Norfolk, Middlesex, and Essex counties who want Northeast income without Northeast housing pressure.',
      },
      {
        title: 'More space',
        body: 'Suburban lots, garage storage, home offices, and community amenities that are cost-prohibitive in Back Bay Boston, dense Cambridge neighborhoods, and cramped North Shore townhomes — plus easier regional travel when you need to return northeast.',
      },
      {
  ...
  destinations: {
    heading: 'Major North Carolina destinations for Massachusetts transplants',
    intro:
  ...
  costBreakdown: {
    heading: 'Cost breakdown: what Massachusetts to North Carolina moves cost in 2026–2027',
    paragraphs: [
    ...
    seasons: [
      {
        ...
        note: 'Highest MA→NC Piedmont demand; tighter crews, wider delivery spreads, and modest price premiums. Book early; confirm HOA move-in windows in Apex, Cary, Wendell Falls, and Lake Norman communities.',
      },
      {
      ...
      },
      {
        ...
        note: 'Families moving on school calendars spike certain weeks — confirm carrier capacity before accepting MA lease end dates and NC start dates, especially for Charlotte Uptown condo and RTP new-build turnovers.',
      },
    ],
  },
  pickupTips: {
    ...
    tips: [
      ...
      'Order street parking permits or reserve loading zones where Boston, Cambridge, and suburban towns require them; dense triple-decker blocks rarely accommodate 53-foot trailers at the curb without a shuttle truck.',
      ...
      'Cape Cod and island origins may require ferry coordination or staging at a mainland lot — confirm whether your carrier\'s warehouse is Boston-based or Cape-accessible for accurate transit estimates.',
  ...
  deliveryTips: {
    ...
    tips: [
      ...
      'For Charlotte Uptown and South End high-rises, replicate Boston discipline: COI filings, freight elevator bookings, and dock or podium reservations two weeks ahead.',
  ...
  carShipping: {
    heading: 'Shipping your car from Massachusetts to North Carolina',
    paragraphs: [
    ...
    tips: [
      ...
      'Expect 3–6 days for open carrier Massachusetts to North Carolina transit, with wider windows during Charlotte and Research Triangle summer peak.',
  ...
  faqItems: [
    {
      question: 'How much does it cost to move from Massachusetts to North Carolina?',
      answer:
    ...
    {
      question: 'How long does a Massachusetts to North Carolina move take?',
      answer:
    ...
    {
      question: 'How many miles is it from Massachusetts to North Carolina?',
      answer:
    ...
    {
      question: 'Is moving from Massachusetts to North Carolina worth it for cost of living?',
      answer:
    ...
    {
      question: 'What is the best time of year to move from Massachusetts to North Carolina?',
      answer:
    ...
    {
      question: 'How do I avoid moving scams on the MA to North Carolina corridor?',
      answer:
    ...
    {
      question: 'Which North Carolina destination is most popular for Massachusetts transplants?',
      answer:
  ...
  howToSteps: [
    {
      ...
      text: 'Use the free Move Trust Hub moving calculator to estimate cubic feet and weight for every room, closet, basement, attic, and garage — MA basement and attic underestimates are costly on I-85 southbound linehaul.',
    },
    {
  ...
  internalLinks: [
    {
      ...
      description: 'Estimate cubic feet and weight before you request MA→NC quotes.',
    },
    {
      label: 'FMCSA-licensed movers directory',
      href: '/companies',
      description: 'Browse and compare interstate carriers serving Massachusetts and North Carolina.',
    },
    {
