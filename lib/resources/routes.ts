...
export const routeGuides: RouteGuide[] = [
  ...
  },
  {
    ...
    relatedRoutes: ['california-to-texas', 'new-york-to-florida', 'texas-to-california', 'east-coast-to-west-coast'],
    destinationHubPath: '/moving-to/texas',
  },
  {
    ...
    relatedRoutes: ['florida-to-new-york', 'new-york-to-texas', 'california-to-new-york', 'california-to-texas'],
