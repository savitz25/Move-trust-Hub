...
> = {
  ...
  yadkin: { seat: 'Yadkinville', metro: 'winston-salem-triad-metro-nc' },
  dare: { seat: 'Manteo', metro: 'outer-banks-metro-nc' },
  alexander: { seat: 'Taylorsville', metro: 'hickory-lenoir-metro-nc' },
  transylvania: { seat: 'Brevard', metro: 'asheville-metro-nc' },
  currituck: { seat: 'Currituck', metro: 'outer-banks-metro-nc' },
  scotland: { seat: 'Laurinburg', metro: 'fayetteville-metro-nc' },
  cherokee: { seat: 'Murphy', metro: 'asheville-metro-nc' },
  bladen: { seat: 'Elizabethtown', metro: 'wilmington-metro-nc' },
  ashe: { seat: 'Jefferson', metro: 'boone-metro-nc' },
  montgomery: { seat: 'Troy', metro: 'fayetteville-metro-nc' },
  caswell: { seat: 'Yanceyville', metro: 'greensboro-high-point-metro-nc' },
  chowan: { seat: 'Edenton', metro: 'elizabeth-city-metro-nc' },
  swain: { seat: 'Bryson City', metro: 'asheville-metro-nc' },
  perquimans: { seat: 'Hertford', metro: 'elizabeth-city-metro-nc' },
  pamlico: { seat: 'Bayboro', metro: 'new-bern-metro-nc' },
  clay: { seat: 'Hayesville', metro: 'asheville-metro-nc' },
  alleghany: { seat: 'Sparta', metro: 'boone-metro-nc' },
  camden: { seat: 'Camden', metro: 'elizabeth-city-metro-nc' },
  washington: { seat: 'Plymouth', metro: 'greenville-metro-nc' },
  gates: { seat: 'Gatesville', metro: 'elizabeth-city-metro-nc' },
  jones: { seat: 'Trenton', metro: 'new-bern-metro-nc' },
  graham: { seat: 'Robbinsville', metro: 'asheville-metro-nc' },
  hyde: { seat: 'Swan Quarter', metro: 'elizabeth-city-metro-nc' },
  tyrrell: { seat: 'Columbia', metro: 'elizabeth-city-metro-nc' },
};
