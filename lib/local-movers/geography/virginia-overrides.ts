...
> = {
  ...
  chesapeake: {
    seat: 'Chesapeake',
    metro: 'chesapeake-metro-va',
    name: 'Chesapeake City',
  },
  arlington: {
    seat: 'Arlington',
    metro: 'arlington-metro-va',
    name: 'Arlington County',
  },
  // Independent city (capital) — not Richmond County (Northern Neck / Warsaw).
  richmond: {
    seat: 'Richmond',
    metro: 'richmond-metro-va',
    name: 'Richmond City',
  },
  norfolk: { seat: 'Norfolk', metro: 'norfolk-metro-va', name: 'Norfolk City' },
...
> = {
  ...
  richmond: {
    ...
    // Capital independent city (Fan/Museum District market) — not Northern Neck county.
    'virginia-region-2': { slug: 'richmond', name: 'Richmond City' },
  },
  roanoke: {
