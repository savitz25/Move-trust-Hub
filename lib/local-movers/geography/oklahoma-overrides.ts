...
> = {
  ...
  blaine: { seat: 'Watonga', metro: 'watonga-metro-ok' },
  woods: { seat: 'Alva', metro: 'alva-metro-ok' },
  kiowa: { seat: 'Hobart', metro: 'hobart-metro-ok' },
  major: { seat: 'Fairview', metro: 'fairview-metro-ok' },
  tillman: { seat: 'Frederick', metro: 'frederick-metro-ok' },
  alfalfa: { seat: 'Cherokee', metro: 'cherokee-metro-ok' },
  jefferson: { seat: 'Waurika', metro: 'waurika-metro-ok' },
  coal: { seat: 'Coalgate', metro: 'coalgate-metro-ok' },
  cotton: { seat: 'Walters', metro: 'walters-metro-ok' },
  greer: { seat: 'Mangum', metro: 'mangum-metro-ok' },
  beaver: { seat: 'Beaver', metro: 'beaver-metro-ok' },
  dewey: { seat: 'Taloga', metro: 'taloga-metro-ok' },
  grant: { seat: 'Medford', metro: 'medford-metro-ok' },
  ellis: { seat: 'Arnett', metro: 'arnett-metro-ok' },
  'roger-mills': { seat: 'Cheyenne', metro: 'cheyenne-metro-ok' },
  harper: { seat: 'Buffalo', metro: 'buffalo-metro-ok' },
  harmon: { seat: 'Hollis', metro: 'hollis-metro-ok' },
  cimarron: { seat: 'Boise City', metro: 'boise-city-metro-ok' },
};
