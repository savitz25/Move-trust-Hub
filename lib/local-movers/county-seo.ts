...
export function buildStateDescription(
  ...
  if (stateName === 'Wisconsin') {
    return `Find curated local movers in 30 Wisconsin county guides — 10 ranked companies in Milwaukee, Madison (Dane), Waukesha, Green Bay (Brown), Racine, Appleton (Outagamie), Oshkosh (Winnebago), Kenosha, Janesville (Rock), Wausau (Marathon), West Bend (Washington), La Crosse, Sheboygan, Eau Claire, Elkhorn (Walworth), Fond du Lac, Hudson (St. Croix), Port Washington (Ozaukee), Juneau (Dodge), Jefferson, Manitowoc, Wisconsin Rapids (Wood), Stevens Point (Portage), Chippewa Falls, Baraboo (Sauk), Portage (Columbia), Chilton (Calumet), Lancaster (Grant), Waupaca, and Sparta (Monroe). Milwaukee, Ozaukee, and Washington metros cover north suburban I-43/I-41 corridor traffic; St. Croix covers Twin Cities west-metro commuter relocations; La Crosse and Chippewa Valley cover Mississippi River cross-border logistics; Fox Cities, Green Bay, and Sheboygan cover northeast Wisconsin regional hub demand; Madison covers state government and UW campus turnover; lakes-country counties cover seasonal vacation-home moves for ${SEO_YEAR}. Use our free moving calculator and interstate directory.`;
  }
