...
export function buildStateDescription(
  ...
  if (stateName === 'Wisconsin') {
    return `Find curated local movers in all 72 Wisconsin county guides — 10 ranked companies per county from Milwaukee and Madison metros through Fox Cities, Green Bay, Kenosha, Twin Cities fringe, Duluth–Superior, Door Peninsula, Chippewa Valley, Driftless Area, and northwoods lakes-country markets for ${SEO_YEAR}. Use our free moving calculator and interstate directory.`;
  }
