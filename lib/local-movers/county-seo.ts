...
export function buildStateDescription(
  ...
  if (stateName === 'Wisconsin') {
    return `Find curated local movers in 50 Wisconsin county guides — 10 ranked companies per county across Milwaukee and Madison metros, Fox Cities and Green Bay, Kenosha and Chicago–Milwaukee corridor, Twin Cities fringe (St. Croix, Pierce), Duluth–Superior (Douglas), Door Peninsula tourism markets, Chippewa Valley, Driftless Area counties, and northwoods lakes-country guides for ${SEO_YEAR}. Use our free moving calculator and interstate directory.`;
  }
