...
export function stateIntrastateCredentialPhrase(stateSlug: string): string {
  switch (stateSlug) {
    ...
    case 'maryland':
      return 'Maryland household goods mover registration (Dept. of Labor) for in-state-only jobs when applicable';
    case 'massachusetts':
    ...
    case 'alabama':
      return 'APSC Motor Carrier Services household goods authority for in-state-only jobs when applicable';
    case 'louisiana':
      return 'LPSC household goods common carrier certificate for in-state-only jobs when applicable';
    case 'oklahoma':
    ...
    case 'kansas':
      return 'KCC household goods Certificate of Public Convenience and Necessity for in-state-only jobs when applicable';
    case 'mississippi':
      return 'MDOT household goods carrier authority for in-state-only jobs when applicable';
    case 'new-hampshire':
      return 'New Hampshire household goods carrier authority (RSA 359-T / DOS Bureau) for in-state-only jobs when applicable';
    case 'maine':
      return 'written estimates, insurance proof, and Maine BMV motor-carrier frameworks when applicable for in-state-only jobs';
    case 'nebraska':
    ...
    case 'vermont':
      return 'written estimates, insurance proof, and Vermont DMV CVO motor-carrier frameworks when applicable for in-state-only jobs';
    case 'delaware':
      return 'written estimates, insurance proof, and Delaware DMV motor-carrier frameworks when applicable for in-state-only jobs';
    case 'alaska':
      return 'Alaska business license, written estimates, and insurance for in-state-only jobs when applicable';
    case 'hawaii':
      return 'Hawaii PUC household goods motor carrier CPCN for in-state-only and inter-island jobs when applicable';
    case 'montana':
      return 'written estimates, insurance proof, and MDT Motor Carrier Services frameworks when applicable for in-state-only jobs';
    case 'north-dakota':
      return 'NDDOT Household Goods Carrier Permit for in-state-only jobs when applicable';
    case 'south-dakota':
      return 'written estimates, insurance proof, and SD DOR motor-carrier frameworks when applicable for in-state-only jobs';
    case 'wyoming':
      return 'WYDOT Operating Authority (Letter of Authority) for in-state-only jobs when applicable';
    default:
                                    ...
                                    : county.stateSlug === 'washington'
                                      ...
                                      : county.stateSlug === 'oregon'
                                        ...
                                        : county.stateSlug === 'maryland'
                                          ? `Interstate moves require active FMCSA USDOT and usually MC authority — verify on FMCSA SAFER. Purely local/intrastate Maryland household goods moves using a commercial motor vehicle generally require active Maryland household goods mover registration with the Department of Labor, Division of Occupational and Professional Licensing (Household Goods Movers Registration Unit under Business Regulation Title 8.5). Confirm active registration matching the legal name on your estimate. FMCSA does not cover every in-state Maryland job; confirm Maryland HHG registration vs FMCSA for your exact origin and destination before you deposit.`
                                                          ...
                                                          : county.stateSlug === 'kentucky'
                                                            ...
                                                            : county.stateSlug === 'nevada'
                                                              ...
                                                              : county.stateSlug === 'alabama'
                                                                ? `Interstate moves require active FMCSA USDOT and usually MC authority — verify on FMCSA SAFER. Purely local/intrastate Alabama household goods moves by for-hire carriers generally require Alabama Public Service Commission (APSC) Motor Carrier Services intrastate authority under the Alabama Motor Carrier Act (Title 37 Chapter 3), including cargo and liability insurance filings and an approved tariff. Confirm active APSC authority matching the legal name on your estimate. FMCSA does not cover every in-state Alabama job; confirm APSC household goods authority vs FMCSA for your exact origin and destination before you deposit.`
                                                                : county.stateSlug === 'louisiana'
                                                                  ? `Interstate moves require active FMCSA USDOT and usually MC authority — verify on FMCSA SAFER. Purely local/intrastate Louisiana household goods moves are regulated by the Louisiana Public Service Commission (LPSC). Intrastate movers generally must hold a common carrier certificate from the LPSC before engaging in household goods moving activities (La. R.S. 45:164.E). Confirm the company is registered and in good standing, and obtain a written estimate matching the legal name on the paperwork. FMCSA does not cover every in-state Louisiana job; confirm LPSC household goods authority vs FMCSA for your exact origin and destination before you deposit.`
                                                                      ...
                                                                      : county.stateSlug === 'arkansas'
                                                                        ...
                                                                        : county.stateSlug === 'new-mexico'
                                                                          ...
                                                                          : county.stateSlug === 'kansas'
                                                                            ? `Interstate moves require active FMCSA USDOT and usually MC authority — verify on FMCSA SAFER. Purely local/intrastate Kansas household goods moves by for-hire carriers generally require a Certificate of Public Convenience and Necessity from the Kansas Corporation Commission (KCC) Transportation Division, with household goods tariff frameworks under commission oversight. Confirm active KCC authority matching the legal name on your estimate. FMCSA does not cover every in-state Kansas job; confirm KCC household goods authority vs FMCSA for your exact origin and destination before you deposit.`
                                                                            : county.stateSlug === 'mississippi'
                                                                              ? `Interstate moves require active FMCSA USDOT and usually MC authority — verify on FMCSA SAFER. Purely local/intrastate Mississippi household goods moves by for-hire carriers generally require Mississippi Department of Transportation (MDOT) household goods carrier authority under Certificate of Public Convenience and Necessity application frameworks with required insurance documentation. Confirm active MDOT household goods authority matching the legal name on your estimate. FMCSA does not cover every in-state Mississippi job; confirm MDOT household goods authority vs FMCSA for your exact origin and destination before you deposit.`
                                                                              : county.stateSlug === 'new-hampshire'
                                                                                ? `Interstate moves require active FMCSA USDOT and usually MC authority — verify on FMCSA SAFER. Purely local/intrastate New Hampshire household goods moves by for-hire carriers generally require Household Goods Carrier authority (permit or certificate pathways) under RSA 359-T frameworks administered through the New Hampshire Department of Safety Bureau of common carriers rules. Updated guidance emphasizes written estimates on customer request and annual DMV registration for vehicles used in household goods service. Confirm active New Hampshire household goods carrier authority matching the legal name on your estimate. FMCSA does not cover every in-state New Hampshire job; confirm NH household goods carrier authority vs FMCSA for your exact origin and destination before you deposit.`
                                                                                : county.stateSlug === 'maine'
                                                                                  ? `Interstate moves require active FMCSA USDOT and usually MC authority — verify on FMCSA SAFER. Maine does not maintain a dedicated statewide household-goods mover certificate program comparable to Massachusetts DPU or New Hampshire RSA 359-T household goods carrier authority. Maine Bureau of Motor Vehicles (BMV) Motor Carrier Services handles commercial motor-carrier frameworks (IRP, IFTA, UCR, for-hire insurance). For pure in-state Maine jobs, insist on written estimates matching the legal business name, cargo and liability insurance certificates, and clear inventory terms. FMCSA does not cover every in-state Maine job; confirm insurance, written contracts, and FMCSA for any out-of-state leg before you deposit.`
                                                                                      ...
                                                                                      : county.stateSlug === 'west-virginia'
                                                                                        ...
                                                                                        : county.stateSlug === 'rhode-island'
                                                                                          ...
                                                                                          : county.stateSlug === 'vermont'
                                                                                            ? `Interstate moves require active FMCSA USDOT and usually MC authority — verify on FMCSA SAFER. Vermont does not maintain a dedicated statewide household-goods mover certificate program comparable to New Hampshire RSA 359-T or Massachusetts DPU operating certificates. For pure in-state Vermont jobs, insist on a written estimate matching the legal business name, cargo and liability insurance certificates, and clear inventory terms — and ask whether Vermont DMV Commercial Vehicle Operations (CVO) motor-carrier frameworks apply. FMCSA does not cover every in-state Vermont job; confirm insurance, written contracts, and FMCSA for any out-of-state leg before you deposit.`
                                                                                            : county.stateSlug === 'delaware'
                                                                                              ? `Interstate moves require active FMCSA USDOT and usually MC authority — verify on FMCSA SAFER. Delaware does not issue a special statewide household-goods mover certificate for pure intrastate operators according to commonly cited consumer guidance (unlike Pennsylvania PUC household goods authority or New Jersey public-mover frameworks). For pure in-state Delaware jobs, insist on a written estimate matching the legal business name, cargo and liability insurance certificates, and clear inventory terms — and ask whether Delaware DMV Motor Carrier Services frameworks apply. Many Delaware jobs become interstate within minutes when they touch Maryland, Pennsylvania, or New Jersey; confirm FMCSA for any out-of-state leg before you deposit.`
                                                                                              : county.stateSlug === 'alaska'
                                                                                                ? `Interstate and Outside moves require active FMCSA USDOT and usually MC authority — verify on FMCSA SAFER. Alaska does not maintain a dedicated statewide household-goods mover certificate program comparable to Washington UTC or Oregon ODOT. For pure in-state Alaska jobs, insist on a written estimate matching the legal business name, a State of Alaska business license, cargo and liability insurance certificates, and clear inventory terms. FMCSA does not cover every in-state Alaska job; confirm insurance, written contracts, and FMCSA for any Outside or interstate leg before you deposit.`
                                                                                                : county.stateSlug === 'hawaii'
                                                                                                  ? `Mainland and other out-of-state moves require active FMCSA USDOT and usually MC authority — verify on FMCSA SAFER. Purely local and inter-island Hawaii household goods moves by for-hire carriers generally require a Hawaii Public Utilities Commission (PUC) Motor Carrier Certificate of Public Convenience and Necessity covering the household goods classification for the islands served. Confirm active Hawaii PUC motor carrier certificate status matching the legal name on your estimate. FMCSA does not cover every in-state Hawaii job; confirm Hawaii PUC household goods CPCN vs FMCSA for your exact origin and destination before you deposit.`
                                                                                                  : county.stateSlug === 'montana'
                                                                                                    ? `Interstate moves require active FMCSA USDOT and usually MC authority — verify on FMCSA SAFER. Montana does not currently operate a consumer-facing household-goods permit regime comparable to Idaho IPUC or Nebraska PSC after recent motor-carrier policy changes — do not invent a Montana household goods certificate number. For pure in-state Montana jobs, insist on written estimates matching the legal business name, cargo and liability insurance certificates, and clear inventory terms; Montana Department of Transportation Motor Carrier Services remains relevant for commercial vehicle frameworks. FMCSA does not cover every in-state Montana job; confirm insurance, written contracts, and FMCSA for any out-of-state leg before you deposit.`
                                                                                                    : county.stateSlug === 'north-dakota'
                                                                                                      ? `Interstate moves require active FMCSA USDOT and usually MC authority — verify on FMCSA SAFER. Purely local/intrastate North Dakota household goods moves by for-hire carriers generally require a Household Goods Carrier Permit through North Dakota Department of Transportation (NDDOT) Motor Vehicle application frameworks, including statutory fees and insurance documentation. Confirm permit status matching the legal name on your estimate. FMCSA does not cover every in-state North Dakota job; confirm NDDOT household goods carrier permit vs FMCSA for your exact origin and destination before you deposit.`
                                                                                                      : county.stateSlug === 'south-dakota'
                                                                                                        ? `Interstate moves require active FMCSA USDOT and usually MC authority — verify on FMCSA SAFER. South Dakota does not maintain a dedicated statewide household-goods consumer permit board comparable to North Dakota’s NDDOT Household Goods Carrier Permit or Nebraska’s PSC Household Goods Mover License. For pure in-state South Dakota jobs, insist on a written estimate matching the legal business name, cargo and liability insurance certificates, and clear inventory terms — and ask whether South Dakota Department of Revenue Motor Carrier Services frameworks apply. FMCSA does not cover every in-state South Dakota job; confirm insurance, written contracts, and FMCSA for any out-of-state leg before you deposit.`
                                                                                                        : county.stateSlug === 'wyoming'
                                                                                                          ? `Interstate moves require active FMCSA USDOT and usually MC authority — verify on FMCSA SAFER. Purely local/intrastate Wyoming household goods moves by for-hire carriers transporting goods they do not own for compensation generally require Operating Authority from the Wyoming Department of Transportation (WYDOT) Motor Carrier Services; a Letter of Authority is commonly expected in each vehicle. Confirm authority and insurance filings matching the legal name on your estimate. FMCSA does not cover every in-state Wyoming job; confirm WYDOT Operating Authority vs FMCSA for your exact origin and destination before you deposit.`
