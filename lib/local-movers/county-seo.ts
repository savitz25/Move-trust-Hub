...
export function buildStateDescription(
  ...
  if (stateName === 'Minnesota') {
    return `Find curated local movers in 63 Minnesota county guides — 10 ranked companies in Hennepin (Minneapolis), Ramsey (Saint Paul), Dakota (Lakeville), Anoka, Washington (Stillwater), Scott (Shakopee), Wright (Buffalo), Carver (Chaska), Sherburne (Elk River), Chisago (Center City), and Isanti (Cambridge), plus regional specialists in St. Louis (Duluth), Olmsted (Rochester), Stearns (St. Cloud), Blue Earth (Mankato), Crow Wing (Brainerd), Clay (Moorhead), Winona, Goodhue (Red Wing), Beltrami (Bemidji), Itasca (Grand Rapids), Kandiyohi (Willmar), Douglas (Alexandria), Becker (Detroit Lakes), Cass (Walker), Le Sueur (Le Center), Mille Lacs (Milaca), Lyon (Marshall), Brown (New Ulm), Hubbard (Park Rapids), Nobles (Worthington), and 38 more regional and rural hubs statewide. Twin Cities metros cover corporate relocations and I-94/I-35W corridor traffic; Rochester covers Mayo Clinic medical-sector relocations; Duluth and Carlton cover Lake Superior northwoods logistics; lakes-country counties cover resort-season moves; Red River Valley and northwest counties cover cross-border North Dakota corridors; southern and western counties cover agricultural and rural hauls for ${SEO_YEAR}. Use our free moving calculator and interstate directory.`;
  }
