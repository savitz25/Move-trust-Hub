...
const NC_COUNTY_NEIGHBORS: Record<string, string[]> = {
  ...
  yadkin: ['forsyth', 'surry', 'davie', 'iredell', 'wilkes', 'stokes'],
  dare: ['currituck', 'tyrrell', 'hyde', 'pamlico', 'carteret', 'pasquotank'],
  alexander: ['iredell', 'catawba', 'caldwell', 'wilkes', 'burke', 'davie'],
  transylvania: ['henderson', 'jackson', 'haywood', 'buncombe', 'polk', 'macon'],
  currituck: ['dare', 'camden', 'pasquotank', 'tyrrell', 'gates', 'chowan'],
  scotland: ['robeson', 'richmond', 'hoke', 'moore', 'cumberland', 'anson'],
  cherokee: ['clay', 'macon', 'graham', 'swain', 'polk', 'rutherford'],
  bladen: ['cumberland', 'sampson', 'columbus', 'robeson', 'pender', 'brunswick'],
  ashe: ['alleghany', 'wilkes', 'watauga', 'avery', 'surry', 'caldwell'],
  montgomery: ['richmond', 'stanly', 'moore', 'randolph', 'anson', 'davidson'],
  caswell: ['person', 'orange', 'alamance', 'rockingham', 'halifax', 'granville'],
  chowan: ['perquimans', 'gates', 'bertie', 'washington', 'hertford', 'pasquotank'],
  swain: ['jackson', 'macon', 'graham', 'haywood', 'buncombe', 'transylvania'],
  perquimans: ['chowan', 'pasquotank', 'camden', 'gates', 'hertford', 'currituck'],
  pamlico: ['carteret', 'craven', 'hyde', 'beaufort', 'jones', 'dare'],
  clay: ['cherokee', 'macon', 'graham', 'swain', 'polk', 'rutherford'],
  alleghany: ['ashe', 'wilkes', 'surry', 'watauga', 'stokes', 'caldwell'],
  camden: ['currituck', 'pasquotank', 'gates', 'chowan', 'perquimans', 'tyrrell'],
  washington: ['beaufort', 'martin', 'bertie', 'tyrrell', 'hyde', 'chowan'],
  gates: ['chowan', 'perquimans', 'camden', 'hertford', 'northampton', 'bertie'],
  jones: ['craven', 'lenoir', 'onslow', 'pamlico', 'carteret', 'duplin'],
  graham: ['swain', 'macon', 'cherokee', 'clay', 'jackson', 'haywood'],
  hyde: ['beaufort', 'pamlico', 'dare', 'tyrrell', 'washington', 'martin'],
  tyrrell: ['washington', 'hyde', 'dare', 'bertie', 'martin', 'chowan'],
};
