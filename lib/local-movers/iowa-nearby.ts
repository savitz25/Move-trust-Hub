...
const IA_COUNTY_NEIGHBORS: Record<string, NearbyCountyLink[]> = {
  ...
  floyd: [
    { slug: 'bremer', name: 'Bremer', seat: 'Waverly', href: '/local-movers/iowa/bremer', displayLabel: 'Bremer County, IA' },
    { slug: 'chickasaw', name: 'Chickasaw', seat: 'New Hampton', href: '/local-movers/iowa/chickasaw', displayLabel: 'Chickasaw County, IA' },
    { slug: 'cerro-gordo', name: 'Cerro Gordo', seat: 'Mason City', href: '/local-movers/iowa/cerro-gordo', displayLabel: 'Cerro Gordo County, IA' },
    { slug: 'franklin', name: 'Franklin', seat: 'Hampton', href: '/local-movers/iowa/franklin', displayLabel: 'Franklin County, IA' },
    { slug: 'mitchell', name: 'Mitchell', seat: 'Osage', href: '/local-movers/iowa/mitchell', displayLabel: 'Mitchell County, IA' },
  ],
  page: [
    { slug: 'montgomery', name: 'Montgomery', seat: 'Red Oak', href: '/local-movers/iowa/montgomery', displayLabel: 'Montgomery County, IA' },
    { slug: 'taylor', name: 'Taylor', seat: 'Green City', href: '/local-movers/missouri/taylor', displayLabel: 'Taylor County, MO' },
    { slug: 'fremont', name: 'Fremont', seat: 'Hamburg', href: '/local-movers/nebraska/fremont', displayLabel: 'Fremont County, NE' },
  ],
  harrison: [
    { slug: 'crawford', name: 'Crawford', seat: 'Denison', href: '/local-movers/iowa/crawford', displayLabel: 'Crawford County, IA' },
  ...
  kossuth: [
    { slug: 'palo-alto', name: 'Palo Alto', seat: 'Emmetsburg', href: '/local-movers/iowa/palo-alto', displayLabel: 'Palo Alto County, IA' },
    { slug: 'humboldt', name: 'Humboldt', seat: 'Dakota City', href: '/local-movers/iowa/humboldt', displayLabel: 'Humboldt County, IA' },
    { slug: 'pocahontas', name: 'Pocahontas', seat: 'Pocahontas', href: '/local-movers/iowa/pocahontas', displayLabel: 'Pocahontas County, IA' },
    { slug: 'winnebago', name: 'Winnebago', seat: 'Forest City', href: '/local-movers/iowa/winnebago', displayLabel: 'Winnebago County, IA' },
    { slug: 'hancock', name: 'Hancock', seat: 'Garner', href: '/local-movers/iowa/hancock', displayLabel: 'Hancock County, IA' },
  ],
  butler: [
    { slug: 'bremer', name: 'Bremer', seat: 'Waverly', href: '/local-movers/iowa/bremer', displayLabel: 'Bremer County, IA' },
  ...
  appanoose: [
    ...
    { slug: 'monroe', name: 'Monroe', seat: 'Albia', href: '/local-movers/iowa/monroe', displayLabel: 'Monroe County, IA' },
    { slug: 'wapello', name: 'Wapello', seat: 'Ottumwa', href: '/local-movers/iowa/wapello', displayLabel: 'Wapello County, IA' },
    { slug: 'wayne', name: 'Wayne', seat: 'Corydon', href: '/local-movers/iowa/wayne', displayLabel: 'Wayne County, IA' },
  ],
  union: [
    { slug: 'adair', name: 'Adair', seat: 'Greenfield', href: '/local-movers/iowa/adair', displayLabel: 'Adair County, IA' },
    { slug: 'adams', name: 'Adams', seat: 'Corning', href: '/local-movers/iowa/adams', displayLabel: 'Adams County, IA' },
    { slug: 'cass', name: 'Cass', seat: 'Atlantic', href: '/local-movers/iowa/cass', displayLabel: 'Cass County, IA' },
    { slug: 'madison', name: 'Madison', seat: 'Winterset', href: '/local-movers/iowa/madison', displayLabel: 'Madison County, IA' },
    { slug: 'ringgold', name: 'Ringgold', seat: 'Mount Ayr', href: '/local-movers/iowa/ringgold', displayLabel: 'Ringgold County, IA' },
  ],
  chickasaw: [
    { slug: 'bremer', name: 'Bremer', seat: 'Waverly', href: '/local-movers/iowa/bremer', displayLabel: 'Bremer County, IA' },
    { slug: 'butler', name: 'Butler', seat: 'Allison', href: '/local-movers/iowa/butler', displayLabel: 'Butler County, IA' },
  ...
  hancock: [
    { slug: 'cerro-gordo', name: 'Cerro Gordo', seat: 'Mason City', href: '/local-movers/iowa/cerro-gordo', displayLabel: 'Cerro Gordo County, IA' },
    { slug: 'kossuth', name: 'Kossuth', seat: 'Algona', href: '/local-movers/iowa/kossuth', displayLabel: 'Kossuth County, IA' },
    { slug: 'wright', name: 'Wright', seat: 'Clarion', href: '/local-movers/iowa/wright', displayLabel: 'Wright County, IA' },
    { slug: 'winnebago', name: 'Winnebago', seat: 'Forest City', href: '/local-movers/iowa/winnebago', displayLabel: 'Winnebago County, IA' },
    { slug: 'worth', name: 'Worth', seat: 'Northwood', href: '/local-movers/iowa/worth', displayLabel: 'Worth County, IA' },
  ],
  ...
  montgomery: [
    { slug: 'adams', name: 'Adams', seat: 'Corning', href: '/local-movers/iowa/adams', displayLabel: 'Adams County, IA' },
    { slug: 'cass', name: 'Cass', seat: 'Atlantic', href: '/local-movers/iowa/cass', displayLabel: 'Cass County, IA' },
    { slug: 'page', name: 'Page', seat: 'Clarinda', href: '/local-movers/iowa/page', displayLabel: 'Page County, IA' },
    { slug: 'mills', name: 'Mills', seat: 'Glenwood', href: '/local-movers/iowa/mills', displayLabel: 'Mills County, IA' },
    { slug: 'fremont', name: 'Fremont', seat: 'Hamburg', href: '/local-movers/nebraska/fremont', displayLabel: 'Fremont County, NE' },
  ],
  keokuk: [
  ...
  clarke: [
    { slug: 'decatur', name: 'Decatur', seat: 'Leon', href: '/local-movers/iowa/decatur', displayLabel: 'Decatur County, IA' },
    { slug: 'lucas', name: 'Lucas', seat: 'Chariton', href: '/local-movers/iowa/lucas', displayLabel: 'Lucas County, IA' },
    { slug: 'madison', name: 'Madison', seat: 'Winterset', href: '/local-movers/iowa/madison', displayLabel: 'Madison County, IA' },
    { slug: 'ringgold', name: 'Ringgold', seat: 'Mount Ayr', href: '/local-movers/iowa/ringgold', displayLabel: 'Ringgold County, IA' },
    { slug: 'union', name: 'Union', seat: 'Creston', href: '/local-movers/iowa/union', displayLabel: 'Union County, IA' },
  ],
  calhoun: [
    { slug: 'carroll', name: 'Carroll', seat: 'Carroll', href: '/local-movers/iowa/carroll', displayLabel: 'Carroll County, IA' },
    { slug: 'greene', name: 'Greene', seat: 'Jefferson', href: '/local-movers/iowa/greene', displayLabel: 'Greene County, IA' },
