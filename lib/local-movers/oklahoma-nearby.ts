...
const OK_COUNTY_NEIGHBORS: Record<string, string[]> = {
  ...
  blaine: ['kingfisher', 'canadian', 'caddo', 'custer', 'major', 'dewey'],
  woods: ['woodward', 'alfalfa', 'major', 'ellis', 'dewey', 'grant'],
  kiowa: ['washita', 'greer', 'jackson', 'caddo', 'custer', 'beckham'],
  major: ['alfalfa', 'woodward', 'garfield', 'kingfisher', 'blaine', 'dewey'],
  tillman: ['jackson', 'cotton', 'comanche', 'greer', 'harmon', 'kiowa'],
  alfalfa: ['garfield', 'major', 'woods', 'woodward', 'grant', 'kay'],
  jefferson: ['stephens', 'love', 'carter', 'cotton', 'comanche', 'garvin'],
  coal: ['atoka', 'pontotoc', 'pittsburg', 'hughes', 'bryan', 'latimer'],
  cotton: ['tillman', 'comanche', 'stephens', 'jefferson', 'jackson', 'kiowa'],
  greer: ['beckham', 'washita', 'kiowa', 'jackson', 'harmon', 'roger-mills'],
  beaver: ['texas', 'harper', 'ellis', 'cimarron', 'beckham', 'woodward'],
  dewey: ['custer', 'woodward', 'major', 'blaine', 'ellis', 'roger-mills'],
  grant: ['kay', 'noble', 'garfield', 'alfalfa', 'woods', 'major'],
  ellis: ['woodward', 'dewey', 'roger-mills', 'beckham', 'texas', 'harper'],
  'roger-mills': ['beckham', 'greer', 'washita', 'custer', 'dewey', 'ellis'],
  harper: ['texas', 'beaver', 'ellis', 'woodward', 'cimarron', 'beckham'],
  harmon: ['jackson', 'greer', 'beckham', 'tillman', 'cotton', 'kiowa'],
  cimarron: ['texas', 'beaver', 'harper', 'ellis', 'beckham', 'roger-mills'],
};
