...
const OH_COUNTY_NEIGHBORS: Record<string, string[]> = {
  ...
  jackson: ['ross', 'pike', 'scioto', 'vinton', 'gallia', 'lawrence'],
  hardin: ['allen', 'hancock', 'logan', 'marion', 'union', 'wyandot'],
  gallia: ['meigs', 'lawrence', 'jackson', 'vinton', 'mason', 'jackson'],
  'van-wert': ['allen', 'mercer', 'paulding', 'defiance', 'putnam', 'auglaize'],
  fayette: ['highland', 'clinton', 'greene', 'madison', 'pickaway', 'ross'],
  adams: ['brown', 'highland', 'scioto', 'pike', 'mason'],
  henry: ['fulton', 'lucas', 'wood', 'hancock', 'putnam', 'defiance'],
  hocking: ['fairfield', 'perry', 'athens', 'vinton', 'ross', 'pickaway'],
  pike: ['ross', 'pickaway', 'highland', 'jackson', 'scioto', 'adams'],
  carroll: ['stark', 'tuscarawas', 'columbiana', 'harrison', 'jefferson', 'holmes'],
  meigs: ['gallia', 'athens', 'vinton', 'mason', 'jackson', 'lawrence'],
  wyandot: ['crawford', 'marion', 'hancock', 'hardin', 'seneca', 'richland'],
  paulding: ['defiance', 'van-wert', 'putnam', 'henry', 'allen', 'williams'],
  noble: ['guernsey', 'muskingum', 'monroe', 'washington', 'belmont', 'morgan'],
  harrison: ['carroll', 'jefferson', 'belmont', 'guernsey', 'tuscarawas', 'columbiana'],
  morgan: ['muskingum', 'noble', 'washington', 'perry', 'athens', 'guernsey'],
  monroe: ['noble', 'belmont', 'washington', 'tyler'],
  vinton: ['hocking', 'athens', 'jackson', 'ross', 'gallia', 'meigs'],
  ashland: ['richland', 'wayne', 'holmes', 'knox', 'lorain', 'medina'],
  auglaize: ['allen', 'mercer', 'shelby', 'logan', 'hardin', 'darke'],
  brown: ['clermont', 'highland', 'adams', 'clinton', 'hamilton', 'mason'],
  darke: ['miami', 'shelby', 'mercer', 'preble', 'montgomery', 'jay'],
  holmes: ['wayne', 'stark', 'tuscarawas', 'coshocton', 'knox', 'ashland'],
  huron: ['erie', 'crawford', 'richland', 'seneca', 'sandusky', 'lorain'],
  jefferson: ['harrison', 'carroll', 'columbiana', 'belmont', 'brooke'],
  lawrence: ['gallia', 'jackson', 'scioto', 'cabell'],
  logan: ['hardin', 'union', 'champaign', 'shelby', 'auglaize', 'marion'],
  madison: ['franklin', 'pickaway', 'fayette', 'champaign', 'union', 'clark'],
  sandusky: ['huron', 'erie', 'ottawa', 'wood', 'seneca', 'lucas'],
  seneca: ['sandusky', 'huron', 'crawford', 'wyandot', 'hancock', 'wood'],
  shelby: ['darke', 'miami', 'champaign', 'logan', 'auglaize', 'mercer'],
  athens: ['hocking', 'vinton', 'meigs', 'washington', 'morgan', 'perry'],
  washington: ['noble', 'morgan', 'monroe', 'pleasants', 'wood', 'athens'],
};
