...
const TX_COUNTY_NEIGHBORS: Record<string, string[]> = {
  archer: ['baylor', 'clay', 'jack', 'montague', 'young', 'wichita'],
  ...
  brewster: ['presidio', 'jeff-davis', 'pecos', 'terrell', 'culberson', 'el-paso'],
  ...
  clay: ['montague', 'wichita', 'archer', 'jack', 'wise', 'cooke'],
  cottle: ['childress', 'hardeman', 'foard', 'king', 'motley', 'dickens'],
  culberson: ['hudspeth', 'jeff-davis', 'reeves', 'el-paso', 'presidio'],
  dawson: ['borden', 'martin', 'gaines', 'lynn', 'terry', 'lubbock'],
  delta: ['hopkins', 'lamar', 'fannin', 'hunt', 'franklin', 'red-river'],
  dimmit: ['zavala', 'la-salle', 'webb', 'maverick', 'frio', 'mcmullen'],
  duval: ['jim-hogg', 'webb', 'mcmullen', 'la-salle', 'brooks', 'kleberg'],
  ...
  franklin: ['titus', 'camp', 'morris', 'hopkins', 'delta', 'red-river'],
  ...
  newton: ['jasper', 'sabine', 'orange', 'tyler', 'hardin', 'polk'],
  marion: ['cass', 'harrison', 'upshur', 'morris', 'camp', 'bowie'],
  mason: ['menard', 'kimble', 'llano', 'gillespie', 'mcculloch', 'san-saba'],
  mitchell: ['borden', 'howard', 'scurry', 'fisher', 'nolan', 'coke'],
  morris: ['camp', 'titus', 'cass', 'bowie', 'marion', 'upshur'],
  menard: ['kimble', 'mason', 'mcculloch', 'concho', 'schleicher', 'sutton'],
  ochiltree: ['lipscomb', 'hansford', 'roberts', 'hemphill', 'hutchinson', 'moore'],
  oldham: ['hartley', 'deaf-smith', 'potter', 'randall', 'moore', 'hutchinson'],
  parmer: ['bailey', 'castro', 'deaf-smith', 'lamb', 'hockley', 'cochran'],
  ...
  runnels: ['concho', 'coke', 'coleman', 'brown', 'tom-green', 'nolan'],
  sabine: ['newton', 'san-augustine', 'jasper', 'shelby', 'tyler', 'angelina'],
