...
export const taosNmContent: CityHubContent = {
  marketSlug: 'taos-nm',
  h1: 'Moving to Taos, NM: Compare Trusted Movers & Estimate Your Move',
  seo: {
    title:
      'Moving to Taos, NM (2026) — Costs, Best Movers & Trusted Movers | Move Trust Hub',
    description:
      'Planning a move to Taos in Taos County? Compare FMCSA-verified movers, estimate costs with our free calculator, and research carriers in our independent directory. Artistic mountain town, historic adobe architecture, Taos Ski Valley, hiking and cultural heritage. Independent directory. Transparent. No affiliation with listed companies.',
    keywords: [
      'moving to taos nm',
      'taos nm movers',
      'cost to move to taos new mexico',
      'best moving companies taos nm',
      'relocating to taos county nm',
      'taos nm interstate moving cost 2026',
      'taos ski valley relocation movers',
      'moving from colorado to taos nm',
      'historic adobe taos moving',
      'taos county new mexico movers',
    ],
    canonicalPath: '/moving-to/new-mexico/taos-nm',
    ogImagePath: '/images/destinations/taos-nm-cost-infographic.svg',
    ogImageAlt:
  ...
  insightCards: [
    ...
    },
    {
      ...
      body: 'Moves within Taos County or the immediate Taos–Arroyo Seco footprint are typically local hourly jobs. Cross-state shipments require FMCSA-licensed interstate carriers. Some Taos-area companies broker interstate loads — always verify who physically transports your goods before paying a deposit.',
    },
  ],
  bodySections: [
    {
      heading: 'Why artists and outdoor enthusiasts are moving to Taos in 2026',
      paragraphs: [
    ...
    {
      heading: 'How to choose an interstate mover for a Taos delivery',
      paragraphs: [
    ...
    {
      heading: 'County-level mover coverage across the Taos corridor',
      paragraphs: [
  ...
  resourceLinks: [
    {
      ...
      description: 'Compare Taos with Santa Fe, Los Alamos, Ruidoso, Rio Rancho, and statewide corridors.',
    ...
    },
    {
      ...
      description: 'Compare CO origin markets and Front Range spillover into Taos County.',
      href: '/moving-to/colorado',
    },
    {
      title: 'Texas moving destinations hub',
      description: 'Compare TX origin markets and Southwest spillover into Northern New Mexico.',
      href: '/moving-to/texas',
    },
    {
      title: 'Browse Taos County local movers',
      description: 'Taos and Taos Ski Valley artistic mountain-town mover directory.',
  ...
  testimonials: [
    {
      ...
      name: 'Nina & Greg W.',
      detail: 'Colorado spillover move to Taos · February 2026',
    },
    {
      quote:
      ...
      name: 'Danielle S.',
      detail: 'Relocated from Los Angeles CA to Taos (87571) · August 2026',
    },
  ],
  faqItems: [
    {
      question: 'How accurate is the moving calculator for Taos relocations?',
      answer:
    ...
    {
      question: 'What is the best time of year to move to Taos?',
      answer:
    ...
    {
      question: 'How much does it cost to move a 3-bedroom home to Taos?',
      answer:
        'From Texas, Arizona, Colorado, and California origins, a 3-bedroom household (roughly 5,000–7,000 cubic feet) typically ranges from $6,500 to $10,100 for full-service interstate transport in 2026. Final price depends on exact volume, packing services, historic-district or mountain accessorials, and season. Use our calculator for your specific inventory, then compare trusted movers in our directory.',
    },
    {
      question: 'How does Taos compare to Santa Fe for moving costs?',
      answer:
    ...
    {
      question: 'What access rules affect Taos-area moves?',
      answer:
  ...
  bestMoversPath: '/local-movers/new-mexico/taos',
};