...
export const wyomingClusterContent: WyomingClusterContent = {
  ...
  seo: {
    title:
      'Moving to Wyoming (2026) — Destination Guides, Costs & Free Quotes | Move Trust Hub',
    description:
  ...
  bodySections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'Use our free calculator with your destination ZIP — Cheyenne (82001), Casper (82601), Laramie (82070), Sheridan (82801), Cody (82414), Gillette (82716), Jackson (83001), Lander (82520), Alpine (83128), or Buffalo (82834) — then request 2–3 matched quotes on identical inventory before signing.',
      ],
    },
    {
