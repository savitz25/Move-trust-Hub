...
export const exampleMarketContent: CityHubContent = {
  ...
  seo: {
    title:
      'Moving to {City}, {ST} ({Year}) — Costs, Best Movers & Trusted Movers | Move Trust Hub',
    description:
      'Planning a move to {City}? Compare FMCSA-verified movers, estimate costs with our free calculator, and research carriers in our independent directory. No lead fees. No paid placements.',
    keywords: [
      'moving to {city} {st}',
      '{city} movers',
