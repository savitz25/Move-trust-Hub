...
export const teaSdContent: CityHubContent = {
  ...
  seo: {
    ...
    description:
      'Planning a move to Tea in Lincoln County? Compare FMCSA-verified movers, estimate costs with our free calculator, and get matched with 2–3 licensed quotes within 24 hours. Neighborly commuter safe-haven, Legacy Parkway corridor, between Sioux Falls and Harrisburg. Independent directory. Transparent. No affiliation with listed companies.',
    keywords: [
      'moving to tea sd',
