...
export const teaSdContent: CityHubContent = {
  marketSlug: 'tea-sd',
  h1: 'Moving to Tea, SD: Compare Trusted Movers & Estimate Your Move',
  seo: {
    title:
      'Moving to Tea, SD (2026) — Costs, Best Movers & Trusted Movers | Move Trust Hub',
    description:
      'Planning a move to Tea in Lincoln County? Compare FMCSA-verified movers, estimate costs with our free calculator, and research carriers in our independent directory. Neighborly commuter safe-haven, Legacy Parkway corridor, between Sioux Falls and Harrisburg. Independent directory. Transparent. No affiliation with listed companies.',
    keywords: [
      'moving to tea sd',
      'tea south dakota movers',
      'cost to move to tea south dakota',
      'best moving companies tea sd',
      'relocating to lincoln county sd',
      'tea sd interstate moving cost 2026',
      'legacy parkway tea sd relocation',
      'moving from minnesota to tea sd',
      'moving from iowa to tea sd',
      'sioux falls harrisburg corridor tea movers',
    ],
    canonicalPath: '/moving-to/south-dakota/tea-sd',
    ogImagePath: '/images/destinations/tea-sd-cost-infographic.svg',
    ogImageAlt:
      '2026 interstate moving costs to Tea SD by home size – Move Trust Hub',
  },
  heroSubheadline:
  ...
  insightCards: [
    ...
    },
    {
      ...
      body: 'Moves within Lincoln County or the immediate Tea-Sioux Falls-Harrisburg corridor are typically local hourly jobs. Cross-state shipments require FMCSA-licensed interstate carriers. Some Tea-area companies broker interstate loads — always verify who physically transports your goods before paying a deposit.',
    },
  ],
  bodySections: [
    {
      heading: 'Why commuters, young families, and Sioux Falls-Harrisburg corridor seekers are moving to Tea in 2026',
      paragraphs: [
    ...
    {
      heading: 'How to choose an interstate mover for a Tea delivery',
      paragraphs: [
    ...
    {
      heading: 'County-level mover coverage across the Tea corridor',
      paragraphs: [
  ...
  resourceLinks: [
    {
      ...
      description: 'Compare Tea with Sioux Falls, Harrisburg, Brandon, and statewide corridors.',
    ...
    },
    {
      ...
      description: 'Premium school enclave, Brandon Valley Schools, and Minnehaha County comparison.',
    ...
    },
    {
      ...
      description: 'Tea and Harrisburg suburban growth corridor mover directory.',
  ...
  testimonials: [
    {
      quote:
        'Our Des Moines corporate transfer landed us on the Legacy Parkway corridor. Comparing four carriers on identical cubic footage saved us money — and the HOA gate-coordination fee was a line item on the estimate, not a surprise on delivery day.',
      name: 'David & Rachel M.',
      detail: 'Iowa spillover relocation to Legacy Parkway corridor · June 2026',
    },
    {
      quote:
      ...
      name: 'Angela T.',
      detail: 'Relocated from Minnesota to Tea builder inventory (57064) · April 2026',
    },
    {
      quote:
      ...
      name: 'James & Priya S.',
      detail: 'Texas remote-work transfer to established Tea neighborhood · May 2026',
    },
  ],
  faqItems: [
    {
      question: 'How accurate is the moving calculator for Tea relocations?',
      answer:
    ...
    {
      question: 'What is the best time of year to move to Tea?',
      answer:
    ...
    {
      question: 'How much does it cost to move a 3-bedroom home to Tea?',
      answer:
        'From Minnesota, Iowa, Nebraska, Wyoming, Colorado, Texas, California, New York, and Florida origins, a 3-bedroom household (roughly 5,000–7,000 cubic feet) typically ranges from $6,200 to $10,200 for full-service interstate transport in 2026. Final price depends on exact volume, packing services, Legacy Parkway or cul-de-sac accessorials, and season. Use our calculator for your specific inventory, then compare trusted movers in our directory.',
    },
    {
      question: 'How does Tea compare to Harrisburg for moving costs?',
      answer:
    ...
    {
      question: 'What access rules affect Tea-area moves?',
      answer:
