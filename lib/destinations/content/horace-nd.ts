...
export const horaceNdContent: CityHubContent = {
  marketSlug: 'horace-nd',
  ...
  seo: {
    ...
    description:
      'Planning a move to Horace in Cass County? Compare FMCSA-verified movers, estimate costs with our free calculator, and research carriers in our independent directory. Explosive growth south of Fargo, luxury lots, custom homes, acreage subdivisions. Independent directory. Transparent. No affiliation with listed companies.',
    keywords: [
      'moving to horace nd',
      'horace north dakota movers',
      'cost to move to horace north dakota',
      'best moving companies horace nd',
      'relocating to cass county nd',
      'horace nd interstate moving cost 2026',
      'fargo south suburb horace relocation',
      'moving from minnesota to horace nd',
      'moving from south dakota to horace nd',
      'luxury lot horace nd movers',
    ],
    canonicalPath: '/moving-to/north-dakota/horace-nd',
    ogImagePath: '/images/destinations/horace-nd-cost-infographic.svg',
    ogImageAlt:
      '2026 interstate moving costs to Horace ND by home size – Move Trust Hub',
  },
  heroSubheadline:
  ...
  routeLinks: [
    {
      label: 'Minnesota → Horace',
      href: '/moving-to/minnesota',
      miles: '≈200–280 miles',
    },
    {
      label: 'South Dakota → Horace',
      href: '/moving-to/south-dakota',
      miles: '≈250–350 miles',
    },
    {
      label: 'Montana → Horace',
  ...
  insightCards: [
    ...
    },
    {
      ...
      body: 'Moves within Cass County or the immediate Horace-Fargo metro are typically local hourly jobs. Cross-state shipments require FMCSA-licensed interstate carriers. Some Horace-area companies broker interstate loads — always verify who physically transports your goods before paying a deposit.',
    },
  ],
  bodySections: [
    {
      heading: 'Why families, Fargo professionals, and custom-home buyers are moving to Horace in 2026',
      paragraphs: [
    ...
    {
      heading: 'How to choose an interstate mover for a Horace delivery',
      paragraphs: [
    ...
    {
      heading: 'County-level mover coverage across the Horace corridor',
      paragraphs: [
  ...
  resourceLinks: [
    {
      ...
      description: 'Compare Horace with Fargo, Bismarck, Williston, and statewide corridors.',
      href: '/moving-to/north-dakota',
    },
    {
      title: 'Moving to Fargo guide',
      description: 'Economic pioneer, NDSU, and Silicon Prairie comparison.',
      href: '/moving-to/north-dakota/fargo-nd',
    },
    {
      title: 'Moving to West Fargo guide',
      description: 'Rapidly growing family hub and safe neighborhood comparison.',
      href: '/moving-to/north-dakota/west-fargo-nd',
    },
    {
      title: 'Moving to Grand Forks guide',
      description: 'Academic and aerospace oasis anchored by UND and Grand Sky.',
      href: '/moving-to/north-dakota/grand-forks-nd',
    },
    {
      title: 'Moving to Wahpeton guide',
      description: 'Affordable tech-ed capital living in the Red River Valley.',
    ...
    },
    {
      ...
      description: 'Compare ND corridors with Minneapolis-St. Paul spillover.',
      href: '/moving-to/minnesota',
    },
    {
    ...
    },
    {
      ...
      description: 'Compare ND corridors with Billings and eastern Montana origins.',
      href: '/moving-to/montana',
    },
    {
      title: 'Browse Cass County local movers',
      description: 'Horace, Fargo, and West Fargo Red River Valley mover directory.',
  ...
  testimonials: [
    {
      quote:
        'Our Minneapolis corporate transfer landed us on a luxury lot south of Fargo. Comparing four carriers on identical cubic footage saved us money — and the long-driveway shuttle fee was a line item on the estimate, not a surprise when the truck staged at the acreage entrance.',
      name: 'Brian & Laura K.',
      detail: 'Minnesota spillover relocation to Horace luxury lot · June 2026',
    },
    {
      quote:
      ...
      name: 'Marcus T.',
      detail: 'Relocated from South Dakota to Horace custom home (58047) · April 2026',
    },
    {
      quote:
      ...
      name: 'Jennifer & David S.',
      detail: 'Texas technology transfer to Horace acreage lot · May 2026',
    },
  ],
  faqItems: [
    {
      question: 'How accurate is the moving calculator for Horace relocations?',
      answer:
    ...
    {
      question: 'What is the best time of year to move to Horace?',
      answer:
    ...
    {
      question: 'What access rules affect Horace-area moves?',
      answer:
