...
export const batonRougeLaContent: CityHubContent = {
  ...
  seo: {
    ...
    description:
      'Planning a move to Baton Rouge in East Baton Rouge Parish? Compare FMCSA-verified movers, estimate costs with our free calculator, and get matched with 2–3 licensed quotes within 24 hours. State capital, LSU employment, Mississippi River port and industrial jobs. Independent directory. Transparent. No affiliation with listed companies.',
    keywords: [
