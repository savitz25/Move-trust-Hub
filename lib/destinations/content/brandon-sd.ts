...
export const brandonSdContent: CityHubContent = {
  ...
  seo: {
    ...
    description:
      'Planning a move to Brandon in Minnehaha County? Compare FMCSA-verified movers, estimate costs with our free calculator, and get matched with 2–3 licensed quotes within 24 hours. Premium school enclave, Brandon Valley Schools, cul-de-sac family inventory, Sioux Falls metro growth suburb. Independent directory. Transparent. No affiliation with listed companies.',
    keywords: [
