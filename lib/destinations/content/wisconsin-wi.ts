...
export const wisconsinClusterContent: WisconsinClusterContent = {
  ...
  seo: {
    title:
      'Moving to Wisconsin (2026) — Destination Guides, Costs & Free Quotes | Move Trust Hub',
    description:
  ...
  bodySections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'Use our free calculator with your destination ZIP — Madison (53703), Verona (53593), Brookfield (53045), Appleton (54911), Eau Claire (54701), Oconomowoc (53066), Sun Prairie (53590), Green Bay (54301), La Crosse (54601), or Whitefish Bay (53217) — then request 2–3 matched quotes on identical inventory before signing.',
      ],
    },
    {
