...
export const kansasClusterContent: KansasClusterContent = {
  ...
  seo: {
    title:
      'Moving to Kansas (2026) â€” Destination Guides, Costs & Free Quotes | Move Trust Hub',
    description:
  ...
  introParagraphs: [
    ...
    'Move Trust Hub is an independent informational directory â€” we are not affiliated with, endorsed by, or a partner of the moving companies listed. Kansas moves involve Midwest logistics that statewide guides overlook: Johnson County HOA move-day protocols, KU and K-State August turnover clusters, Wichita Old Town loft elevator reservations, Topeka capital-session traffic, and Butler County new-build cul-de-sac shuttle staging â€” factors our city guides surface so you can plan with confidence.',
    'Ten live Kansas hubs span Johnson County suburbs (Overland Park, Olathe, Lenexa, Leawood, Shawnee), university corridors (Lawrence, Manhattan), aviation and Wichita metro growth (Wichita, Andover), and state capital stability (Topeka). Browse each city guide below for 2026â€“2027 cost tables, calculator prefill by ZIP, and county-level mover directories.',
  ],
  johnsonCountyCorridor: [
    {
      ...
      zip: '66213',
      tagline: 'Johnson County powerhouse Â· Blue Valley schools Â· corporate HQ',
    },
    {
      slug: 'olathe-ks',
      displayName: 'Olathe',
      zip: '66062',
      tagline: 'Family choice Â· master-planned communities Â· Lake Olathe lifestyle',
    },
    {
      slug: 'lenexa-ks',
      displayName: 'Lenexa',
      zip: '66219',
      tagline: 'Modern suburban pioneer Â· Lenexa City Center Â· trail connectivity',
    },
    {
      slug: 'leawood-ks',
      displayName: 'Leawood',
      zip: '66206',
      tagline: 'Premium enclave Â· high-end estates Â· Town Center Plaza',
    },
    {
      slug: 'shawnee-ks',
      displayName: 'Shawnee',
      zip: '66216',
      tagline: 'Accessible west-side suburb Â· historic charm Â· family value',
    },
  ],
  universityCorridor: [
    {
      ...
      zip: '66044',
      tagline: 'Progressive cultural capital Â· KU Â· Mass Street vibrancy',
    },
    {
      slug: 'manhattan-ks',
      displayName: 'Manhattan',
      zip: '66502',
      tagline: 'Active Little Apple Â· KSU Â· Flint Hills horizon',
    },
  ],
  aviationWichitaCorridor: [
    {
      ...
      displayName: 'Wichita',
      zip: '67202',
      tagline: 'Aerospace hub Â· Old Town Â· Air Capital of the World',
    },
    {
      slug: 'andover-ks',
      displayName: 'Andover',
      zip: '67002',
      tagline: 'Fast-growing Wichita alternative Â· elite Butler County schools',
    },
  ],
  capitalCorridor: [
    {
      ...
      displayName: 'Topeka',
      zip: '66603',
      tagline: 'Stable state capital Â· government jobs Â· revitalized downtown',
    },
  ],
  bodySections: [
    {
      ...
      paragraphs: [
        ...
        'Johnson County anchors the highest inbound volume â€” Overland Park corporate headquarters corridors, Leawood estate inventory, Olathe master-planned family growth, Lenexa City Center walkability, and Shawnee\'s accessible west-side value each carry distinct move logistics. Douglas and Riley counties draw academic households around KU and K-State. Sedgwick and Butler counties serve aerospace professionals and families choosing Andover schools over Wichita density. Shawnee County provides capital-government stability in Topeka.',
        'Our ten Kansas city hubs include 2026â€“2027 cost tables, calculator prefill by ZIP, county mover directories, and cross-links to Missouri, Illinois, Oklahoma, and Nebraska for households comparing Great Plains and Kansas City metro relocation corridors.',
      ],
    },
    {
      heading: 'Why Johnson County drives Kansas\'s highest inbound volume',
      paragraphs: [
        'Overland Park, Olathe, Lenexa, Leawood, and Shawnee form Kansas\'s premier suburban pentagon â€” Blue Valley and Olathe USD 233 school prestige, Corporate Woods employment density, and Kansas City metro spillover from Missouri without Missouri income tax on the Kansas side of the line. Summer builder closing clusters (Mayâ€“August) and Kansas City corporate transfer season tighten Johnson County delivery windows along I-435 and K-10 corridors.',
        'Leawood estates, Lenexa City Center towers, and Olathe new-build HOA move-day rules each create different final-mile requirements â€” a Town Center Plaza high-rise COI delivery, a Cedar Creek cul-de-sac shuttle truck, and a Shawnee historic-lane long carry should never share the same accessorial assumptions. Book 6â€“10 weeks ahead for peak metro closings.',
      ],
    },
    {
