...
export const stCharlesMoContent: CityHubContent = {
  marketSlug: 'st-charles-mo',
  ...
  seo: {
    ...
    description:
      'Planning a move to St. Charles on the Missouri River? Compare FMCSA-verified movers, estimate costs with our free calculator, and research carriers in our independent directory. Historic Main Street, Katy Trail access, French colonial heritage, First Missouri State Capitol. Independent directory. Transparent. No affiliation with listed companies.',
    keywords: [
      'moving to st charles mo',
      'st charles mo movers',
      'cost to move to st charles missouri',
      'best moving companies st charles mo',
      'relocating to st charles county mo',
      'st charles mo interstate moving cost 2026',
      'katy trail st charles relocation',
      'historic main street st charles movers',
      'moving from illinois to st charles mo',
      'moving from kansas to st charles mo',
    ],
    canonicalPath: '/moving-to/missouri/st-charles-mo',
    ogImagePath: '/images/destinations/st-charles-mo-cost-infographic.svg',
    ogImageAlt:
      '2026 interstate moving costs to St. Charles MO by home size – Move Trust Hub',
  },
  heroSubheadline:
  ...
  routeLinks: [
    {
      label: 'Illinois → St. Charles',
      href: '/moving-to/illinois',
      miles: '≈25–35 miles',
    },
    {
      label: 'Kansas → St. Charles',
      href: '/moving-to/kansas',
      miles: '≈240–270 miles',
    },
    {
      label: 'Texas → St. Charles',
  ...
  insightCards: [
    ...
    },
    {
      ...
      body: 'Moves within St. Charles County or the immediate St. Louis metro are typically local hourly jobs. Cross-state shipments require FMCSA-licensed interstate carriers. Some St. Charles-area companies broker interstate loads — always verify who physically transports your goods before paying a deposit.',
    },
  ],
  bodySections: [
    {
      heading: 'Why families, river-city enthusiasts, and St. Louis metro professionals are moving to St. Charles in 2026',
      paragraphs: [
    ...
    {
      heading: 'How to choose an interstate mover for a St. Charles delivery',
      paragraphs: [
    ...
    {
      heading: 'County-level mover coverage across the St. Charles corridor',
      paragraphs: [
  ...
  resourceLinks: [
    {
      ...
      description: 'Compare St. Charles with KC, STL, Ozark, and central Missouri siblings statewide.',
    ...
    },
    {
      ...
      description: 'St. Charles, O\'Fallon, and river-city mover directory.',
  ...
  testimonials: [
    {
      quote:
        'Our Illinois corporate transfer landed us near Historic Main Street. Comparing four carriers on identical cubic footage saved us money — and the Main Street stairwell long carry was a line item on the estimate, not a surprise when the crew arrived with the dolly.',
      name: 'Robert & Linda K.',
      detail: 'Illinois Metro East relocation to Historic Main Street · June 2026',
    },
    {
      quote:
      ...
      name: 'Marcus W.',
      detail: 'Relocated from Kansas to Katy Trail corridor (63301) · April 2026',
    },
    {
      quote:
      ...
      name: 'Jennifer & Tom H.',
      detail: 'Texas corporate transfer to New Town at St. Charles · August 2026',
    },
  ],
  faqItems: [
    {
      question: 'How accurate is the moving calculator for St. Charles relocations?',
      answer:
    ...
    {
      question: 'What is the best time of year to move to St. Charles?',
      answer:
    ...
    {
      question: 'What access rules affect St. Charles-area moves?',
      answer:
