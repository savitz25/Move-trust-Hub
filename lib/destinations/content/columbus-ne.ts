...
export const columbusNeContent: CityHubContent = {
  marketSlug: 'columbus-ne',
  h1: 'Moving to Columbus, NE: Compare Trusted Movers & Estimate Your Move',
  seo: {
    title:
      'Moving to Columbus, NE (2026) — Costs, Best Movers & Trusted Movers | Move Trust Hub',
    description:
      'Planning a move to Columbus in Platte County? Compare FMCSA-verified movers, estimate costs with our free calculator, and research carriers in our independent directory. Industrial workhorse, agribusiness corridor, Behlen Manufacturing, Pawnee Park. Independent directory. Transparent. No affiliation with listed companies.',
    keywords: [
      'moving to columbus ne',
      'columbus nebraska movers',
      'cost to move to columbus nebraska',
      'best moving companies columbus ne',
      'relocating to platte county ne',
      'columbus ne interstate moving cost 2026',
      'behlen manufacturing columbus relocation',
      'moving from iowa to columbus ne',
      'moving from kansas to columbus ne',
      'platte county nebraska movers',
    ],
    canonicalPath: '/moving-to/nebraska/columbus-ne',
    ogImagePath: '/images/destinations/columbus-ne-cost-infographic.svg',
    ogImageAlt:
      '2026 interstate moving costs to Columbus NE by home size – Move Trust Hub',
  },
  heroSubheadline:
  ...
  routeLinks: [
    ...
    {
      label: 'Kansas → Columbus',
      href: '/moving-to/kansas',
      miles: '≈200–350 miles',
    },
    {
      label: 'South Dakota → Columbus',
      href: '/moving-to/south-dakota',
      miles: '≈200–320 miles',
    },
    {
      label: 'Colorado → Columbus',
  ...
  insightCards: [
    ...
    },
    {
      ...
      body: 'Moves within Platte County or the immediate Columbus metro are typically local hourly jobs. Cross-state shipments require FMCSA-licensed interstate carriers. Some Columbus-area companies broker interstate loads — always verify who physically transports your goods before paying a deposit.',
    },
  ],
  bodySections: [
    {
      heading: 'Why manufacturing professionals, agribusiness households, and Platte County families are moving to Columbus in 2026',
      paragraphs: [
  ...
  resourceLinks: [
    {
      ...
      description: 'Compare Columbus with Omaha, Lincoln, Kearney, Hastings, and statewide corridors.',
    ...
    },
    {
      ...
      description: 'Columbus industrial agribusiness corridor mover directory.',
  ...
  testimonials: [
    {
      quote:
        'Our Des Moines agribusiness transfer landed us in Pawnee Park. Comparing four carriers on identical cubic footage saved us money — and the cul-de-sac shuttle fee was a line item on the estimate, not a surprise when the truck staged on a narrow Platte County block.',
      name: 'David & Rachel M.',
      detail: 'Iowa spillover relocation to Pawnee Park · June 2026',
    },
    {
      quote:
      ...
      name: 'Angela T.',
      detail: 'Relocated from Kansas to Behlen corridor (68601) · April 2026',
    },
    {
      quote:
      ...
      name: 'James & Priya S.',
      detail: 'Colorado remote-work move to downtown Columbus · August 2026',
    },
  ],
  faqItems: [
    {
    ...
    },
    {
      ...
      answer:
        'From Iowa, Kansas, South Dakota, Colorado, Texas, California, New York, and Florida origins, a 3-bedroom household (roughly 5,000–7,000 cubic feet) typically ranges from $5,500 to $9,200 for full-service interstate transport in 2026. Final price depends on exact volume, packing services, Behlen corridor or Pawnee Park accessorials, and season. Use our calculator for your specific inventory, then compare trusted movers in our directory.',
    },
    {
      question: 'How does Columbus compare to Kearney for moving costs?',
      answer:
  ...
  bestMoversPath: '/local-movers/nebraska/platte',
};