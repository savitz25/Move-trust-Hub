...
export const louisianaClusterContent: LouisianaClusterContent = {
  ...
  seo: {
    title:
      'Moving to Louisiana (2026) — Destination Guides, Costs & Trusted Movers | Move Trust Hub',
    description:
