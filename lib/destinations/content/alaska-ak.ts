...
export const alaskaClusterContent: AlaskaClusterContent = {
  ...
  seo: {
    title:
      'Moving to Alaska (2026) — Destination Guides, Costs & Trusted Movers | Move Trust Hub',
    description:
