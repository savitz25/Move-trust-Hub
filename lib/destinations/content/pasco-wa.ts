...
export const pascoWaContent: CityHubContent = {
  ...
  seo: {
    title:
      'Moving to Pasco (Tri-Cities), WA (2026) — Costs, Best Movers & Free Quotes | Move Trust Hub',
    description:
  ...
  faqItems: [
    ...
    },
    {
      ...
      answer:
        'From California, Oregon, Idaho, Texas, New York, and Florida origins, a 3-bedroom household (roughly 5,000–7,000 cubic feet) typically ranges from $6,800 to $12,400 for full-service interstate transport in 2026. Final price depends on exact volume, packing services, Chiawana or Road 68 accessorials, and season. Use our calculator for your specific inventory, then request matched quotes.',
    },
    {
