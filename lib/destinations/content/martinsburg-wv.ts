...
export const martinsburgWvContent: CityHubContent = {
  ...
  seo: {
    ...
    description:
      'Planning a move to Martinsburg in Berkeley County? Compare FMCSA-verified movers, estimate costs with our free calculator, and research carriers in our independent directory. Fastest-growing Eastern Panhandle, DC commuter, affordable housing. Independent directory. Transparent. No affiliation with listed companies.',
    keywords: [
