...
export const silverSpringMdContent: CityHubContent = {
  ...
  seo: {
    ...
    description:
      'Planning a move to Silver Spring in Montgomery County? Compare FMCSA-verified movers, estimate costs with our free calculator, and get matched with 2–3 licensed quotes within 24 hours. Vibrant transit core, AFI Silver Theatre culture, diverse dining and arts scene. Independent directory. Transparent. No affiliation with listed companies.',
    keywords: [
