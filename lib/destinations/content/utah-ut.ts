...
export const utahClusterContent: UtahClusterContent = {
  ...
  seo: {
    title:
      'Moving to Utah (2026) — Destination Guides, Costs & Trusted Movers | Move Trust Hub',
    description:
  ...
  bodySections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'Use our free calculator with your destination ZIP — Salt Lake City (84101), Lehi (84043), Saratoga Springs (84045), St. George (84770), Provo (84601), Park City (84060), Ogden (84401), Draper (84020), Farmington (84025), or American Fork (84003) — then compare trusted movers in our directory on identical inventory before signing.',
      ],
    },
    {
