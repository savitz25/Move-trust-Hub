...
export const bismarckNdContent: CityHubContent = {
  ...
  seo: {
    title:
      'Moving to Bismarck, ND (2026) — Costs, Best Movers & Free Quotes | Move Trust Hub',
    description:
  ...
  faqItems: [
    ...
    },
    {
      ...
      answer:
        'From Minnesota, South Dakota, Montana, California, Texas, New York, and Florida origins, a 3-bedroom household (roughly 5,000–7,000 cubic feet) typically ranges from $5,800 to $10,000 for full-service interstate transport in 2026. Final price depends on exact volume, packing services, North Hills or Lincoln Road accessorials, and season. Use our calculator for your specific inventory, then request matched quotes.',
    },
    {
