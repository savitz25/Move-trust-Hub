...
export const northDakotaClusterContent: NorthDakotaClusterContent = {
  ...
  seo: {
    title:
      'Moving to North Dakota (2026) — Destination Guides, Costs & Trusted Movers | Move Trust Hub',
    description:
  ...
  bodySections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'Use our free calculator with your destination ZIP — Fargo (58102), Bismarck (58501), West Fargo (58078), Grand Forks (58201), Horace (58047), Williston (58801), Mandan (58554), Dickinson (58601), Wahpeton (58075), or Minot (58701) — then compare trusted movers in our directory on identical inventory before signing.',
      ],
    },
    {
