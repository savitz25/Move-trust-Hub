...
export const corralesNmContent: CityHubContent = {
  ...
  seo: {
    ...
    description:
      'Planning a move to Corrales in Bernalillo County? Compare FMCSA-verified movers, estimate costs with our free calculator, and get matched with 2–3 licensed quotes within 24 hours. Historic rural-urban balance, Rio Grande Bosque, equestrian lifestyle minutes from Albuquerque. Independent directory. Transparent. No affiliation with listed companies.',
    keywords: [
