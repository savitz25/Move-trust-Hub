...
export const corralesNmContent: CityHubContent = {
  marketSlug: 'corrales-nm',
  h1: 'Moving to Corrales, NM: Compare Trusted Movers & Estimate Your Move',
  seo: {
    title:
      'Moving to Corrales, NM (2026) — Costs, Best Movers & Trusted Movers | Move Trust Hub',
    description:
      'Planning a move to Corrales in Bernalillo County? Compare FMCSA-verified movers, estimate costs with our free calculator, and research carriers in our independent directory. Historic rural-urban balance, Rio Grande Bosque, equestrian lifestyle minutes from Albuquerque. Independent directory. Transparent. No affiliation with listed companies.',
    keywords: [
      'moving to corrales nm',
      'corrales nm movers',
      'cost to move to corrales new mexico',
      'best moving companies corrales nm',
      'relocating to bernalillo county nm',
      'corrales nm interstate moving cost 2026',
      'rio grande bosque relocation',
      'moving from texas to corrales nm',
      'equestrian property movers corrales',
      'bernalillo county new mexico movers',
    ],
    canonicalPath: '/moving-to/new-mexico/corrales-nm',
    ogImagePath: '/images/destinations/corrales-nm-cost-infographic.svg',
    ogImageAlt:
  ...
  routeLinks: [
    {
      label: 'Texas → Corrales',
      href: '/moving-to/texas',
      miles: '≈650–750 miles',
    },
    {
      label: 'Arizona → Corrales',
      href: '/moving-to/arizona',
      miles: '≈420–480 miles',
    },
    {
      label: 'Colorado → Corrales',
  ...
  bodySections: [
    {
      heading: 'Why equestrian families and professionals are moving to Corrales in 2026',
      paragraphs: [
    ...
    {
      heading: 'How to choose an interstate mover for a Corrales delivery',
      paragraphs: [
    ...
    {
      heading: 'County-level mover coverage across the Corrales corridor',
      paragraphs: [
  ...
  resourceLinks: [
    {
      ...
      description: 'Compare Corrales with Albuquerque, Rio Rancho, Santa Fe, Los Alamos, and statewide corridors.',
      href: '/moving-to/new-mexico',
    },
    {
      title: 'Moving to Albuquerque guide',
      description: 'Major Rio Grande metro, universities, film production, and diverse neighborhood comparison.',
    ...
    },
    {
      ...
      description: 'World-renowned arts capital, historic Plaza adobe, and Northern New Mexico comparison.',
      href: '/moving-to/new-mexico/santa-fe-nm',
    },
    {
      title: 'Moving to Los Alamos guide',
      description: 'High-income mesa community, national laboratory, and Pajarito Plateau comparison.',
    ...
    },
    {
      ...
      description: 'Compare CO origin markets and Front Range spillover into Rio Grande Metro.',
      href: '/moving-to/colorado',
    },
    {
      title: 'Browse Bernalillo County local movers',
      description: 'Corrales and Albuquerque Rio Grande Bosque mover directory.',
  ...
  testimonials: [
    {
      ...
      name: 'Rebecca & Tom H.',
      detail: 'Texas equestrian relocation to Corrales · April 2026',
    },
    {
      quote:
      ...
      name: 'Angela P.',
      detail: 'Relocated from Denver CO to Corrales (87048) · May 2026',
    },
  ],
  faqItems: [
    {
      question: 'How accurate is the moving calculator for Corrales relocations?',
      answer:
    ...
    {
      question: 'What is the best time of year to move to Corrales?',
      answer:
    ...
    {
      question: 'How much does it cost to move a 3-bedroom home to Corrales?',
      answer:
        'From Texas, Arizona, Colorado, and California origins, a 3-bedroom household (roughly 5,000–7,000 cubic feet) typically ranges from $6,500 to $10,100 for full-service interstate transport in 2026. Final price depends on exact volume, packing services, equestrian or Bosque accessorials, and season. Use our calculator for your specific inventory, then compare trusted movers in our directory.',
    },
    {
      question: 'How does Corrales compare to Albuquerque for moving costs?',
      answer:
    ...
    {
      question: 'What logistics should equestrian property relocations plan for?',
      answer:
    ...
    {
      question: 'What access rules affect Corrales-area moves?',
      answer:
