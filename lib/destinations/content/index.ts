...
import { hendersonNvContent } from '@/lib/destinations/content/henderson-nv';
import { summerlinNvContent } from '@/lib/destinations/content/summerlin-nv';
import { renoNvContent } from '@/lib/destinations/content/reno-nv';
import { sparksNvContent } from '@/lib/destinations/content/sparks-nv';
import { northLasVegasNvContent } from '@/lib/destinations/content/north-las-vegas-nv';
import { carsonCityNvContent } from '@/lib/destinations/content/carson-city-nv';
import { boulderCityNvContent } from '@/lib/destinations/content/boulder-city-nv';
import { inclineVillageNvContent } from '@/lib/destinations/content/incline-village-nv';
import { mesquiteNvContent } from '@/lib/destinations/content/mesquite-nv';
import { elkoNvContent } from '@/lib/destinations/content/elko-nv';
import { fargoNdContent } from '@/lib/destinations/content/fargo-nd';
import { bismarckNdContent } from '@/lib/destinations/content/bismarck-nd';
import { westFargoNdContent } from '@/lib/destinations/content/west-fargo-nd';
import { grandForksNdContent } from '@/lib/destinations/content/grand-forks-nd';
import { horaceNdContent } from '@/lib/destinations/content/horace-nd';
import { willistonNdContent } from '@/lib/destinations/content/williston-nd';
import { mandanNdContent } from '@/lib/destinations/content/mandan-nd';
...
import { alpineStarValleyWyContent } from '@/lib/destinations/content/alpine-star-valley-wy';
import { buffaloWyContent } from '@/lib/destinations/content/buffalo-wy';
import { casperWyContent } from '@/lib/destinations/content/casper-wy';
import { cheyenneWyContent } from '@/lib/destinations/content/cheyenne-wy';
import { codyWyContent } from '@/lib/destinations/content/cody-wy';
import { gilletteWyContent } from '@/lib/destinations/content/gillette-wy';
import { laramieWyContent } from '@/lib/destinations/content/laramie-wy';
import { sheridanWyContent } from '@/lib/destinations/content/sheridan-wy';
import { jacksonWyContent } from '@/lib/destinations/content/jackson-wy';
import { landerWyContent } from '@/lib/destinations/content/lander-wy';
...
const cityHubContentBySlug: Record<string, CityHubContent> = {
  ...
  'henderson-nv': hendersonNvContent,
  'summerlin-nv': summerlinNvContent,
  'reno-nv': renoNvContent,
  'sparks-nv': sparksNvContent,
  'north-las-vegas-nv': northLasVegasNvContent,
  'carson-city-nv': carsonCityNvContent,
  'boulder-city-nv': boulderCityNvContent,
  'incline-village-nv': inclineVillageNvContent,
  'mesquite-nv': mesquiteNvContent,
  'elko-nv': elkoNvContent,
  'fargo-nd': fargoNdContent,
  'bismarck-nd': bismarckNdContent,
  'west-fargo-nd': westFargoNdContent,
  'grand-forks-nd': grandForksNdContent,
  'horace-nd': horaceNdContent,
  'williston-nd': willistonNdContent,
  'mandan-nd': mandanNdContent,
  ...
  'alpine-star-valley-wy': alpineStarValleyWyContent,
  'buffalo-wy': buffaloWyContent,
  'casper-wy': casperWyContent,
  'cheyenne-wy': cheyenneWyContent,
  'cody-wy': codyWyContent,
  'gillette-wy': gilletteWyContent,
  'laramie-wy': laramieWyContent,
  'sheridan-wy': sheridanWyContent,
  'jackson-wy': jacksonWyContent,
  'lander-wy': landerWyContent,
};
...
export function getPublishedNevadaHubSlugs(): string[] {
  return getPublishedCityHubSlugs().filter(
    (slug) => getMarketBySlug(slug)?.clusterParent === 'nevada'
  );
}
...
export function getPublishedWyomingHubSlugs(): string[] {
  return getPublishedCityHubSlugs().filter(
    (slug) => getMarketBySlug(slug)?.clusterParent === 'wyoming'
  );
}