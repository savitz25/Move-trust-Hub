...
export const southDakotaClusterContent: SouthDakotaClusterContent = {
  ...
  seo: {
    title:
      'Moving to South Dakota (2026) — Destination Guides, Costs & Free Quotes | Move Trust Hub',
    description:
  ...
  bodySections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'Use our free calculator with your destination ZIP — Sioux Falls (57104), Rapid City (57701), Harrisburg (57032), Brookings (57006), Spearfish (57783), Brandon (57005), Tea (57064), Watertown (57201), Vermillion (57069), or Box Elder (57719) — then request 2–3 matched quotes on identical inventory before signing.',
      ],
    },
    {
