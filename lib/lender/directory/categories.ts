...
export const FDIC_CATEGORY: DirectoryCategoryConfig = {
  ...
  hubPath: lenderHref('/fdic-insured-banks'),
  statePath: (slug) => lenderHref(`/fdic-insured-banks/${slug}`),
  year: 2026,
  ...
  relatedVerticals: [
    {
      ...
      href: (s) => lenderHref(`/local-lenders/${s}`),
      description: 'Verified local mortgage brokers',
      live: true,
    },
    {
      label: 'Auto Loan Companies',
      href: (s) => lenderHref(`/auto-loan-companies/${s}`),
...
export const MORTGAGE_CATEGORY: DirectoryCategoryConfig = {
  ...
  label: 'Mortgage Lenders',
  labelShort: 'Mortgage',
  hubPath: lenderHref('/local-lenders'),
  statePath: (slug) => lenderHref(`/local-lenders/${slug}`),
  year: 2026,
  ...
  relatedVerticals: [
    {
      label: 'FDIC Insured Banks',
      href: (s) => lenderHref(`/fdic-insured-banks/${s}`),
...
export const AUTO_CATEGORY: DirectoryCategoryConfig = {
  ...
  hubPath: lenderHref('/auto-loan-companies'),
  statePath: (slug) => lenderHref(`/auto-loan-companies/${slug}`),
  year: 2026,
  schemaEntityType: 'FinancialService',
  isFreeDirectory: true,
  relatedVerticals: [
...
export const CREDIT_REPAIR_CATEGORY: DirectoryCategoryConfig = {
  ...
  hubPath: lenderHref('/credit-repair'),
  statePath: (slug) => lenderHref(`/credit-repair/${slug}`),
  year: 2026,
...
export const MCA_CATEGORY: DirectoryCategoryConfig = {
  ...
  label: 'MCA Companies',
  labelShort: 'MCA',
  hubPath: lenderHref('/mca-companies'),
  statePath: (slug) => lenderHref(`/mca-companies/${slug}`),
  year: 2026,
  schemaEntityType: 'FinancialService',
  isFreeDirectory: true,
  relatedVerticals: FDIC_CATEGORY.relatedVerticals,
