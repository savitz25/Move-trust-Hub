...
import { WORCESTER_UNDISPUTED_GROWTH_LEADER_HUB_AREAS, WORCESTER_UNDISPUTED_GROWTH_LEADER_LENDER_SLUGS } from '@/lib/lender/mortgage/massachusettsLenders';
...
export const metadata: Metadata = wrapHubPageMetadata('lender', {
  ...
  description: 'NMLS-verified mortgage lenders in Worcester County. Zoom Town growth leader, life sciences and remote worker financing, Polar Park revitalization, commuter rail access, and relative affordability vs. Greater Boston.',
  path: '/local-lenders/massachusetts/worcester-undisputed-growth-leader',
});
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <section>
              ...
              <p className="mt-4 text-sm">
                <Link href="/lender/local-lenders/massachusetts/worcester" className="text-[#3B82F6] hover:underline">
