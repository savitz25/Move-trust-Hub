...
export const metadata: Metadata = {
  ...
  description:
    'NMLS-verified mortgage lenders in DuPage, Cook, and Lake Counties. Wheaton 102.2% sale-to-list, 60%+ above-list sales, 41–44 day market times, and top-school district bidding wars.',
  alternates: { canonical: 'https://www.movetrusthub.com/lender/local-lenders/illinois/highly-competitive-chicago-suburbs' },
};
