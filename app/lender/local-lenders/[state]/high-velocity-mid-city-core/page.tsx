...
import { HIGH_VELOCITY_MID_CITY_CORE_HUB_AREAS, HIGH_VELOCITY_MID_CITY_CORE_LENDER_SLUGS } from '@/lib/lender/mortgage/districtOfColumbiaLenders';
...
export const metadata: Metadata = wrapHubPageMetadata('lender', {
  ...
  description: 'NMLS-verified mortgage lenders in DC Zip 20005. Historic rowhome and premium condo financing, Logan Circle and Thomas Circle, 14th Street corridor, ironclad demand, capped inventory, and nearly 13% price jumps.',
  path: '/local-lenders/district-of-columbia/high-velocity-mid-city-core',
});
