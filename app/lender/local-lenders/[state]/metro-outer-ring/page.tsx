...
export const metadata: Metadata = wrapHubPageMetadata('lender', {
  ...
  description: 'NMLS-verified mortgage lenders on Atlanta\'s southern outer ring. McDonough first-time buyer teams, DPA programs, USDA outer-ring financing, and independent brokers for $340K–$390K starter homes.',
  path: '/local-lenders/georgia/metro-outer-ring',
});
