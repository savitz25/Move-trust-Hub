...
/** High-traffic IN counties — sitemap priority 0.85 (top 15 by population / metro hubs) */
const IN_HIGH_TRAFFIC_COUNTIES = new Set([
  'marion',
  'lake',
  'allen',
  'hamilton',
...
/** High-traffic OH counties — sitemap priority 0.85 (top 15 by population / metro hubs) */
...
const SD_HIGH_TRAFFIC_COUNTIES = new Set(['minnehaha', 'pennington', 'lincoln']);
...
const KY_HIGH_TRAFFIC_COUNTIES = new Set([
  'jefferson',
  'fayette',
  'kenton',
  'boone',
                                ...
                                : id === 'kansas'
                                  ...
                                  : id === 'missouri'
                                    ...
                                    : id === 'illinois'
                                      ...
                                      : id === 'michigan'
                                        ? new Date(MICHIGAN_COUNTY_CONTENT_UPDATED)
                                        : id === 'indiana'
                                          ? new Date(INDIANA_COUNTY_CONTENT_UPDATED)
                                          : id === 'ohio'
                                                                ...
                                                                : id === 'vermont'
                                                                  ...
                                                                  : id === 'new-hampshire'
                                                                    ...
                                                                    : id === 'maine'
                                                                      ...
                                                                      : id === 'hawaii'
                                                                        ? new Date(HAWAII_COUNTY_CONTENT_UPDATED)
                                                                        : id === 'alaska'
                                                                                        ...
                                                                                        : id === 'idaho'
                                                                                          ...
                                                                                          : id === 'montana'
                                                                                            ...
                                                                                            : id === 'wyoming'
                                                                                              ...
                                                                                              : id === 'north-dakota'
                                                                                                ? new Date(NORTH_DAKOTA_COUNTY_CONTENT_UPDATED)
                                                                                                : id === 'south-dakota'
                                                                                                  ? new Date(SOUTH_DAKOTA_COUNTY_CONTENT_UPDATED)
                                                                                                  : new Date();
