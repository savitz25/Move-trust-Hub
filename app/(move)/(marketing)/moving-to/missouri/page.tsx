...
import {
  missouriClusterContent,
  type MissouriCorridorCity,
} from '@/lib/destinations/content/missouri-mo';
...
import { buildMissouriClusterSchemaGraph } from '@/lib/seo/build-destination-index-schema';
import { SITE_URL, buildOpenGraph, buildTwitter } from '@/lib/seo/site-metadata';

const content = missouriClusterContent;
  ...
  return (
    <div className="grid sm:grid-cols-2 gap-4">
      {cities.map((city) => {
        ...
        const path = market ? getMarketPath(market) : `/moving-to/missouri/${city.slug}`;
...
export default function MissouriClusterPage() {
  const published = new Set(getPublishedCityHubSlugs());
  const otherMissouriCities = getClusterMarkets('missouri').filter(
  ...
  return (
    <>
      <JsonLd
        data={buildMissouriClusterSchemaGraph(
          content.seo.title,
      ...
      <div className="min-h-screen">
        <section className="relative border-b bg-gradient-to-b from-primary/5 to-background py-12 md:py-20">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <DestinationClusterHeroCta clusterSlug="missouri" clusterLabel="Missouri" />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
              Kansas City Metro — Live City Guides
            </h2>
            <p className="text-muted-foreground mb-8 max-w-3xl">
              Kansas City, Lee&apos;s Summit, and Liberty — cultural riverfront revival,
              Longview Lake prestige, and Northland square charm.
            </p>
            <CorridorCityGrid cities={content.kansasCityMetroCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
              St. Louis Metro — Live City Guides
            </h2>
            <p className="text-muted-foreground mb-8 max-w-3xl">
              O&apos;Fallon, Chesterfield, St. Charles, and St. Louis — master-planned families,
              west-county luxury, Katy Trail history, and Central West End urban value.
            </p>
            <CorridorCityGrid cities={content.stLouisMetroCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
              Central Missouri — Live City Guide
            </h2>
            <p className="text-muted-foreground mb-8 max-w-3xl">
              Columbia — Mizzou intellectual culture and Farmers Market high-value consensus.
            </p>
            <CorridorCityGrid cities={content.centralMissouriCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
              Ozark Corridors — Live City Guides
            </h2>
            <p className="text-muted-foreground mb-8 max-w-3xl">
              Springfield and Republic/Nixa — Ozark urban affordability and explosive southwest growth.
            </p>
            <CorridorCityGrid cities={content.ozarkCorridor} published={published} />
          </div>
        </section>
        ...
        {otherMissouriCities.length > 0 && (
          <section className="py-12 md:py-16 bg-muted/20">
            <div className="container mx-auto px-4 max-w-6xl">
              <h2 className="text-2xl font-semibold tracking-tight mb-6">
                More Missouri Cities — Coming Soon
              </h2>
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {otherMissouriCities.map((market) => (
