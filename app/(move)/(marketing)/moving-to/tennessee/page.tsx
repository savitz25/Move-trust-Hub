...
import {
  tennesseeClusterContent,
  type TennesseeCorridorCity,
} from '@/lib/destinations/content/tennessee-tn';
...
import { buildTennesseeClusterSchemaGraph } from '@/lib/seo/build-destination-index-schema';
import { SITE_URL, buildOpenGraph, buildTwitter } from '@/lib/seo/site-metadata';

const content = tennesseeClusterContent;
  ...
  return (
    <div className="grid sm:grid-cols-2 gap-4">
      {cities.map((city) => {
        ...
        const path = market ? getMarketPath(market) : `/moving-to/tennessee/${city.slug}`;
...
export default function TennesseeClusterPage() {
  const published = new Set(getPublishedCityHubSlugs());
  const otherTennesseeCities = getClusterMarkets('tennessee').filter(
  ...
  return (
    <>
      <JsonLd
        data={buildTennesseeClusterSchemaGraph(
          content.seo.title,
      ...
      <div className="min-h-screen">
        <section className="relative border-b bg-gradient-to-b from-primary/5 to-background py-12 md:py-20">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <div className="inline-flex items-center gap-2 rounded-full border bg-primary/5 px-3 py-1 text-xs font-semibold text-primary mb-4">
              ...
              Tennessee Cluster · Updated 2026
            </div>
            ...
            <DestinationClusterHeroCta clusterSlug="tennessee" clusterLabel="Tennessee" />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
              Nashville Metro &amp; Middle Tennessee — Live City Guides
            </h2>
            <p className="text-muted-foreground mb-8 max-w-3xl">
              Six production-ready hubs covering Music City, the Williamson County
              luxury corridor, Wilson County family suburbs, and affordable
              south-of-Nashville alternatives.
            </p>
            <CorridorCityGrid cities={content.nashvilleMetroCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
              East &amp; North Tennessee — Live City Guides
            </h2>
            <p className="text-muted-foreground mb-8 max-w-3xl">
              Four production-ready hubs covering Knoxville, Chattanooga, Fort
              Campbell military relocations, and the Tri-Cities mountain region.
            </p>
            <CorridorCityGrid cities={content.eastTennesseeCorridor} published={published} />
          </div>
        </section>
        ...
        {otherTennesseeCities.length > 0 && (
          <section className="py-12 md:py-16 bg-muted/20">
            <div className="container mx-auto px-4 max-w-6xl">
              <h2 className="text-2xl font-semibold tracking-tight mb-6">
                More Tennessee Cities — Coming Soon
              </h2>
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {otherTennesseeCities.map((market) => (
