...
import {
  westVirginiaClusterContent,
  type WestVirginiaCorridorCity,
} from '@/lib/destinations/content/west-virginia-wv';
...
import { buildWestVirginiaClusterSchemaGraph } from '@/lib/seo/build-destination-index-schema';
import { SITE_URL, buildOpenGraph, buildTwitter } from '@/lib/seo/site-metadata';

const content = westVirginiaClusterContent;
...
function CorridorCityGrid({
  ...
  cities: WestVirginiaCorridorCity[];
  ...
  return (
    <div className="grid sm:grid-cols-2 gap-4">
      {cities.map((city) => {
        ...
        const path = market ? getMarketPath(market) : `/moving-to/west-virginia/${city.slug}`;
...
export default function WestVirginiaClusterPage() {
  const published = new Set(getPublishedCityHubSlugs());
  const otherWestVirginiaCities = getClusterMarkets('west-virginia').filter(
  ...
  return (
    <>
      <JsonLd
        data={buildWestVirginiaClusterSchemaGraph(
          content.seo.title,
      ...
      <div className="min-h-screen">
        <section className="relative border-b bg-gradient-to-b from-primary/5 to-background py-12 md:py-20">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <div className="inline-flex items-center gap-2 rounded-full border bg-primary/5 px-3 py-1 text-xs font-semibold text-primary mb-4">
              ...
              West Virginia Cluster · Updated 2026
            </div>
            ...
            <DestinationClusterHeroCta clusterSlug="west-virginia" clusterLabel="West Virginia" />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <p className="text-muted-foreground mb-8 max-w-3xl">
              ...
              corridor for D.C. commuters, Maryland spillover, and affordable Eastern Panhandle living.
            </p>
            <CorridorCityGrid cities={content.easternPanhandleCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <p className="text-muted-foreground mb-8 max-w-3xl">
              ...
              North Central suburban schools along the I-79 corridor.
            </p>
            <CorridorCityGrid cities={content.northUniversityCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <p className="text-muted-foreground mb-8 max-w-3xl">
              ...
              plus I-64 suburban family growth west of the capital.
            </p>
            <CorridorCityGrid cities={content.centralKanawhaCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <p className="text-muted-foreground mb-8 max-w-3xl">
              ...
              mountain towns for remote workers, retirees, and outdoor enthusiasts.
            </p>
            <CorridorCityGrid cities={content.mountainsLifestyleCorridor} published={published} />
          </div>
        </section>
        ...
        {otherWestVirginiaCities.length > 0 && (
          <section className="py-12 md:py-16 bg-muted/20">
            <div className="container mx-auto px-4 max-w-6xl">
              <h2 className="text-2xl font-semibold tracking-tight mb-6">
                More West Virginia Cities 
              </h2>
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {otherWestVirginiaCities.map((market) => (
        ...
        <section className="py-12 md:py-16">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl font-semibold tracking-tight mb-8">
              West Virginia Moving Resources
            </h2>
            <div className="grid sm:grid-cols-2 gap-4">
