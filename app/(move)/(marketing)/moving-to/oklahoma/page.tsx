...
import {
  oklahomaClusterContent,
  type OklahomaCorridorCity,
} from '@/lib/destinations/content/oklahoma-ok';
...
import { buildOklahomaClusterSchemaGraph } from '@/lib/seo/build-destination-index-schema';
import { SITE_URL, buildOpenGraph, buildTwitter } from '@/lib/seo/site-metadata';

const content = oklahomaClusterContent;
  ...
  return (
    <div className="grid sm:grid-cols-2 gap-4">
      {cities.map((city) => {
        ...
        const path = market ? getMarketPath(market) : `/moving-to/oklahoma/${city.slug}`;
...
export default function OklahomaClusterPage() {
  const published = new Set(getPublishedCityHubSlugs());
  const otherOklahomaCities = getClusterMarkets('oklahoma').filter(
  ...
  return (
    <>
      <JsonLd
        data={buildOklahomaClusterSchemaGraph(
          content.seo.title,
      ...
      <div className="min-h-screen">
        <section className="relative border-b bg-gradient-to-b from-primary/5 to-background py-12 md:py-20">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <DestinationClusterHeroCta clusterSlug="oklahoma" clusterLabel="Oklahoma" />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <p className="text-muted-foreground mb-8 max-w-3xl">
              ...
              driven by MAPS revitalization, aerospace and energy hiring, and top-ranked suburban
              schools.
            </p>
            <CorridorCityGrid cities={content.okcMetroCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <p className="text-muted-foreground mb-8 max-w-3xl">
              ...
              revitalization, and upscale Riverwalk suburban living at South Central affordability.
            </p>
            <CorridorCityGrid cities={content.tulsaMetroCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <p className="text-muted-foreground mb-8 max-w-3xl">
              ...
              state&apos;s most affordable stable housing north of the OKC–Tulsa corridor.
            </p>
            <CorridorCityGrid cities={content.collegeCorridor} published={published} />
          </div>
        </section>
        ...
        {otherOklahomaCities.length > 0 && (
          <section className="py-12 md:py-16 bg-muted/20">
            <div className="container mx-auto px-4 max-w-6xl">
              <h2 className="text-2xl font-semibold tracking-tight mb-6">
                More Oklahoma Cities — Coming Soon
              </h2>
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {otherOklahomaCities.map((market) => (
