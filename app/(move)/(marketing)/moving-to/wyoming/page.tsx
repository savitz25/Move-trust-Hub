...
import {
  wyomingClusterContent,
  type WyomingCorridorCity,
} from '@/lib/destinations/content/wyoming-wy';
...
import { buildWyomingClusterSchemaGraph } from '@/lib/seo/build-destination-index-schema';
import { SITE_URL, buildOpenGraph, buildTwitter } from '@/lib/seo/site-metadata';

const content = wyomingClusterContent;
  ...
  return (
    <div className="grid sm:grid-cols-2 gap-4">
      {cities.map((city) => {
        ...
        const path = market ? getMarketPath(market) : `/moving-to/wyoming/${city.slug}`;
...
export default function WyomingClusterPage() {
  const published = new Set(getPublishedCityHubSlugs());
  const otherWyomingCities = getClusterMarkets('wyoming').filter(
  ...
  return (
    <>
      <JsonLd
        data={buildWyomingClusterSchemaGraph(
          content.seo.title,
      ...
      <div className="min-h-screen">
        <section className="relative border-b bg-gradient-to-b from-primary/5 to-background py-12 md:py-20">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <DestinationClusterHeroCta clusterSlug="wyoming" clusterLabel="Wyoming" />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
              Southeast Wyoming — Live City Guides
            </h2>
            <p className="text-muted-foreground mb-8 max-w-3xl">
              Cheyenne and Laramie — complete capital core with F.E. Warren corridors and UW
              mountain-valley academic culture.
            </p>
            <CorridorCityGrid cities={content.southeastCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
              Central Basin — Live City Guides
            </h2>
            <p className="text-muted-foreground mb-8 max-w-3xl">
              Casper and Gillette — North Platte practical hub living and Powder River Basin
              industrial workhorse corridors.
            </p>
            <CorridorCityGrid cities={content.centralBasinCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
              Bighorn & Yellowstone — Live City Guides
            </h2>
            <p className="text-muted-foreground mb-8 max-w-3xl">
              Sheridan, Cody, Buffalo, and Lander — refined Bighorn oasis, Yellowstone gateway,
              Old West value, and Wind River climber sanctuary.
            </p>
            <CorridorCityGrid cities={content.bighornYellowstoneCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
              Alpine Resort — Live City Guides
            </h2>
            <p className="text-muted-foreground mb-8 max-w-3xl">
              Jackson and Alpine & Star Valley — Jackson Hole alpine paradise and Palisades
              Reservoir high-growth escape corridors.
            </p>
            <CorridorCityGrid cities={content.alpineResortCorridor} published={published} />
          </div>
        </section>
        ...
        {otherWyomingCities.length > 0 && (
          <section className="py-12 md:py-16 bg-muted/20">
            <div className="container mx-auto px-4 max-w-6xl">
              <h2 className="text-2xl font-semibold tracking-tight mb-6">
                More Wyoming Cities — Coming Soon
              </h2>
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {otherWyomingCities.map((market) => (
