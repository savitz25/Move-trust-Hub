...
import {
  southDakotaClusterContent,
  type SouthDakotaCorridorCity,
} from '@/lib/destinations/content/south-dakota-sd';
...
import { buildSouthDakotaClusterSchemaGraph } from '@/lib/seo/build-destination-index-schema';
import { SITE_URL, buildOpenGraph, buildTwitter } from '@/lib/seo/site-metadata';

const content = southDakotaClusterContent;
...
function CorridorCityGrid({
  ...
  cities: SouthDakotaCorridorCity[];
  ...
  return (
    <div className="grid sm:grid-cols-2 gap-4">
      {cities.map((city) => {
        ...
        const path = market ? getMarketPath(market) : `/moving-to/south-dakota/${city.slug}`;
...
export default function SouthDakotaClusterPage() {
  const published = new Set(getPublishedCityHubSlugs());
  const otherSouthDakotaCities = getClusterMarkets('south-dakota').filter(
  ...
  return (
    <>
      <JsonLd
        data={buildSouthDakotaClusterSchemaGraph(
          content.seo.title,
      ...
      <div className="min-h-screen">
        <section className="relative border-b bg-gradient-to-b from-primary/5 to-background py-12 md:py-20">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <div className="inline-flex items-center gap-2 rounded-full border bg-primary/5 px-3 py-1 text-xs font-semibold text-primary mb-4">
              ...
              South Dakota Cluster · Updated 2026
            </div>
            ...
            <DestinationClusterHeroCta clusterSlug="south-dakota" clusterLabel="South Dakota" />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
              Sioux Falls Metro — City Guides
            </h2>
            <p className="text-muted-foreground mb-8 max-w-3xl">
              Sioux Falls, Harrisburg, Brandon, and Tea — economic engine living, explosive
              master-planned growth, premium schools, and neighborly commuter corridors.
            </p>
            <CorridorCityGrid cities={content.siouxFallsMetroCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
              Black Hills & Western — City Guides
            </h2>
            <p className="text-muted-foreground mb-8 max-w-3xl">
              Rapid City, Spearfish, and Box Elder — Mount Rushmore gateway adventure, alpine
              sanctuary living, and Ellsworth AFB military corridor stability.
            </p>
            <CorridorCityGrid cities={content.blackHillsCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
              Eastern Corridor — City Guides
            </h2>
            <p className="text-muted-foreground mb-8 max-w-3xl">
              Brookings, Watertown, and Vermillion — SDSU brainy college culture, Lake Kampeska
              recreation, and USD riverfront academic living.
            </p>
        ...
        {otherSouthDakotaCities.length > 0 && (
          <section className="py-12 md:py-16 bg-muted/20">
            <div className="container mx-auto px-4 max-w-6xl">
              <h2 className="text-2xl font-semibold tracking-tight mb-6">
                More South Dakota Cities — Coming Soon
              </h2>
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {otherSouthDakotaCities.map((market) => (
