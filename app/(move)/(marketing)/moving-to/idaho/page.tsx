...
import {
  idahoClusterContent,
  type IdahoCorridorCity,
} from '@/lib/destinations/content/idaho-id';
...
import { buildIdahoClusterSchemaGraph } from '@/lib/seo/build-destination-index-schema';
import { SITE_URL, buildOpenGraph, buildTwitter } from '@/lib/seo/site-metadata';

const content = idahoClusterContent;
  ...
  return (
    <div className="grid sm:grid-cols-2 gap-4">
      {cities.map((city) => {
        ...
        const path = market ? getMarketPath(market) : `/moving-to/idaho/${city.slug}`;
...
export default function IdahoClusterPage() {
  const published = new Set(getPublishedCityHubSlugs());
  const otherIdahoCities = getClusterMarkets('idaho').filter(
  ...
  return (
    <>
      <JsonLd
        data={buildIdahoClusterSchemaGraph(
          content.seo.title,
      ...
      <div className="min-h-screen">
        <section className="relative border-b bg-gradient-to-b from-primary/5 to-background py-12 md:py-20">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <DestinationClusterHeroCta clusterSlug="idaho" clusterLabel="Idaho" />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <CorridorCityGrid cities={content.treasureValleyCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <p className="text-muted-foreground mb-8 max-w-3xl">
              ...
              with retirees, outdoor enthusiasts, and remote workers seeking mountain
              and water lifestyle without coastal premiums.
            </p>
            <CorridorCityGrid cities={content.panhandleCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <p className="text-muted-foreground mb-8 max-w-3xl">
              ...
              access, and affordable Snake River Canyon outdoor living beyond the
              Treasure Valley price curve.
            </p>
            <CorridorCityGrid cities={content.easternSouthernCorridor} published={published} />
          </div>
        </section>
        ...
        {otherIdahoCities.length > 0 && (
          <section className="py-12 md:py-16 bg-muted/20">
            <div className="container mx-auto px-4 max-w-6xl">
              <h2 className="text-2xl font-semibold tracking-tight mb-6">
                More Idaho Cities — Coming Soon
              </h2>
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {otherIdahoCities.map((market) => (
