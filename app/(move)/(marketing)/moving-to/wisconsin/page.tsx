...
import {
  wisconsinClusterContent,
  type WisconsinCorridorCity,
} from '@/lib/destinations/content/wisconsin-wi';
...
import { buildWisconsinClusterSchemaGraph } from '@/lib/seo/build-destination-index-schema';
import { SITE_URL, buildOpenGraph, buildTwitter } from '@/lib/seo/site-metadata';

const content = wisconsinClusterContent;
  ...
  return (
    <div className="grid sm:grid-cols-2 gap-4">
      {cities.map((city) => {
        ...
        const path = market ? getMarketPath(market) : `/moving-to/wisconsin/${city.slug}`;
...
export default function WisconsinClusterPage() {
  const published = new Set(getPublishedCityHubSlugs());
  const otherWisconsinCities = getClusterMarkets('wisconsin').filter(
  ...
  return (
    <>
      <JsonLd
        data={buildWisconsinClusterSchemaGraph(
          content.seo.title,
      ...
      <div className="min-h-screen">
        <section className="relative border-b bg-gradient-to-b from-primary/5 to-background py-12 md:py-20">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <div className="inline-flex items-center gap-2 rounded-full border bg-primary/5 px-3 py-1 text-xs font-semibold text-primary mb-4">
              ...
              Wisconsin Cluster · Updated 2026
            </div>
            ...
            <DestinationClusterHeroCta clusterSlug="wisconsin" clusterLabel="Wisconsin" />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <p className="text-muted-foreground mb-8 max-w-3xl">
              ...
              fast-growing northeast Madison commuter magnet.
            </p>
            <CorridorCityGrid cities={content.madisonCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <p className="text-muted-foreground mb-8 max-w-3xl">
              ...
              Lake Country living, and elite Lake Michigan North Shore character.
            </p>
            <CorridorCityGrid
              cities={content.milwaukeeLakeCountryCorridor}
              published={published}
            />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <p className="text-muted-foreground mb-8 max-w-3xl">
              ...
              community classic living.
            </p>
            <CorridorCityGrid cities={content.foxValleyNortheastCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <CorridorCityGrid cities={content.westernWisconsinCorridor} published={published} />
          </div>
        </section>
        ...
        {otherWisconsinCities.length > 0 && (
          <section className="py-12 md:py-16 bg-muted/20">
            <div className="container mx-auto px-4 max-w-6xl">
              <h2 className="text-2xl font-semibold tracking-tight mb-6">
                More Wisconsin Cities — Coming Soon
              </h2>
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {otherWisconsinCities.map((market) => (
