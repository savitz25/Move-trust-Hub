...
import {
  newYorkClusterContent,
  type NewYorkCorridorCity,
} from '@/lib/destinations/content/new-york-ny';
...
import { buildNewYorkClusterSchemaGraph } from '@/lib/seo/build-destination-index-schema';
import { SITE_URL, buildOpenGraph, buildTwitter } from '@/lib/seo/site-metadata';

const content = newYorkClusterContent;
  ...
  return (
    <div className="grid sm:grid-cols-2 gap-4">
      {cities.map((city) => {
        ...
        const path = market ? getMarketPath(market) : `/moving-to/new-york/${city.slug}`;
...
export default function NewYorkClusterPage() {
  const published = new Set(getPublishedCityHubSlugs());
  const otherNewYorkCities = getClusterMarkets('new-york').filter(
  ...
  return (
    <>
      <JsonLd
        data={buildNewYorkClusterSchemaGraph(
          content.seo.title,
      ...
      <div className="min-h-screen">
        <section className="relative border-b bg-gradient-to-b from-primary/5 to-background py-12 md:py-20">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <DestinationClusterHeroCta clusterSlug="new-york" clusterLabel="New York" />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <p className="text-muted-foreground mb-8 max-w-3xl">
              ...
              villages, and South Shore lifestyle.
            </p>
            <CorridorCityGrid cities={content.longIslandCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <p className="text-muted-foreground mb-8 max-w-3xl">
              ...
              revitalization with Metro-North access.
            </p>
            <CorridorCityGrid cities={content.westchesterCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <CorridorCityGrid cities={content.buffaloRochesterCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <p className="text-muted-foreground mb-8 max-w-3xl">
              ...
              most affordable Southern Tier housing.
            </p>
            <CorridorCityGrid
              cities={content.southernTierAdirondacksCorridor}
              published={published}
            />
          </div>
        </section>
        ...
        {otherNewYorkCities.length > 0 && (
          <section className="py-12 md:py-16 bg-muted/20">
            <div className="container mx-auto px-4 max-w-6xl">
              <h2 className="text-2xl font-semibold tracking-tight mb-6">
                More New York Cities — Coming Soon
              </h2>
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {otherNewYorkCities.map((market) => (
