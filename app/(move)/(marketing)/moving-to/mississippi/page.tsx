...
import {
  mississippiClusterContent,
  type MississippiCorridorCity,
} from '@/lib/destinations/content/mississippi-ms';
...
import { buildMississippiClusterSchemaGraph } from '@/lib/seo/build-destination-index-schema';
import { SITE_URL, buildOpenGraph, buildTwitter } from '@/lib/seo/site-metadata';

const content = mississippiClusterContent;
...
function CorridorCityGrid({
  ...
  cities: MississippiCorridorCity[];
  ...
  return (
    <div className="grid sm:grid-cols-2 gap-4">
      {cities.map((city) => {
        ...
        const path = market ? getMarketPath(market) : `/moving-to/mississippi/${city.slug}`;
...
export default function MississippiClusterPage() {
  const published = new Set(getPublishedCityHubSlugs());
  const otherMississippiCities = getClusterMarkets('mississippi').filter(
  ...
  return (
    <>
      <JsonLd
        data={buildMississippiClusterSchemaGraph(
          content.seo.title,
      ...
      <div className="min-h-screen">
        <section className="relative border-b bg-gradient-to-b from-primary/5 to-background py-12 md:py-20">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <div className="inline-flex items-center gap-2 rounded-full border bg-primary/5 px-3 py-1 text-xs font-semibold text-primary mb-4">
              ...
              Mississippi Cluster · Updated 2026
            </div>
            ...
            <DestinationClusterHeroCta clusterSlug="mississippi" clusterLabel="Mississippi" />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
              Gulf Coast — Live City Guides
            </h2>
            <p className="text-muted-foreground mb-8 max-w-3xl">
              Gulfport and Ocean Springs — Mississippi&apos;s #1 coastal city with port-sector
              employment and public beaches, plus an artistic walkable downtown with genuine beach
              access.
            </p>
            <CorridorCityGrid cities={content.gulfCoastCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
              Jackson Metro — Live City Guides
            </h2>
            <p className="text-muted-foreground mb-8 max-w-3xl">
              Madison, Flowood, Brandon, Ridgeland, and Jackson — affluent A+ school suburbs,
              healthcare-commercial convenience, lakeside family inventory, upscale reservoir living,
              and state-capital employment.
            </p>
            <CorridorCityGrid cities={content.jacksonMetroCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
              Hub Cities — Live City Guides
            </h2>
            <p className="text-muted-foreground mb-8 max-w-3xl">
              Hattiesburg and Oxford — Hub City university economy and sophisticated Ole Miss
              college-town culture with culinary and outdoor recreation.
            </p>
            <CorridorCityGrid cities={content.hubCitiesCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
              Border Growth — Live City Guide
            </h2>
            <p className="text-muted-foreground mb-8 max-w-3xl">
              Olive Branch — fastest-growing Memphis-border boomtown with low taxes and suburban
              inventory for households priced out of Tennessee premiums.
            </p>
            <CorridorCityGrid cities={content.borderGrowthCorridor} published={published} />
          </div>
        </section>
        ...
        {otherMississippiCities.length > 0 && (
          <section className="py-12 md:py-16 bg-muted/20">
            <div className="container mx-auto px-4 max-w-6xl">
              <h2 className="text-2xl font-semibold tracking-tight mb-6">
                More Mississippi Cities — Coming Soon
              </h2>
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {otherMississippiCities.map((market) => (
