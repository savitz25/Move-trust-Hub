...
import {
  alabamaClusterContent,
  type AlabamaCorridorCity,
} from '@/lib/destinations/content/alabama-al';
...
import { buildAlabamaClusterSchemaGraph } from '@/lib/seo/build-destination-index-schema';
import { SITE_URL, buildOpenGraph, buildTwitter } from '@/lib/seo/site-metadata';

const content = alabamaClusterContent;
  ...
  return (
    <div className="grid sm:grid-cols-2 gap-4">
      {cities.map((city) => {
        ...
        const path = market ? getMarketPath(market) : `/moving-to/alabama/${city.slug}`;
...
export default function AlabamaClusterPage() {
  const published = new Set(getPublishedCityHubSlugs());
  const otherAlabamaCities = getClusterMarkets('alabama').filter(
  ...
  return (
    <>
      <JsonLd
        data={buildAlabamaClusterSchemaGraph(
          content.seo.title,
      ...
      <div className="min-h-screen">
        <section className="relative border-b bg-gradient-to-b from-primary/5 to-background py-12 md:py-20">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <DestinationClusterHeroCta clusterSlug="alabama" clusterLabel="Alabama" />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <p className="text-muted-foreground mb-8 max-w-3xl">
              ...
              Redstone Arsenal, NASA, and fastest-growing engineering inbound volume in the Southeast.
            </p>
            <CorridorCityGrid cities={content.northAlabamaCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <p className="text-muted-foreground mb-8 max-w-3xl">
              ...
              from retail-growth corridors to eastern Mobile Bay and beach resort living.
            </p>
            <CorridorCityGrid cities={content.coastalSouthCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <p className="text-muted-foreground mb-8 max-w-3xl">
              ...
              Auburn University college-town manufacturing growth.
            </p>
            <CorridorCityGrid cities={content.centralEastCorridor} published={published} />
          </div>
        </section>
        ...
        {otherAlabamaCities.length > 0 && (
          <section className="py-12 md:py-16 bg-muted/20">
            <div className="container mx-auto px-4 max-w-6xl">
              <h2 className="text-2xl font-semibold tracking-tight mb-6">
                More Alabama Cities — Coming Soon
              </h2>
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {otherAlabamaCities.map((market) => (
