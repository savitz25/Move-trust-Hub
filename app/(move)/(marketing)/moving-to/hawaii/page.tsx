...
import {
  hawaiiClusterContent,
  type HawaiiCorridorCity,
} from '@/lib/destinations/content/hawaii-hi';
...
import { buildHawaiiClusterSchemaGraph } from '@/lib/seo/build-destination-index-schema';
import { SITE_URL, buildOpenGraph, buildTwitter } from '@/lib/seo/site-metadata';

const content = hawaiiClusterContent;
  ...
  return (
    <div className="grid sm:grid-cols-2 gap-4">
      {cities.map((city) => {
        ...
        const path = market ? getMarketPath(market) : `/moving-to/hawaii/${city.slug}`;
...
export default function HawaiiClusterPage() {
  const published = new Set(getPublishedCityHubSlugs());
  const otherHawaiiCities = getClusterMarkets('hawaii').filter(
  ...
  return (
    <>
      <JsonLd
        data={buildHawaiiClusterSchemaGraph(
          content.seo.title,
      ...
      <div className="min-h-screen">
        <section className="relative border-b bg-gradient-to-b from-primary/5 to-background py-12 md:py-20">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <DestinationClusterHeroCta clusterSlug="hawaii" clusterLabel="Hawaii" />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
              Oʻahu — Live City Guides
            </h2>
            <p className="text-muted-foreground mb-8 max-w-3xl">
              Honolulu, Kapolei, Kailua, Pearl City, and Waipahu — urban capital employment,
              Second City master-planned growth, windward beach lifestyle, central transit, and
              affordable west-side entry on Hawaiʻi&apos;s primary job-market island.
            </p>
            <CorridorCityGrid cities={content.oahuCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
              Maui — Live City Guides
            </h2>
            <p className="text-muted-foreground mb-8 max-w-3xl">
              Kihei and Wailuku — sun-drenched south-shore beaches with snorkeling and dining, plus
              historic creative county-seat charm at the West Maui Mountains base.
            </p>
            <CorridorCityGrid cities={content.mauiCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
              Hawaiʻi Island (Big Island) — Live City Guides
            </h2>
            <p className="text-muted-foreground mb-8 max-w-3xl">
              Hilo and Kailua-Kona — lush affordable rainforest living on the windward side versus
              sunny leeward fishing, resort employment, and volcanic landscapes.
            </p>
            <CorridorCityGrid cities={content.bigIslandCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
              Kauaʻi — Live City Guide
            </h2>
            <p className="text-muted-foreground mb-8 max-w-3xl">
              Lihue — quiet Garden Isle commercial capital with dramatic Nā Pali Coast and Waimea
              Canyon access.
            </p>
            <CorridorCityGrid cities={content.kauaiCorridor} published={published} />
          </div>
        </section>
        ...
        {otherHawaiiCities.length > 0 && (
          <section className="py-12 md:py-16 bg-muted/20">
            <div className="container mx-auto px-4 max-w-6xl">
              <h2 className="text-2xl font-semibold tracking-tight mb-6">
                More Hawaii Cities — Coming Soon
              </h2>
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {otherHawaiiCities.map((market) => (
        ...
        <section className="py-12 md:py-16">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl font-semibold tracking-tight mb-8">Hawaii Moving Resources</h2>
            <div className="grid sm:grid-cols-2 gap-4">
