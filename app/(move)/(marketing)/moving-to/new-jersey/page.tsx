...
import {
  newJerseyClusterContent,
  type NewJerseyCorridorCity,
} from '@/lib/destinations/content/new-jersey-nj';
...
import { buildNewJerseyClusterSchemaGraph } from '@/lib/seo/build-destination-index-schema';
import { SITE_URL, buildOpenGraph, buildTwitter } from '@/lib/seo/site-metadata';

const content = newJerseyClusterContent;
  ...
  return (
    <div className="grid sm:grid-cols-2 gap-4">
      {cities.map((city) => {
        ...
        const path = market ? getMarketPath(market) : `/moving-to/new-jersey/${city.slug}`;
...
export default function NewJerseyClusterPage() {
  const published = new Set(getPublishedCityHubSlugs());
  const otherNewJerseyCities = getClusterMarkets('new-jersey').filter(
  ...
  return (
    <>
      <JsonLd
        data={buildNewJerseyClusterSchemaGraph(
          content.seo.title,
      ...
      <div className="min-h-screen">
        <section className="relative border-b bg-gradient-to-b from-primary/5 to-background py-12 md:py-20">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <div className="inline-flex items-center gap-2 rounded-full border bg-primary/5 px-3 py-1 text-xs font-semibold text-primary mb-4">
              ...
              New Jersey Cluster · Updated 2026
            </div>
            ...
            <DestinationClusterHeroCta clusterSlug="new-jersey" clusterLabel="New Jersey" />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <p className="text-muted-foreground mb-8 max-w-3xl">
              ...
              PATH, ferry, and NJ Transit commuter access.
            </p>
            <CorridorCityGrid cities={content.hudsonWaterfrontCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <CorridorCityGrid cities={content.northJerseyGatewayCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <p className="text-muted-foreground mb-8 max-w-3xl">
              ...
              arts culture, and Ivy League prestige.
            </p>
            <CorridorCityGrid cities={content.upscaleSuburbsCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <p className="text-muted-foreground mb-8 max-w-3xl">
              ...
              Philadelphia corridor access.
            </p>
            <CorridorCityGrid cities={content.southJerseyCorridor} published={published} />
          </div>
        </section>
        ...
        {otherNewJerseyCities.length > 0 && (
          <section className="py-12 md:py-16 bg-muted/20">
            <div className="container mx-auto px-4 max-w-6xl">
              <h2 className="text-2xl font-semibold tracking-tight mb-6">
                More New Jersey Cities — Coming Soon
              </h2>
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {otherNewJerseyCities.map((market) => (
