...
import {
  vermontClusterContent,
  type VermontCorridorCity,
} from '@/lib/destinations/content/vermont-vt';
...
import { buildVermontClusterSchemaGraph } from '@/lib/seo/build-destination-index-schema';
import { SITE_URL, buildOpenGraph, buildTwitter } from '@/lib/seo/site-metadata';

const content = vermontClusterContent;
  ...
  return (
    <div className="grid sm:grid-cols-2 gap-4">
      {cities.map((city) => {
        ...
        const path = market ? getMarketPath(market) : `/moving-to/vermont/${city.slug}`;
...
export default function VermontClusterPage() {
  const published = new Set(getPublishedCityHubSlugs());
  const otherVermontCities = getClusterMarkets('vermont').filter(
  ...
  return (
    <>
      <JsonLd
        data={buildVermontClusterSchemaGraph(
          content.seo.title,
      ...
      <div className="min-h-screen">
        <section className="relative border-b bg-gradient-to-b from-primary/5 to-background py-12 md:py-20">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <DestinationClusterHeroCta clusterSlug="vermont" clusterLabel="Vermont" />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
              Champlain Valley — Live City Guides
            </h2>
            <p className="text-muted-foreground mb-8 max-w-3xl">
              South Burlington, Burlington, Essex, Colchester, and Williston — top schools, UVM
              culture, Lake Champlain access, and Champlain Valley suburban growth.
            </p>
            <CorridorCityGrid cities={content.champlainValleyCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
              Central Vermont — Live City Guides
            </h2>
            <p className="text-muted-foreground mb-8 max-w-3xl">
              Montpelier and Rutland — historic state capital arts living and affordable central
              mountain-hub value.
            </p>
            <CorridorCityGrid cities={content.centralVermontCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
              Northeast Kingdom &amp; College Towns — Live City Guides
            </h2>
            <p className="text-muted-foreground mb-8 max-w-3xl">
              St. Johnsbury and Middlebury — kingdom gateway scenic beauty and charming
              college-town farmland culture.
            </p>
            <CorridorCityGrid cities={content.kingdomAndCollegeCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
              Southern Gateway — Live City Guides
            </h2>
            <p className="text-muted-foreground mb-8 max-w-3xl">
              Brattleboro — artsy progressive corridor on the Connecticut River with Massachusetts-border
              convenience.
            </p>
            <CorridorCityGrid cities={content.southernGatewayCorridor} published={published} />
          </div>
        </section>
        ...
        {otherVermontCities.length > 0 && (
          <section className="py-12 md:py-16 bg-muted/20">
            <div className="container mx-auto px-4 max-w-6xl">
              <h2 className="text-2xl font-semibold tracking-tight mb-6">
                More Vermont Cities — Coming Soon
              </h2>
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {otherVermontCities.map((market) => (
        ...
        <section className="py-12 md:py-16">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl font-semibold tracking-tight mb-8">Vermont Moving Resources</h2>
            <div className="grid sm:grid-cols-2 gap-4">
