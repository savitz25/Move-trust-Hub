...
import {
  alaskaClusterContent,
  type AlaskaCorridorCity,
} from '@/lib/destinations/content/alaska-ak';
...
import { buildAlaskaClusterSchemaGraph } from '@/lib/seo/build-destination-index-schema';
import { SITE_URL, buildOpenGraph, buildTwitter } from '@/lib/seo/site-metadata';

const content = alaskaClusterContent;
  ...
  return (
    <div className="grid sm:grid-cols-2 gap-4">
      {cities.map((city) => {
        ...
        const path = market ? getMarketPath(market) : `/moving-to/alaska/${city.slug}`;
...
export default function AlaskaClusterPage() {
  const published = new Set(getPublishedCityHubSlugs());
  const otherAlaskaCities = getClusterMarkets('alaska').filter(
  ...
  return (
    <>
      <JsonLd
        data={buildAlaskaClusterSchemaGraph(
          content.seo.title,
      ...
      <div className="min-h-screen">
        <section className="relative border-b bg-gradient-to-b from-primary/5 to-background py-12 md:py-20">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <DestinationClusterHeroCta clusterSlug="alaska" clusterLabel="Alaska" />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <p className="text-muted-foreground mb-8 max-w-3xl">
              ...
              Valley affordability, and historic agricultural charm on the Road System.
            </p>
            <CorridorCityGrid cities={content.anchorageMatSuCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <CorridorCityGrid cities={content.interiorAlaskaCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <p className="text-muted-foreground mb-8 max-w-3xl">
              ...
              and Inside Passage rainforest coastal living.
            </p>
            <CorridorCityGrid cities={content.southeastIslandCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <p className="text-muted-foreground mb-8 max-w-3xl">
              ...
              economies, and artsy Spit community at the End of the Road.
            </p>
            <CorridorCityGrid cities={content.kenaiPeninsulaCorridor} published={published} />
          </div>
        </section>
        ...
        {otherAlaskaCities.length > 0 && (
          <section className="py-12 md:py-16 bg-muted/20">
            <div className="container mx-auto px-4 max-w-6xl">
              <h2 className="text-2xl font-semibold tracking-tight mb-6">
                More Alaska Cities — Coming Soon
              </h2>
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {otherAlaskaCities.map((market) => (
        ...
        <section className="py-12 md:py-16">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl font-semibold tracking-tight mb-8">Alaska Moving Resources</h2>
            <div className="grid sm:grid-cols-2 gap-4">
