...
import {
  arizonaClusterContent,
  type ArizonaCorridorCity,
} from '@/lib/destinations/content/arizona-az';
...
import { buildArizonaClusterSchemaGraph } from '@/lib/seo/build-destination-index-schema';
import { SITE_URL, buildOpenGraph, buildTwitter } from '@/lib/seo/site-metadata';

const content = arizonaClusterContent;
  ...
  return (
    <div className="grid sm:grid-cols-2 gap-4">
      {cities.map((city) => {
        ...
        const path = market ? getMarketPath(market) : `/moving-to/arizona/${city.slug}`;
...
export default function ArizonaClusterPage() {
  const published = new Set(getPublishedCityHubSlugs());
  const otherArizonaCities = getClusterMarkets('arizona').filter(
  ...
  return (
    <>
      <JsonLd
        data={buildArizonaClusterSchemaGraph(
          content.seo.title,
      ...
      <div className="min-h-screen">
        <section className="relative border-b bg-gradient-to-b from-primary/5 to-background py-12 md:py-20">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <DestinationClusterHeroCta clusterSlug="arizona" clusterLabel="Arizona" />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
              Phoenix Metro Core — Live City Guides
            </h2>
            <p className="text-muted-foreground mb-8 max-w-3xl">
              Phoenix, Scottsdale, and Tempe — urban revitalization, luxury desert lifestyle, and
              ASU campus energy at the center of Valley of the Sun inbound demand.
            </p>
            <CorridorCityGrid cities={content.phoenixMetroCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
              East Valley — Live City Guides
            </h2>
            <p className="text-muted-foreground mb-8 max-w-3xl">
              Gilbert, Chandler, and Queen Creek — top-ranked schools, Silicon Desert tech employment,
              and fast-growing upscale suburban family corridors.
            </p>
            <CorridorCityGrid cities={content.eastValleyCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
              West Valley — Live City Guides
            </h2>
            <p className="text-muted-foreground mb-8 max-w-3xl">
              Buckeye and Goodyear &amp; Surprise — hyper-growth master-planned communities and West
              Valley new-construction value driving California and Midwest inbound volume.
            </p>
            <CorridorCityGrid cities={content.westValleyCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
              Pinal County — Live City Guides
            </h2>
            <p className="text-muted-foreground mb-8 max-w-3xl">
              Maricopa and Casa Grande — affordable Phoenix commute corridors with rapid inbound
              growth south of the Valley of the Sun.
            </p>
            <CorridorCityGrid cities={content.pinalCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
              Southern Arizona — Live City Guides
            </h2>
            <p className="text-muted-foreground mb-8 max-w-3xl">
              Tucson and Marana — mountain-backed lifestyle, University of Arizona employment, and
              lower cost of living than Phoenix metro.
            </p>
            <CorridorCityGrid cities={content.southernArizonaCorridor} published={published} />
          </div>
        </section>
        ...
        {otherArizonaCities.length > 0 && (
          <section className="py-12 md:py-16 bg-muted/20">
            <div className="container mx-auto px-4 max-w-6xl">
              <h2 className="text-2xl font-semibold tracking-tight mb-6">
                More Arizona Cities — Coming Soon
              </h2>
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {otherArizonaCities.map((market) => (
