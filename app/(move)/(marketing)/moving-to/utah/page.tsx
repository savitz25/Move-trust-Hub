...
import {
  utahClusterContent,
  type UtahCorridorCity,
} from '@/lib/destinations/content/utah-ut';
...
import { buildUtahClusterSchemaGraph } from '@/lib/seo/build-destination-index-schema';
import { SITE_URL, buildOpenGraph, buildTwitter } from '@/lib/seo/site-metadata';

const content = utahClusterContent;
  ...
  return (
    <div className="grid sm:grid-cols-2 gap-4">
      {cities.map((city) => {
        ...
        const path = market ? getMarketPath(market) : `/moving-to/utah/${city.slug}`;
...
export default function UtahClusterPage() {
  const published = new Set(getPublishedCityHubSlugs());
  const otherUtahCities = getClusterMarkets('utah').filter(
  ...
  return (
    <>
      <JsonLd
        data={buildUtahClusterSchemaGraph(
          content.seo.title,
      ...
      <div className="min-h-screen">
        <section className="relative border-b bg-gradient-to-b from-primary/5 to-background py-12 md:py-20">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <DestinationClusterHeroCta clusterSlug="utah" clusterLabel="Utah" />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <p className="text-muted-foreground mb-8 max-w-3xl">
              ...
              northern value, Davis County rail connectivity, and upscale foothill inventory.
            </p>
            <CorridorCityGrid cities={content.saltLakeMetroCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <p className="text-muted-foreground mb-8 max-w-3xl">
              ...
              corridor epicenter, brainy valley anchors, walkable hybrid living, and Utah Lake
              new-construction growth.
            </p>
            <CorridorCityGrid cities={content.siliconSlopesCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <p className="text-muted-foreground mb-8 max-w-3xl">
              ...
              living near Snow Canyon and Zion.
            </p>
            <CorridorCityGrid cities={content.resortSouthernCorridor} published={published} />
          </div>
        </section>
        ...
        {otherUtahCities.length > 0 && (
          <section className="py-12 md:py-16 bg-muted/20">
            <div className="container mx-auto px-4 max-w-6xl">
              <h2 className="text-2xl font-semibold tracking-tight mb-6">
                More Utah Cities — Coming Soon
              </h2>
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {otherUtahCities.map((market) => (
        ...
        <section className="py-12 md:py-16">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl font-semibold tracking-tight mb-8">Utah Moving Resources</h2>
            <div className="grid sm:grid-cols-2 gap-4">
