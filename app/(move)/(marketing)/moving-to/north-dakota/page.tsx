...
import {
  northDakotaClusterContent,
  type NorthDakotaCorridorCity,
} from '@/lib/destinations/content/north-dakota-nd';
...
import { buildNorthDakotaClusterSchemaGraph } from '@/lib/seo/build-destination-index-schema';
import { SITE_URL, buildOpenGraph, buildTwitter } from '@/lib/seo/site-metadata';

const content = northDakotaClusterContent;
...
function CorridorCityGrid({
  ...
  cities: NorthDakotaCorridorCity[];
  ...
  return (
    <div className="grid sm:grid-cols-2 gap-4">
      {cities.map((city) => {
        ...
        const path = market ? getMarketPath(market) : `/moving-to/north-dakota/${city.slug}`;
...
export default function NorthDakotaClusterPage() {
  const published = new Set(getPublishedCityHubSlugs());
  const otherNorthDakotaCities = getClusterMarkets('north-dakota').filter(
  ...
  return (
    <>
      <JsonLd
        data={buildNorthDakotaClusterSchemaGraph(
          content.seo.title,
      ...
      <div className="min-h-screen">
        <section className="relative border-b bg-gradient-to-b from-primary/5 to-background py-12 md:py-20">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <div className="inline-flex items-center gap-2 rounded-full border bg-primary/5 px-3 py-1 text-xs font-semibold text-primary mb-4">
              ...
              North Dakota Cluster · Updated 2026
            </div>
            ...
            <DestinationClusterHeroCta clusterSlug="north-dakota" clusterLabel="North Dakota" />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
              Red River Valley — Live City Guides
            </h2>
            <p className="text-muted-foreground mb-8 max-w-3xl">
              Fargo, West Fargo, Horace, Grand Forks, and Wahpeton — NDSU tech culture, family
              suburbs, luxury-lot growth, UND aerospace, and affordable tech-ed living.
            </p>
            <CorridorCityGrid cities={content.redRiverValleyCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
              Capital Corridor — Live City Guides
            </h2>
            <p className="text-muted-foreground mb-8 max-w-3xl">
              Bismarck and Mandan — polished state capital living and historic western character
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
              Energy & Western — Live City Guides
            </h2>
            <p className="text-muted-foreground mb-8 max-w-3xl">
              Williston, Dickinson, and Minot — Bakken energy employment, Badlands gateway living,
              and Magic City Air Force stability.
            </p>
            <CorridorCityGrid cities={content.energyWesternCorridor} published={published} />
          </div>
        </section>
        ...
        {otherNorthDakotaCities.length > 0 && (
          <section className="py-12 md:py-16 bg-muted/20">
            <div className="container mx-auto px-4 max-w-6xl">
              <h2 className="text-2xl font-semibold tracking-tight mb-6">
                More North Dakota Cities — Coming Soon
              </h2>
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {otherNorthDakotaCities.map((market) => (
