...
import {
  arkansasClusterContent,
  type ArkansasCorridorCity,
} from '@/lib/destinations/content/arkansas-ar';
...
import { buildArkansasClusterSchemaGraph } from '@/lib/seo/build-destination-index-schema';
import { SITE_URL, buildOpenGraph, buildTwitter } from '@/lib/seo/site-metadata';

const content = arkansasClusterContent;
  ...
  return (
    <div className="grid sm:grid-cols-2 gap-4">
      {cities.map((city) => {
        ...
        const path = market ? getMarketPath(market) : `/moving-to/arkansas/${city.slug}`;
...
export default function ArkansasClusterPage() {
  const published = new Set(getPublishedCityHubSlugs());
  const otherArkansasCities = getClusterMarkets('arkansas').filter(
  ...
  return (
    <>
      <JsonLd
        data={buildArkansasClusterSchemaGraph(
          content.seo.title,
      ...
      <div className="min-h-screen">
        <section className="relative border-b bg-gradient-to-b from-primary/5 to-background py-12 md:py-20">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <DestinationClusterHeroCta clusterSlug="arkansas" clusterLabel="Arkansas" />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
              Northwest Arkansas — City Guides
            </h2>
        ...
        {otherArkansasCities.length > 0 && (
          <section className="py-12 md:py-16 bg-muted/20">
            <div className="container mx-auto px-4 max-w-6xl">
              <h2 className="text-2xl font-semibold tracking-tight mb-6">
                More Arkansas Cities — Coming Soon
              </h2>
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {otherArkansasCities.map((market) => (
