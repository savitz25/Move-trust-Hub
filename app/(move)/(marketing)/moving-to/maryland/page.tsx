...
import {
  marylandClusterContent,
  type MarylandCorridorCity,
} from '@/lib/destinations/content/maryland-md';
...
import { buildMarylandClusterSchemaGraph } from '@/lib/seo/build-destination-index-schema';
import { SITE_URL, buildOpenGraph, buildTwitter } from '@/lib/seo/site-metadata';

const content = marylandClusterContent;
  ...
  return (
    <div className="grid sm:grid-cols-2 gap-4">
      {cities.map((city) => {
        ...
        const path = market ? getMarketPath(market) : `/moving-to/maryland/${city.slug}`;
...
export default function MarylandClusterPage() {
  const published = new Set(getPublishedCityHubSlugs());
  const otherMarylandCities = getClusterMarkets('maryland').filter(
  ...
  return (
    <>
      <JsonLd
        data={buildMarylandClusterSchemaGraph(
          content.seo.title,
      ...
      <div className="min-h-screen">
        <section className="relative border-b bg-gradient-to-b from-primary/5 to-background py-12 md:py-20">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <DestinationClusterHeroCta clusterSlug="maryland" clusterLabel="Maryland" />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <p className="text-muted-foreground mb-8 max-w-3xl">
              ...
              I-270 biotech hiring, Metro Red Line access, and Bethesda Row walkability.
            </p>
            <CorridorCityGrid cities={content.montgomeryMetroCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <p className="text-muted-foreground mb-8 max-w-3xl">
              ...
              Merriweather Post Pavilion culture, and Old Ellicott City historic charm.
            </p>
            <CorridorCityGrid cities={content.howardCountyCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <p className="text-muted-foreground mb-8 max-w-3xl">
              ...
              and Severn River peninsula estates along the B&A Trail.
            </p>
            <CorridorCityGrid cities={content.chesapeakeCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <p className="text-muted-foreground mb-8 max-w-3xl">
              ...
              harbor views at meaningful discounts versus D.C. suburb premiums.
            </p>
            <CorridorCityGrid cities={content.baltimoreUrbanCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <p className="text-muted-foreground mb-8 max-w-3xl">
              ...
              arts-district pace on the Chesapeake Eastern Shore.
            </p>
            <CorridorCityGrid
              cities={content.frederickEasternShoreCorridor}
              published={published}
            />
          </div>
        </section>
        ...
        {otherMarylandCities.length > 0 && (
          <section className="py-12 md:py-16 bg-muted/20">
            <div className="container mx-auto px-4 max-w-6xl">
              <h2 className="text-2xl font-semibold tracking-tight mb-6">
                More Maryland Cities — Coming Soon
              </h2>
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {otherMarylandCities.map((market) => (
