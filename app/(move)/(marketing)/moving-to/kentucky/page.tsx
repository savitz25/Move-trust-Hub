...
import {
  kentuckyClusterContent,
  type KentuckyCorridorCity,
} from '@/lib/destinations/content/kentucky-ky';
...
import { buildKentuckyClusterSchemaGraph } from '@/lib/seo/build-destination-index-schema';
import { SITE_URL, buildOpenGraph, buildTwitter } from '@/lib/seo/site-metadata';

const content = kentuckyClusterContent;
  ...
  return (
    <div className="grid sm:grid-cols-2 gap-4">
      {cities.map((city) => {
        ...
        const path = market ? getMarketPath(market) : `/moving-to/kentucky/${city.slug}`;
...
export default function KentuckyClusterPage() {
  const published = new Set(getPublishedCityHubSlugs());
  const otherKentuckyCities = getClusterMarkets('kentucky').filter(
  ...
  return (
    <>
      <JsonLd
        data={buildKentuckyClusterSchemaGraph(
          content.seo.title,
      ...
      <div className="min-h-screen">
        <section className="relative border-b bg-gradient-to-b from-primary/5 to-background py-12 md:py-20">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <DestinationClusterHeroCta clusterSlug="kentucky" clusterLabel="Kentucky" />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
              Bluegrass Horse Country — Live City Guides
            </h2>
            <p className="text-muted-foreground mb-8 max-w-3xl">
              Lexington and Georgetown — University of Kentucky intellectual culture,
              Keeneland horse farms, and Toyota manufacturing stability.
            </p>
            <CorridorCityGrid cities={content.bluegrassCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
              Louisville Metro — Live City Guides
            </h2>
            <p className="text-muted-foreground mb-8 max-w-3xl">
              Louisville — Highlands walkability, Old Louisville historic inventory,
              bourbon culture, and UPS Worldport logistics employment.
            </p>
            <CorridorCityGrid cities={content.louisvilleMetroCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
              Northern Kentucky — Live City Guides
            </h2>
            <p className="text-muted-foreground mb-8 max-w-3xl">
              Covington and Florence — Cincinnati riverfront alternative, MainStrasse
              historic charm, and I-75/CVG logistics corridor.
            </p>
            <CorridorCityGrid cities={content.northernKentuckyCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
              I-65 Western Growth — Live City Guides
            </h2>
            <p className="text-muted-foreground mb-8 max-w-3xl">
              Bowling Green, Elizabethtown, and Owensboro — Corvette plant employment,
              EV battery Hub City growth, and BBQ Capital riverfront affordability.
            </p>
            <CorridorCityGrid cities={content.i65WesternCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
              Eastern & Creative — Live City Guides
            </h2>
            <p className="text-muted-foreground mb-8 max-w-3xl">
              Richmond and Paducah — EKU commuter value and UNESCO Creative City
              river-confluence arts sanctuary.
            </p>
            <CorridorCityGrid cities={content.easternCreativeCorridor} published={published} />
          </div>
        </section>
        ...
        {otherKentuckyCities.length > 0 && (
          <section className="py-12 md:py-16 bg-muted/20">
            <div className="container mx-auto px-4 max-w-6xl">
              <h2 className="text-2xl font-semibold tracking-tight mb-6">
                More Kentucky Cities — Coming Soon
              </h2>
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {otherKentuckyCities.map((market) => (
