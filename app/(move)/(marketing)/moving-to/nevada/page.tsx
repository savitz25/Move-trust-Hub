...
import {
  nevadaClusterContent,
  type NevadaCorridorCity,
} from '@/lib/destinations/content/nevada-nv';
...
import { buildNevadaClusterSchemaGraph } from '@/lib/seo/build-destination-index-schema';
import { SITE_URL, buildOpenGraph, buildTwitter } from '@/lib/seo/site-metadata';

const content = nevadaClusterContent;
  ...
  return (
    <div className="grid sm:grid-cols-2 gap-4">
      {cities.map((city) => {
        ...
        const path = market ? getMarketPath(market) : `/moving-to/nevada/${city.slug}`;
...
export default function NevadaClusterPage() {
  const published = new Set(getPublishedCityHubSlugs());
  const otherNevadaCities = getClusterMarkets('nevada').filter(
  ...
  return (
    <>
      <JsonLd
        data={buildNevadaClusterSchemaGraph(
          content.seo.title,
      ...
      <div className="min-h-screen">
        <section className="relative border-b bg-gradient-to-b from-primary/5 to-background py-12 md:py-20">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <DestinationClusterHeroCta clusterSlug="nevada" clusterLabel="Nevada" />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
              Las Vegas Metro — Live City Guides
            </h2>
            <p className="text-muted-foreground mb-8 max-w-3xl">
              Henderson, Summerlin, North Las Vegas, Boulder City, and Mesquite — master-planned
              suburbs, Red Rock luxury, first-time buyer value, and retirement golf corridors.
            </p>
            <CorridorCityGrid cities={content.lasVegasMetroCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
              Reno-Tahoe — Live City Guides
            </h2>
            <p className="text-muted-foreground mb-8 max-w-3xl">
              Reno, Sparks, and Incline Village — Truckee River tech reinvention, Sparks Marina
              accessibility, and Lake Tahoe alpine luxury.
            </p>
            <CorridorCityGrid cities={content.renoTahoeCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
              Capital Corridor — Live City Guide
            </h2>
            <p className="text-muted-foreground mb-8 max-w-3xl">
              Carson City — historic capital stability and Eagle Valley government employment.
            </p>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
              Eastern Nevada — Live City Guide
            </h2>
            <p className="text-muted-foreground mb-8 max-w-3xl">
              Elko — gold-mining workhorse employment and rural Mountain West character.
            </p>
        ...
        {otherNevadaCities.length > 0 && (
          <section className="py-12 md:py-16 bg-muted/20">
            <div className="container mx-auto px-4 max-w-6xl">
              <h2 className="text-2xl font-semibold tracking-tight mb-6">
                More Nevada Cities — Coming Soon
              </h2>
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {otherNevadaCities.map((market) => (
