...
import {
  massachusettsClusterContent,
  type MassachusettsCorridorCity,
} from '@/lib/destinations/content/massachusetts-ma';
...
import { buildMassachusettsClusterSchemaGraph } from '@/lib/seo/build-destination-index-schema';
import { SITE_URL, buildOpenGraph, buildTwitter } from '@/lib/seo/site-metadata';

const content = massachusettsClusterContent;
...
function CorridorCityGrid({
  ...
  cities: MassachusettsCorridorCity[];
  ...
  return (
    <div className="grid sm:grid-cols-2 gap-4">
      {cities.map((city) => {
        ...
        const path = market ? getMarketPath(market) : `/moving-to/massachusetts/${city.slug}`;
...
export default function MassachusettsClusterPage() {
  const published = new Set(getPublishedCityHubSlugs());
  const otherMassachusettsCities = getClusterMarkets('massachusetts').filter(
  ...
  return (
    <>
      <JsonLd
        data={buildMassachusettsClusterSchemaGraph(
          content.seo.title,
      ...
      <div className="min-h-screen">
        <section className="relative border-b bg-gradient-to-b from-primary/5 to-background py-12 md:py-20">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <div className="inline-flex items-center gap-2 rounded-full border bg-primary/5 px-3 py-1 text-xs font-semibold text-primary mb-4">
              ...
              Massachusetts Cluster · Updated 2026
            </div>
            ...
            <DestinationClusterHeroCta clusterSlug="massachusetts" clusterLabel="Massachusetts" />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
              Greater Boston Inner Core — Live City Guides
            </h2>
            <p className="text-muted-foreground mb-8 max-w-3xl">
              Cambridge, Somerville, and Brookline — Harvard/MIT innovation, progressive arts
              walkability, and prestigious urban-suburban density.
            </p>
            <CorridorCityGrid cities={content.innerCoreCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
              Elite Transit Suburbs — Live City Guides
            </h2>
            <p className="text-muted-foreground mb-8 max-w-3xl">
              Newton, Lexington, and Waltham — Garden City schools, Revolutionary War heritage, and
              Route 128 Watch City life sciences.
            </p>
            <CorridorCityGrid cities={content.eliteSuburbsCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
              MetroWest &amp; Coast — Live City Guides
            </h2>
            <p className="text-muted-foreground mb-8 max-w-3xl">
              Framingham, Malden, and Quincy — commuter-rail commercial hub, Orange Line diversity,
              and Red Line coastal revival.
            </p>
            <CorridorCityGrid cities={content.metroWestCoastCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
              Central Massachusetts — Live City Guides
            </h2>
            <p className="text-muted-foreground mb-8 max-w-3xl">
              Worcester — revitalizing college-and-healthcare hub with affordable Boston-alternative
              value.
            </p>
            <CorridorCityGrid cities={content.centralMaCorridor} published={published} />
          </div>
        </section>
        ...
        {otherMassachusettsCities.length > 0 && (
          <section className="py-12 md:py-16 bg-muted/20">
            <div className="container mx-auto px-4 max-w-6xl">
              <h2 className="text-2xl font-semibold tracking-tight mb-6">
                More Massachusetts Cities — Coming Soon
              </h2>
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {otherMassachusettsCities.map((market) => (
        ...
        <section className="py-12 md:py-16">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl font-semibold tracking-tight mb-8">
              Massachusetts Moving Resources
            </h2>
            <div className="grid sm:grid-cols-2 gap-4">
