...
} from '@/lib/destinations/content/north-carolina-nc';
...
import { buildNorthCarolinaClusterSchemaGraph } from '@/lib/seo/build-destination-index-schema';
import { SITE_URL, buildOpenGraph, buildTwitter } from '@/lib/seo/site-metadata';

const content = northCarolinaClusterContent;
...
function CorridorCityGrid({
  ...
  cities: NorthCarolinaCorridorCity[];
  ...
  return (
    <div className="grid sm:grid-cols-2 gap-4">
      {cities.map((city) => {
        ...
        const path = market ? getMarketPath(market) : `/moving-to/north-carolina/${city.slug}`;
...
export default function NorthCarolinaClusterPage() {
  const published = new Set(getPublishedCityHubSlugs());
  const otherNorthCarolinaCities = getClusterMarkets('north-carolina').filter(
  ...
  return (
    <>
      <JsonLd
        data={buildNorthCarolinaClusterSchemaGraph(
          content.seo.title,
      ...
      <div className="min-h-screen">
        <section className="relative border-b bg-gradient-to-b from-primary/5 to-background py-12 md:py-20">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <div className="inline-flex items-center gap-2 rounded-full border bg-primary/5 px-3 py-1 text-xs font-semibold text-primary mb-4">
              ...
              North Carolina Cluster · Updated 2026
            </div>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
              Charlotte Metro &amp; Lake Norman — City Guides
            </h2>
            <p className="text-muted-foreground mb-8 max-w-3xl">
              Banking-corridor Charlotte and Lake Norman lakefront suburbs within
              Mecklenburg and Iredell county commute range.
            </p>
            <CorridorCityGrid cities={content.charlotteMetroCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
              Research Triangle &amp; Wake County — City Guides
            </h2>
            <p className="text-muted-foreground mb-8 max-w-3xl">
              Raleigh, Durham, and the fastest-growing Wake County spillover corridors
              driving NC tech and biotech inbound volume.
            </p>
            <CorridorCityGrid cities={content.researchTriangleCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
              Coastal &amp; Foothills — City Guides
            </h2>
            <p className="text-muted-foreground mb-8 max-w-3xl">
              Wilmington and Leland coastal master-planned growth plus Hickory&apos;s Blue
              Ridge foothills affordability corridor.
            </p>
            <CorridorCityGrid cities={content.coastalFoothillsCorridor} published={published} />
          </div>
        </section>
        ...
        {otherNorthCarolinaCities.length > 0 && (
          <section className="py-12 md:py-16 bg-muted/20">
            <div className="container mx-auto px-4 max-w-6xl">
              <h2 className="text-2xl font-semibold tracking-tight mb-6">
                More North Carolina Cities — Coming Soon
              </h2>
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {otherNorthCarolinaCities.map((market) => (
        ...
        <section className="py-12 md:py-16">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl font-semibold tracking-tight mb-8">
              North Carolina Moving Resources
            </h2>
            <div className="grid sm:grid-cols-2 gap-4">
