...
import {
  georgiaClusterContent,
  type GeorgiaCorridorCity,
} from '@/lib/destinations/content/georgia-ga';
...
import { buildGeorgiaClusterSchemaGraph } from '@/lib/seo/build-destination-index-schema';
import { SITE_URL, buildOpenGraph, buildTwitter } from '@/lib/seo/site-metadata';

const content = georgiaClusterContent;
  ...
  return (
    <div className="grid sm:grid-cols-2 gap-4">
      {cities.map((city) => {
        ...
        const path = market ? getMarketPath(market) : `/moving-to/georgia/${city.slug}`;
...
export default function GeorgiaClusterPage() {
  const published = new Set(getPublishedCityHubSlugs());
  const otherGeorgiaCities = getClusterMarkets('georgia').filter(
  ...
  return (
    <>
      <JsonLd
        data={buildGeorgiaClusterSchemaGraph(
          content.seo.title,
      ...
      <div className="min-h-screen">
        <section className="relative border-b bg-gradient-to-b from-primary/5 to-background py-12 md:py-20">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <DestinationClusterHeroCta clusterSlug="georgia" clusterLabel="Georgia" />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
              North Fulton Elite Suburbs — Live City Guides
            </h2>
            <p className="text-muted-foreground mb-8 max-w-3xl">
              Johns Creek, Alpharetta, and Roswell — #1 in Georgia prestige, Technology City of the
              South, and Canton Street river-community walkability.
            </p>
            <CorridorCityGrid cities={content.northFultonCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
              Metro Atlanta — Live City Guides
            </h2>
            <p className="text-muted-foreground mb-8 max-w-3xl">
              Atlanta, Decatur, Smyrna, and Cumming — BeltLine cultural capital, MARTA walkability,
              Truist Park convenience, and Lake Lanier exurban growth.
            </p>
            <CorridorCityGrid cities={content.metroAtlantaCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
              Coastal Growth — Live City Guides
            </h2>
            <p className="text-muted-foreground mb-8 max-w-3xl">
              Savannah and Pooler — historic port tourism, logistics expansion, and Hyundai EV plant
              boomtown momentum.
            </p>
            <CorridorCityGrid cities={content.coastalCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
              Heartland — Live City Guides
            </h2>
            <p className="text-muted-foreground mb-8 max-w-3xl">
              Warner Robins — Robins Air Force Base defense-aerospace stability and Houston County
              affordability.
            </p>
            <CorridorCityGrid cities={content.heartlandCorridor} published={published} />
          </div>
        </section>
        ...
        {otherGeorgiaCities.length > 0 && (
          <section className="py-12 md:py-16 bg-muted/20">
            <div className="container mx-auto px-4 max-w-6xl">
              <h2 className="text-2xl font-semibold tracking-tight mb-6">
                More Georgia Cities — Coming Soon
              </h2>
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {otherGeorgiaCities.map((market) => (
        ...
        <section className="py-12 md:py-16">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl font-semibold tracking-tight mb-8">Georgia Moving Resources</h2>
            <div className="grid sm:grid-cols-2 gap-4">
