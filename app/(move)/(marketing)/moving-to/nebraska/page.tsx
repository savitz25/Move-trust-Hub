...
import {
  nebraskaClusterContent,
  type NebraskaCorridorCity,
} from '@/lib/destinations/content/nebraska-ne';
...
import { buildNebraskaClusterSchemaGraph } from '@/lib/seo/build-destination-index-schema';
import { SITE_URL, buildOpenGraph, buildTwitter } from '@/lib/seo/site-metadata';

const content = nebraskaClusterContent;
  ...
  return (
    <div className="grid sm:grid-cols-2 gap-4">
      {cities.map((city) => {
        ...
        const path = market ? getMarketPath(market) : `/moving-to/nebraska/${city.slug}`;
...
export default function NebraskaClusterPage() {
  const published = new Set(getPublishedCityHubSlugs());
  const otherNebraskaCities = getClusterMarkets('nebraska').filter(
  ...
  return (
    <>
      <JsonLd
        data={buildNebraskaClusterSchemaGraph(
          content.seo.title,
      ...
      <div className="min-h-screen">
        <section className="relative border-b bg-gradient-to-b from-primary/5 to-background py-12 md:py-20">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <DestinationClusterHeroCta clusterSlug="nebraska" clusterLabel="Nebraska" />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
              Omaha Metro — Live City Guides
            </h2>
            <p className="text-muted-foreground mb-8 max-w-3xl">
              Omaha, Elkhorn, Papillion, Gretna, and La Vista — economic powerhouse employment,
              West Omaha elite schools, Sarpy County suburbs, and civic innovation.
            </p>
            <CorridorCityGrid cities={content.omahaMetroCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
              Lincoln Corridor — Live City Guide
            </h2>
            <p className="text-muted-foreground mb-8 max-w-3xl">
              Lincoln — brainy capital living through University of Nebraska and Haymarket culture.
            </p>
            <CorridorCityGrid cities={content.lincolnCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
              Central Nebraska — Live City Guides
            </h2>
            <p className="text-muted-foreground mb-8 max-w-3xl">
              Kearney, Columbus, Hastings, and Fremont — I-80 hub stability, agribusiness industry,
              college-town value, and Fremont Lakes recreation.
            </p>
            <CorridorCityGrid cities={content.centralNebraskaCorridor} published={published} />
          </div>
        </section>
        ...
        {otherNebraskaCities.length > 0 && (
          <section className="py-12 md:py-16 bg-muted/20">
            <div className="container mx-auto px-4 max-w-6xl">
              <h2 className="text-2xl font-semibold tracking-tight mb-6">
                More Nebraska Cities — Coming Soon
              </h2>
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {otherNebraskaCities.map((market) => (
