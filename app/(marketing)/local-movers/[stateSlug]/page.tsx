                              ...
                              : state.slug === 'vermont'
                                ...
                                : state.slug === 'new-hampshire'
                                  ...
                                  : state.slug === 'maine'
                                    ...
                                    : state.slug === 'hawaii'
                                      ? 'Browse all 5 Hawaii county guides — 10 curated movers per county from Honolulu (Oahu) through Maui, Kauai, Hawaii Island (Big Island), and remote Kalawao. FMCSA licensing, cost estimates, and island-specific moving tips.'
                                      : state.slug === 'alaska'
                                        ? 'Browse Alaska’s 5 major borough guides — 10 curated movers each in Anchorage Municipality, Matanuska-Susitna, Fairbanks North Star, Kenai Peninsula, and Juneau. Remote boroughs and census areas use generated listings. FMCSA licensing, cost estimates, and Alaska-specific moving tips.'
