                                                        ...
                                                        : state.slug === 'montana'
                                                          ...
                                                          : state.slug === 'wyoming'
                                                            ...
                                                            : state.slug === 'north-dakota'
                                                              ...
                                                              : state.slug === 'south-dakota'
                                                                ? 'Browse 26 curated South Dakota county guides — 10 movers each in Minnehaha (Sioux Falls), Pennington (Rapid City), Lincoln, Brookings, Brown (Aberdeen), and 21 additional active markets. Sioux Falls and Rapid City lead with Two Men and a Truck; Black Hills counties (Lawrence, Custer, Meade) emphasize tourism and seasonal demand; university counties (Brookings, Clay) cover semester turnover; Pierre covers state capital demand; rural Missouri River and James River counties emphasize agricultural hauls and long-distance regional moves. FMCSA licensing, cost estimates, and South Dakota-specific moving tips.'
