                                            ...
                                            : state.slug === 'nevada'
                                              ...
                                              : state.slug === 'arizona'
                                                ...
                                                : state.slug === 'new-mexico'
                                                  ...
                                                  : state.slug === 'utah'
                                                    ? 'Browse all 29 Utah county guides — 10 curated movers in Salt Lake County (Salt Lake City metro), Utah County (Provo-Orem), Davis, Weber, Washington (St. George), Cache (Logan), Summit (Park City), and every county statewide. Wasatch Front metros cover urban traffic and suburban high-value homes; southern Utah covers retirement and tourism corridors; rural counties emphasize long-distance regional hauls and mountain logistics. FMCSA licensing, cost estimates, and Utah-specific moving tips.'
