                                                          ...
                                                          : state.slug === 'wyoming'
                                                            ...
                                                            : state.slug === 'north-dakota'
                                                              ...
                                                              : state.slug === 'south-dakota'
                                                                ...
                                                                : state.slug === 'nebraska'
                                                                  ? 'Browse 21 curated Nebraska county guides — 10 movers each in Douglas (Omaha), Lancaster (Lincoln), Sarpy (Papillion), Hall (Grand Island), Buffalo (Kearney), and 16 additional active markets. Omaha and Lincoln lead with Two Men and a Truck; Sarpy, Cass, and Washington cover Omaha metro suburban growth; Grand Island, Kearney, and Hastings cover central Platte Valley demand; Scotts Bluff and North Platte cover Panhandle and western corridor moves; eastern counties emphasize Missouri River and Big Blue Valley agricultural hauls. FMCSA licensing, cost estimates, and Nebraska-specific moving tips.'
