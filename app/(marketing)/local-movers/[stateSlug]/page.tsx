              ...
              ? state.slug === 'california' ||
                ...
                ? state.slug === 'district-of-columbia'
                  ...
                  : state.slug === 'delaware'
                    ...
                    : state.slug === 'maryland'
                      ? 'Browse Maryland county guides — 10 curated movers each in Montgomery, Prince George\'s, and Baltimore County. FMCSA licensing, DC and Baltimore metro cost estimates, and county-specific moving tips.'
