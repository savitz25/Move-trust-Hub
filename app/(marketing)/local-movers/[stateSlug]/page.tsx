                                                            ...
                                                            : state.slug === 'north-dakota'
                                                              ...
                                                              : state.slug === 'south-dakota'
                                                                ...
                                                                : state.slug === 'nebraska'
                                                                  ...
                                                                  : state.slug === 'iowa'
                                                                    ? 'Browse 21 Iowa county guides — 10 curated movers in Polk County (Des Moines), Linn (Cedar Rapids), Scott (Quad Cities), Johnson (Iowa City), Black Hawk (Waterloo-Cedar Falls), Dallas (Waukee), Woodbury (Sioux City), Story (Ames), Dubuque, Pottawattamie (Council Bluffs), and 10 regional specialists in every curated county. Des Moines covers corporate, suburban, and state capital relocations; Iowa City and Ames cover university turnover; Quad Cities and Council Bluffs cover cross-border Omaha metro demand; rural counties emphasize agricultural hauls, harsh winters, and regional corridor logistics. FMCSA licensing, cost estimates, and Iowa-specific moving tips.'
