                                              ...
                                              : state.slug === 'arizona'
                                                ...
                                                : state.slug === 'new-mexico'
                                                  ...
                                                  : state.slug === 'utah'
                                                    ...
                                                    : state.slug === 'colorado'
                                                      ? 'Browse all 64 Colorado county guides — 10 curated movers in every county including Denver metro (Denver, Arapahoe, Jefferson, Adams, Douglas, Broomfield, Clear Creek, Gilpin), Colorado Springs (El Paso, Teller), Fort Collins (Larimer), Boulder, Greeley (Weld), Grand Junction (Mesa), and regional markets from Aspen (Pitkin) and Telluride (San Miguel) ski corridors to eastern plains counties (Baca, Kit Carson, Sedgwick). Denver metro guides cover urban traffic; Colorado Springs covers military PCS; mountain and resort counties cover tourism logistics; remote counties (Hinsdale, Mineral, San Juan) emphasize limited crew availability and route planning. FMCSA licensing, cost estimates, and Colorado-specific moving tips.'
