                                                      ...
                                                      : state.slug === 'idaho'
                                                        ...
                                                        : state.slug === 'montana'
                                                          ...
                                                          : state.slug === 'wyoming'
                                                            ...
                                                            : state.slug === 'north-dakota'
                                                              ? 'Browse all 53 North Dakota county guides — 10 curated movers each in every county. Cass (Fargo) leads with Two Men and a Truck; Burleigh (Bismarck) covers state capital demand; Bakken counties (Williams, McKenzie, Mountrail) emphasize energy-sector relocations; Red River Valley and university-area counties cover suburban and semester turnover; rural counties emphasize long winter hauls and limited crew availability. FMCSA licensing, cost estimates, and North Dakota-specific moving tips.'
