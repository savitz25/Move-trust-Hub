                                              ...
                                              : state.slug === 'arizona'
                                                ...
                                                : state.slug === 'new-mexico'
                                                  ...
                                                  : state.slug === 'utah'
                                                    ...
                                                    : state.slug === 'colorado'
                                                      ? 'Browse Colorado county guides — 10 curated movers in 44 counties including Denver metro (Denver, Arapahoe, Jefferson, Adams, Douglas, Broomfield), Colorado Springs (El Paso), Fort Collins (Larimer), Boulder, Greeley (Weld), Grand Junction (Mesa), and regional markets from Aspen (Pitkin) and Telluride (San Miguel) ski corridors to eastern plains counties. Denver metro guides cover urban traffic; Colorado Springs covers military PCS; mountain and resort counties cover tourism logistics. Additional county guides are rolling out statewide toward 64 counties. FMCSA licensing, cost estimates, and Colorado-specific moving tips.'
