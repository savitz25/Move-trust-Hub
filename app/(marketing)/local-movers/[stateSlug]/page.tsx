                                          ...
                                          : state.slug === 'oregon'
                                            ...
                                            : state.slug === 'nevada'
                                              ...
                                              : state.slug === 'arizona'
                                                ...
                                                : state.slug === 'new-mexico'
                                                  ? 'Browse all 33 New Mexico county guides — 10 curated movers in every county from Bernalillo (Albuquerque) and Doña Ana (Las Cruces) through Santa Fe, Taos, Farmington, Roswell, and rural regional markets statewide. Albuquerque metro covers urban and suburban moves; northern New Mexico covers capital-city, tourism, and Los Alamos lab relocations; southern New Mexico covers border and military corridors; southeastern counties cover energy-sector relocations. FMCSA licensing, cost estimates, and New Mexico-specific moving tips.'
