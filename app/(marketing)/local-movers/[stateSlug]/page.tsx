                                                      ...
                                                      : state.slug === 'idaho'
                                                        ...
                                                        : state.slug === 'montana'
                                                          ...
                                                          : state.slug === 'wyoming'
                                                            ...
                                                            : state.slug === 'north-dakota'
                                                              ? 'Browse 25 curated North Dakota county guides — 10 movers each in Cass (Fargo), Burleigh (Bismarck), Grand Forks, Ward (Minot), Williams (Williston), and 20 additional active markets. Fargo leads with Two Men and a Truck; Bismarck covers state capital demand; Bakken counties (Williams, McKenzie, Mountrail) emphasize energy-sector relocations; Red River Valley and university-area counties cover suburban and semester turnover; rural counties emphasize long winter hauls and limited crew availability. FMCSA licensing, cost estimates, and North Dakota-specific moving tips.'
