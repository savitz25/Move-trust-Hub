                                                              ...
                                                              : state.slug === 'south-dakota'
                                                                ...
                                                                : state.slug === 'nebraska'
                                                                  ...
                                                                  : state.slug === 'iowa'
                                                                    ...
                                                                    : state.slug === 'wisconsin'
                                                                      ? 'Browse all 72 Wisconsin county guides — 10 curated movers per county from Milwaukee and Madison metros through Fox Cities, Green Bay, Kenosha, Twin Cities fringe, Duluth–Superior, Door Peninsula, Chippewa Valley, Driftless Area, and northwoods lakes-country markets. FMCSA licensing, cost estimates, and Wisconsin-specific moving tips.'
                                                                    : state.slug === 'minnesota'
