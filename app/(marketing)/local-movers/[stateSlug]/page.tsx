                                  ...
                                  : state.slug === 'maine'
                                    ...
                                    : state.slug === 'hawaii'
                                      ...
                                      : state.slug === 'alaska'
                                        ...
                                        : state.slug === 'washington'
                                          ? 'Browse Washington county guides — 10 curated movers each in King (Seattle), Pierce (Tacoma), Snohomish (Everett), Spokane, Clark (Vancouver), Thurston (Olympia), Kitsap, and Yakima. Remaining counties use generated listings until curated. FMCSA licensing, cost estimates, and Puget Sound moving tips.'
