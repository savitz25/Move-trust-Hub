                                              ...
                                              : state.slug === 'arizona'
                                                ...
                                                : state.slug === 'new-mexico'
                                                  ...
                                                  : state.slug === 'utah'
                                                    ...
                                                    : state.slug === 'colorado'
                                                      ? 'Browse Colorado county guides — 10 curated movers in El Paso County (Colorado Springs), Denver, Arapahoe (Aurora), Jefferson (Lakewood), Adams (Thornton), Douglas (Castle Rock), Weld (Greeley), Larimer (Fort Collins), Boulder, Pueblo, Mesa (Grand Junction), Broomfield, and 11 additional regional markets including Eagle, Summit, and Routt ski corridors. Denver metro guides cover urban traffic and suburban high-value homes; Colorado Springs covers military PCS; mountain counties cover resort and tourism logistics. Additional county guides are rolling out statewide. FMCSA licensing, cost estimates, and Colorado-specific moving tips.'
