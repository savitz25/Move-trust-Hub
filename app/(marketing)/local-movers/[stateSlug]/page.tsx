                                                          ...
                                                          : state.slug === 'wyoming'
                                                            ...
                                                            : state.slug === 'north-dakota'
                                                              ...
                                                              : state.slug === 'south-dakota'
                                                                ...
                                                                : state.slug === 'nebraska'
                                                                  ? 'Browse all 93 Nebraska county guides — up to 10 curated movers in Douglas (Omaha), Lancaster (Lincoln), Sarpy (Papillion), Hall (Grand Island), Buffalo (Kearney), and 88 additional counties. Omaha and Lincoln lead with Two Men and a Truck; Sarpy, Cass, and Washington cover Omaha metro suburban growth; Grand Island, Kearney, and Hastings cover central Platte Valley demand; Scotts Bluff and North Platte cover Panhandle and western corridor moves; rural counties emphasize agricultural hauls, long-distance regional moves, and Missouri River valley logistics. FMCSA licensing, cost estimates, and Nebraska-specific moving tips.'
