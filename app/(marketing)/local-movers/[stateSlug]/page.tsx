                                                  ...
                                                  : state.slug === 'utah'
                                                    ...
                                                    : state.slug === 'colorado'
                                                      ...
                                                      : state.slug === 'idaho'
                                                        ...
                                                        : state.slug === 'montana'
                                                          ? 'Browse all 56 Montana county guides — 10 curated movers each in Yellowstone (Billings), Gallatin (Bozeman), and Missoula, with regional specialists in every county. Billings and Bozeman guides cover rapid growth and suburban demand; western Montana covers university, lakeside tourism, and mountain-home logistics; eastern Hi-Line and plains counties emphasize rural hauls, energy-corridor relocations, and long-distance regional moves. FMCSA licensing, cost estimates, and Montana-specific moving tips.'
