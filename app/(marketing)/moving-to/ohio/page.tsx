...
import {
  ohioClusterContent,
  type OhioCorridorCity,
} from '@/lib/destinations/content/ohio-oh';
...
import { buildOhioClusterSchemaGraph } from '@/lib/seo/build-destination-index-schema';
import { SITE_URL, buildOpenGraph, buildTwitter } from '@/lib/seo/site-metadata';

const content = ohioClusterContent;
  ...
  return (
    <div className="grid sm:grid-cols-2 gap-4">
      {cities.map((city) => {
        ...
        const path = market ? getMarketPath(market) : `/moving-to/ohio/${city.slug}`;
...
export default function OhioClusterPage() {
  const published = new Set(getPublishedCityHubSlugs());
  const otherOhioCities = getClusterMarkets('ohio').filter(
  ...
  return (
    <>
      <JsonLd
        data={buildOhioClusterSchemaGraph(
          content.seo.title,
      ...
      <div className="min-h-screen">
        <section className="relative border-b bg-gradient-to-b from-primary/5 to-background py-12 md:py-20">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <DestinationClusterHeroCta clusterSlug="ohio" clusterLabel="Ohio" />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
              Northeast Lake Erie — Live City Guides
            </h2>
            <p className="text-muted-foreground mb-8 max-w-3xl">
              Mentor, Parma, Cleveland, and Lorain — Lake Erie shoreline value, safe Cleveland
              suburbs, revitalizing metro healthcare, and waterfront affordability.
            </p>
            <CorridorCityGrid cities={content.northeastLakeErieCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
              Central Ohio — Live City Guide
            </h2>
            <p className="text-muted-foreground mb-8 max-w-3xl">
              Columbus — fast-growing state capital and Silicon Heartland hub with Intel, Google, and
              Amazon corridor investment.
            </p>
            <CorridorCityGrid cities={content.centralOhioCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
              Southwest River — Live City Guides
            </h2>
            <p className="text-muted-foreground mb-8 max-w-3xl">
              Cincinnati and Hamilton — corporate Ohio River riverfront culture and Butler County
              creative river-city value.
            </p>
            <CorridorCityGrid cities={content.southwestRiverCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
              Western Value — Live City Guides
            </h2>
            <p className="text-muted-foreground mb-8 max-w-3xl">
              Springfield and Lima — affordable logistics, manufacturing, and budget-friendly
              housing along I-70 and I-75.
            </p>
            <CorridorCityGrid cities={content.westernValueCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
              North Coast — Live City Guide
            </h2>
            <p className="text-muted-foreground mb-8 max-w-3xl">
              Sandusky — maritime tourist gateway with Cedar Point corridor access and revitalized
              lakefront downtown.
            </p>
            <CorridorCityGrid cities={content.northCoastCorridor} published={published} />
          </div>
        </section>
        ...
        {otherOhioCities.length > 0 && (
          <section className="py-12 md:py-16 bg-muted/20">
            <div className="container mx-auto px-4 max-w-6xl">
              <h2 className="text-2xl font-semibold tracking-tight mb-6">
                More Ohio Cities — Coming Soon
              </h2>
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {otherOhioCities.map((market) => (
        ...
        <section className="py-12 md:py-16">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl font-semibold tracking-tight mb-8">Ohio Moving Resources</h2>
            <div className="grid sm:grid-cols-2 gap-4">
