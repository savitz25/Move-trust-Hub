...
import {
  rhodeIslandClusterContent,
  type RhodeIslandCorridorCity,
} from '@/lib/destinations/content/rhode-island-ri';
...
import { buildRhodeIslandClusterSchemaGraph } from '@/lib/seo/build-destination-index-schema';
import { SITE_URL, buildOpenGraph, buildTwitter } from '@/lib/seo/site-metadata';

const content = rhodeIslandClusterContent;
...
function CorridorCityGrid({
  ...
  cities: RhodeIslandCorridorCity[];
  ...
  return (
    <div className="grid sm:grid-cols-2 gap-4">
      {cities.map((city) => {
        ...
        const path = market ? getMarketPath(market) : `/moving-to/rhode-island/${city.slug}`;
...
export default function RhodeIslandClusterPage() {
  const published = new Set(getPublishedCityHubSlugs());
  const otherRhodeIslandCities = getClusterMarkets('rhode-island').filter(
  ...
  return (
    <>
      <JsonLd
        data={buildRhodeIslandClusterSchemaGraph(
          content.seo.title,
      ...
      <div className="min-h-screen">
        <section className="relative border-b bg-gradient-to-b from-primary/5 to-background py-12 md:py-20">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <div className="inline-flex items-center gap-2 rounded-full border bg-primary/5 px-3 py-1 text-xs font-semibold text-primary mb-4">
              ...
              Rhode Island Cluster · Updated 2026
            </div>
            ...
            <DestinationClusterHeroCta clusterSlug="rhode-island" clusterLabel="Rhode Island" />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <p className="text-muted-foreground mb-8 max-w-3xl">
              ...
              walkability, and airport-and-commuter-rail connectivity.
            </p>
            <CorridorCityGrid cities={content.capitalUrbanCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <p className="text-muted-foreground mb-8 max-w-3xl">
              ...
              charm, and historic patriotic waterfront.
            </p>
            <CorridorCityGrid cities={content.eastBayCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <p className="text-muted-foreground mb-8 max-w-3xl">
              ...
              coastal resort living.
            </p>
            <CorridorCityGrid cities={content.southCountyCoastalCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <p className="text-muted-foreground mb-8 max-w-3xl">
              ...
              Providence-adjacent value.
            </p>
            <CorridorCityGrid cities={content.northernSuburbsCorridor} published={published} />
          </div>
        </section>
        ...
        {otherRhodeIslandCities.length > 0 && (
