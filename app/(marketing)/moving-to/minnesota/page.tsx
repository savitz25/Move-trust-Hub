...
import {
  minnesotaClusterContent,
  type MinnesotaCorridorCity,
} from '@/lib/destinations/content/minnesota-mn';
...
import { buildMinnesotaClusterSchemaGraph } from '@/lib/seo/build-destination-index-schema';
import { SITE_URL, buildOpenGraph, buildTwitter } from '@/lib/seo/site-metadata';

const content = minnesotaClusterContent;
  ...
  return (
    <div className="grid sm:grid-cols-2 gap-4">
      {cities.map((city) => {
        ...
        const path = market ? getMarketPath(market) : `/moving-to/minnesota/${city.slug}`;
...
export default function MinnesotaClusterPage() {
  const published = new Set(getPublishedCityHubSlugs());
  const otherMinnesotaCities = getClusterMarkets('minnesota').filter(
  ...
  return (
    <>
      <JsonLd
        data={buildMinnesotaClusterSchemaGraph(
          content.seo.title,
      ...
      <div className="min-h-screen">
        <section className="relative border-b bg-gradient-to-b from-primary/5 to-background py-12 md:py-20">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <div className="inline-flex items-center gap-2 rounded-full border bg-primary/5 px-3 py-1 text-xs font-semibold text-primary mb-4">
              ...
              Minnesota Cluster · Updated 2026
            </div>
            ...
            <DestinationClusterHeroCta clusterSlug="minnesota" clusterLabel="Minnesota" />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
              West Metro — Live City Guides
            </h2>
            <p className="text-muted-foreground mb-8 max-w-3xl">
              Plymouth, Eden Prairie, Maple Grove, and Wayzata — Medicine Lake balance,
              corporate-suburb polish, Arbor Lakes retail, and Lake Minnetonka luxury.
            </p>
            <CorridorCityGrid cities={content.westMetroCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
              South &amp; East Metro — Live City Guides
            </h2>
            <p className="text-muted-foreground mb-8 max-w-3xl">
              Edina, Eagan, and Woodbury — Galleria prestige, MSP airport convenience,
              and Viking Lakes master-planned growth.
            </p>
            <CorridorCityGrid cities={content.southEastMetroCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
              St. Croix River — Live City Guide
            </h2>
            <p className="text-muted-foreground mb-8 max-w-3xl">
              Stillwater — historic river bluffs, lift bridge charm, and Washington County escape.
            </p>
            <CorridorCityGrid cities={content.stCroixCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
              Greater Minnesota — Live City Guides
            </h2>
            <p className="text-muted-foreground mb-8 max-w-3xl">
              Rochester and Duluth — Mayo Clinic med-tech beacon and Lake Superior outdoor sanctuary.
            </p>
            <CorridorCityGrid cities={content.greaterMinnesotaCorridor} published={published} />
          </div>
        </section>
        ...
        {otherMinnesotaCities.length > 0 && (
          <section className="py-12 md:py-16 bg-muted/20">
            <div className="container mx-auto px-4 max-w-6xl">
              <h2 className="text-2xl font-semibold tracking-tight mb-6">
                More Minnesota Cities — Coming Soon
              </h2>
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {otherMinnesotaCities.map((market) => (
