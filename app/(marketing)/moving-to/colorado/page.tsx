...
import {
  coloradoClusterContent,
  type ColoradoCorridorCity,
} from '@/lib/destinations/content/colorado-co';
...
import { buildColoradoClusterSchemaGraph } from '@/lib/seo/build-destination-index-schema';
import { SITE_URL, buildOpenGraph, buildTwitter } from '@/lib/seo/site-metadata';

const content = coloradoClusterContent;
  ...
  return (
    <div className="grid sm:grid-cols-2 gap-4">
      {cities.map((city) => {
        ...
        const path = market ? getMarketPath(market) : `/moving-to/colorado/${city.slug}`;
...
export default function ColoradoClusterPage() {
  const published = new Set(getPublishedCityHubSlugs());
  const otherColoradoCities = getClusterMarkets('colorado').filter(
  ...
  return (
    <>
      <JsonLd
        data={buildColoradoClusterSchemaGraph(
          content.seo.title,
      ...
      <div className="min-h-screen">
        <section className="relative border-b bg-gradient-to-b from-primary/5 to-background py-12 md:py-20">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <DestinationClusterHeroCta clusterSlug="colorado" clusterLabel="Colorado" />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
              Denver Metro — Live City Guides
            </h2>
            <p className="text-muted-foreground mb-8 max-w-3xl">
              Denver, Arvada, Centennial, and Boulder — urban energy, DTC suburbs,
              foothills access, and Flatirons tech culture.
            </p>
            <CorridorCityGrid cities={content.denverMetroCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
              South Metro — Live City Guides
            </h2>
            <p className="text-muted-foreground mb-8 max-w-3xl">
              Castle Rock and Parker — Douglas County master-planned family growth on
              the I-25 corridor between Denver and Colorado Springs.
            </p>
            <CorridorCityGrid cities={content.southMetroCorridor} published={published} />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-b">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
              Front Range North &amp; South — Live City Guides
            </h2>
            <p className="text-muted-foreground mb-8 max-w-3xl">
              Fort Collins, Longmont, Colorado Springs, and Pueblo — college-town craft
              beer, Boulder alternatives, Pikes Peak military corridor, and riverwalk
              affordability.
            </p>
            <CorridorCityGrid cities={content.frontRangeCorridor} published={published} />
          </div>
        </section>
        ...
        {otherColoradoCities.length > 0 && (
          <section className="py-12 md:py-16 bg-muted/20">
            <div className="container mx-auto px-4 max-w-6xl">
              <h2 className="text-2xl font-semibold tracking-tight mb-6">
                More Colorado Cities — Coming Soon
              </h2>
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {otherColoradoCities.map((market) => (
