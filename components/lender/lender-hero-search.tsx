    ...
    >
      <div className="flex flex-col gap-2 sm:flex-row">
        <input
          ...
          placeholder="ZIP code or lender name (e.g. 33301, Veterans United, FHA Orlando)"
          className="h-12 w-full rounded-xl border border-zinc-200 bg-white px-4 text-base text-[#0A2540] shadow-sm focus:border-[#3B82F6] focus:outline-none focus:ring-2 focus:ring-[#3B82F6]/20"
      ...
      <p className="mt-2 text-left text-xs text-muted-foreground">
        5-digit ZIP opens your county directory. Anything else searches lender names, cities, and loan types.
      </p>
    </form>
  );
}