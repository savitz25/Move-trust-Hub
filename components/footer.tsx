  ...
  return (
    <footer className="border-t bg-muted/20">
        ...
        <div className="grid grid-cols-2 md:grid-cols-6 gap-y-9">
          ...
          <div>
            ...
            <div className="space-y-1.5 text-sm text-muted-foreground">
              ...
              <div><Link prefetch={false} href="/about/how-we-score-movers" className="hover:text-foreground transition-colors">Methodology</Link></div>
      ...
      <div className="border-t py-6 space-y-4">
        <AskNetworkSeal currentHub="move" showSiblings />
