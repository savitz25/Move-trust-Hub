        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-y-9">
          <div className="col-span-2 md:col-span-1">
            <Link href="/" className="flex items-center gap-2 font-semibold text-base tracking-tight">
              <img src="/logo.svg" alt="Move Trust Hub" className="h-7 w-auto" />
          ...
          <div>
            ...
            <div className="space-y-1.5 text-sm text-muted-foreground">
              ...
              <div><a href="tel:8702606352" className="hover:text-foreground transition-colors">(870) 260-6352</a></div>
