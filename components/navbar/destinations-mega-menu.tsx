          ...
          <div className="rounded-xl border bg-background shadow-lg p-5 grid sm:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <div className="mt-4 pt-4 border-t text-xs text-muted-foreground space-y-1">
                ...
                <Link prefetch={false} href="/resources/routes/pennsylvania-to-florida" className="block hover:text-primary" onClick={() => setOpen(false)}>
                  PA → Florida route guide →
                </Link>
                <Link prefetch={false} href="/resources/routes/pennsylvania-to-south-carolina" className="block hover:text-primary" onClick={() => setOpen(false)}>
                  PA → South Carolina route guide →
                </Link>
                <Link prefetch={false} href="/resources/routes/pennsylvania-to-texas" className="block hover:text-primary" onClick={() => setOpen(false)}>
                  PA → Texas route guide →
                </Link>
                <Link prefetch={false} href="/resources/routes/massachusetts-to-florida" className="block hover:text-primary" onClick={() => setOpen(false)}>
                  MA → Florida route guide →
                </Link>
                <Link prefetch={false} href="/resources/routes/massachusetts-to-south-carolina" className="block hover:text-primary" onClick={() => setOpen(false)}>
                  MA → South Carolina route guide →
                </Link>
                <Link prefetch={false} href="/resources/routes/massachusetts-to-texas" className="block hover:text-primary" onClick={() => setOpen(false)}>
                  MA → Texas route guide →
                </Link>
                <Link prefetch={false} href="/resources/routes/minnesota-to-florida" className="block hover:text-primary" onClick={() => setOpen(false)}>
                  MN → Florida route guide →
                </Link>
                <Link prefetch={false} href="/resources/routes/minnesota-to-arizona" className="block hover:text-primary" onClick={() => setOpen(false)}>
                  MN → Arizona route guide →
                </Link>
                <Link prefetch={false} href="/resources/routes/minnesota-to-texas" className="block hover:text-primary" onClick={() => setOpen(false)}>
                  MN → Texas route guide →
                </Link>
