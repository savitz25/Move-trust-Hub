/**
 * Tight Move hub mark — Ask canonical geometry, Move orange #FF5A1F.
 * Header PNG lockup was too wide (logo x≈35). Optical slot is CSS 36/33/30.
 */
export function MoveNetworkMark({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      viewBox="0 0 36 36"
